...
function rizky_css_styles_mobile_admin(){
    wp_register_style('my_custom_css',site_url().'/wp-content/plugins/oxygen/css/custom.css');
    wp_enqueue_style('my_custom_css');
    wp_register_style('my_slick_css',site_url(). '/wp-content/plugins/oxygen/slick/slick.css');
    wp_enqueue_style('my_slick_css');
...
add_action('admin_head','rizky_css_styles_mobile_admin',120);

function slick_scripts(){
 
wp_register_script('my_slick_slider',site_url(). '/wp-content/plugins/oxygen/slick/slick.js',array('jquery'),'1.8',true);
wp_enqueue_script('my_slick_slider');
wp_register_script('my_slick_slider_min',site_url(). '/wp-content/plugins/oxygen/slick/slick.min.js',array('jquery'),'1.8',true);
wp_enqueue_script('my_slick_slider_min');
wp_register_script('my_jscript',site_url(). '/wp-content/plugins/oxygen/js/script.js',array('jquery'),'1.8',true);
wp_enqueue_script('my_jscript');
}
