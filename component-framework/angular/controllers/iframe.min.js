...
CTFrontendBuilder.controller("ControllerNavigation",["$scope","$parentScope","$http","$timeout",function(k,c,e,s){k.openFolders={},k.toggledNodes=[],k.generateBreadcrumbs=function(e,t){return!1},k.calcDefaultComponentTitle=function(e,t){var o=k.niceNames[e.name];return"ct_reusable"==e.name?o+=" (post: "+e.options.view_id+")":"ct_woocommerce"==e.name&&(hookName=k.getWooCommerceHookNiceName(e.options.original.hook_name),o+=hookName),t||(o+=" (#"+e.id+")"),o},k.setComponentCategory=function(e,t,o){var n=k.findComponentItem(k.componentsTree.children,e,k.getComponentItem);n.options.ct_category===t?(delete n.options.ct_category,delete k.component.options[e].ct_category):(n.options.ct_category=t,k.component.options[e].ct_category=t),jQuery(o.target).closest(".ct-more-options-expanded").removeClass("ct-more-options-expanded")},k.generateDOMTreeNavigator=function(e,C,x,t,w){null==k.component.options[99999]&&(k.component.options[99999]=[]),k.component.options[99999].nicename="Button Area",void 0===t&&(t=!1);var N=!1;angular.forEach(e.children,function(e,t){if(!N){if(void 0===C||e.id==C){var o=e.id,n=e.name,a="",r="",i=" ng-class=\"{'ct-dom-tree-node-expanded' : toggledNodes["+o+"],'ct-dom-tree-child' : hasParent("+o+')}"}',c=" ng-class=\"{'ct-dom-tree-node-selected' : parentScope.isActiveId("+o+')}"',s="";"oxy_header_left"==n||"oxy_header_center"==n||"oxy_header_right"==n?(activateID=e.options.ct_parent,activateName="oxy_header_row",a+=" dom-tree-disabled"):(activateID=o,activateName=n);var l=k.calcDefaultComponentTitle(e),d=' ng-mousedown="parentScope.triggerCodeMirrorBlur('+o+');" ng-click="activateComponent('+activateID+", '"+activateName+"',$event); parentScope.scrollToComponent('"+e.options.selector+"');\"";if(99999==e.id&&(d=""),e.children||(a+=" ct-dom-tree-no-children"),"ct_columns"!=e.name&&"ct_new_columns"!=e.name&&"ct_column"!=e.name&&"ct_section"!=e.name&&"ct_ul"!=e.name&&"ct_link"!=e.name&&("ct_inner_content"!=e.name||CtBuilderAjax.query&&CtBuilderAjax.query.post_type&&"ct_template"===CtBuilderAjax.query.post_type)&&"ct_div_block"!=e.name&&"oxy_dynamic_list"!=e.name&&"ct_nestable_shortcode"!=e.name&&"oxy_icon_box_button_area"!=e.name&&"oxy_tabs"!=e.name&&"oxy_tabs_contents"!=e.name&&"oxy_tab"!=e.name&&"oxy_tab_content"!=e.name&&"oxy_toggle"!=e.name&&"oxy_header"!=e.name&&"ct_if_wrap"!=e.name&&"ct_else_wrap"!=e.name&&"oxy_header"!=e.name&&"oxy_header_left"!=e.name&&"oxy_header_center"!=e.name&&"oxy_header_right"!=e.name&&"ct_slider"!=e.name&&"ct_slide"!=e.name&&"ct_modal"!=e.name||(a+=" ct-accept-drops"),k.isAPIComponent(e.name)&&k.componentsTemplates[n].nestable&&(a+=" ct-accept-drops"),s+=" data-component-name='"+e.name+"' ","ct_columns"==e.name&&(a+=" ct-sortable-columns"),"ct_column"==e.name&&(a+=" ct-sortable-column"),"ct_ul"==e.name&&(a+=" ct-sortable-ul"),"ct_li"==e.name&&(a+=" ct-sortable-li"),"ct_if_else_wrap"==e.name&&(a+=" ct-sortable-if-else-wrap"),"ct_if_wrap"==e.name&&(a+=" ct-sortable-if-wrap"),"oxy_dynamic_list"==e.name&&(a+=" ct-sortable-dynamic-list"),"ct_else_wrap"==e.name&&(a+=" ct-sortable-else-wrap"),"ct_slider"==e.name&&(a+=" ct-sortable-slider"),"ct_modal"==e.name&&(a+=" ct-sortable-modal"),"ct_slide"==e.name&&(a+=" ct-sortable-slide"),"ct_section"==e.name&&(a+=" ct-sortable-section"),"ct_link"==e.name&&(a+=" ct-sortable-link"),"ct_link_text"==e.name&&(a+=" ct-sortable-link-text"),"ct_new_columns"==e.name&&(a+=" ct-sortable-new-columns"),"ct_div_block"==e.name&&(a+=" ct-sortable-div-block"),"oxy_header"==e.name&&(a+=" ct-sortable-header"),"oxy_header_row"==e.name&&(a+=" ct-sortable-header-row"),"oxy_tabs"==e.name&&(a+=" ct-sortable-tabs"),"oxy_tabs_contents"==e.name&&(a+=" ct-sortable-tabs-contents"),"oxy_tab"==e.name&&(a+=" ct-sortable-tab"),"oxy_tab_content"==e.name&&(a+=" ct-sortable-tab-content"),"ct_span"!=e.name&&"oxy_header_left"!=e.name&&"oxy_header_right"!=e.name&&"oxy_header_center"!=e.name&&"true"!=e.options.oxy_builtin&&(a+=" ct-draggable"),"ct_span"!=e.name&&"true"!=e.options.oxy_builtin)var m='<li ng-show="isCanComponentize('+o+",'"+n+'\');"ng-click="saveReusable('+o+')">Make Re-Usable</li>',p='<li ng-click="duplicateComponent('+o+",'"+n+"',"+e.options.ct_parent+')">Duplicate</li>',g="<li ng-click=\"wrapComponentWith('ct_div_block',"+o+","+e.options.ct_parent+')">Wrap with &#60;div&#62;</li>';else m="",p="",g="";var u="";if(!angular.element("body").hasClass("ct_connection_active")||"ct_section"!=e.name&&"ct_div_block"!=e.name||(u='<li ng-click="saveReusable('+o+', true)">Copy to Block</li>'),null==k.component.options[e.id]&&(k.component.options[e.id]={}),k.component.options[e.id].nicename=k.component.options[e.id].nicename&&""!==k.component.options[e.id].nicename.trim()?k.component.options[e.id].nicename:l,k.component.options[e.id].ct_parent=e.options.ct_parent,parseInt(e.id)<1e5){if("oxy_header_left"!=e.name&&"oxy_header_right"!=e.name&&"oxy_header_center"!=e.name&&"ct_if_wrap"!=e.name&&"ct_else_wrap"!=e.name)var _='<span class="ct-icon ct-delete-icon" title="Remove Component" ng-click="removeComponentWithUndo('+o+",'"+n+"',"+e.options.ct_parent+')"></span>';else _="";var v=!1;if(CtBuilderAjax.componentCategories&&0<CtBuilderAjax.componentCategories.length)for(key in v="",CtBuilderAjax.componentCategories)v+="<li ng-class=\"{'active': component.options[component.active.id]['ct_category'] === '"+CtBuilderAjax.componentCategories[key]+'\'}" ng-click="showCategorize=false; setComponentCategory('+e.id+", '"+CtBuilderAjax.componentCategories[key]+"', $event)\">"+CtBuilderAjax.componentCategories[key]+"</li>";var y=angular.element("body").hasClass("ct_connection_active")&&v&&(0===parseInt(e.options.ct_parent)||1e5<parseInt(e.options.ct_parent));99999!=e.id&&"true"!=e.options.oxy_builtin&&(r='<div class="ct-node-options"><span class="ct-icon ct-more-options-icon" ng-click="showCategorize=false"></span>'+_+'<div class="ct-more-options-container"><div class="ct-more-options"><ul ng-show="showCategorize!=true">'+m+u+p+g+'<li ng-click="setEditableFriendlyName('+o+')">Rename</li>'+(y?'<li ng-click="showCategorize=true">Categorize</li>':"")+"</ul>"+(y?'<ul ng-show="showCategorize==true"><li ng-click="showCategorize=false">< Back</li>'+v+"</ul>":"")+"</div></div></div>"),x.HTML+='<div ng-attr-tree-actual-id="'+e.actualID+'" ng-attr-tree-id="'+e.id+'"'+i+' id="ct-dom-tree-node-'+e.id+'" class="ct-dom-tree-node '+a+'" '+s+' ng-Style="parentScope.isActiveId('+o+')?{zIndex: 9999}:{}"><div class="ct-dom-tree-bottom-dash-cover"></div><div class="ct-dom-tree-left-dash-cover"></div><div ng-attr-node-id="'+o+'" class="ct-dom-tree-node-anchor ct-dom-tree-node-type-general ct-dom-tree-name"'+c+d+'><div class="ct-dom-tree-node-header" ng-class="{\'ct-handle\': editableFriendlyName!='+o+(y?", 'categorized-component': component.options['"+e.id+"']['ct_category']":"")+'}"><div class="ct-expand-butt" ng-click="toggleNode('+o+',$event)"><span class="ct-icon"></span></div><span class="ct-icon ct-node-type-icon"></span><i class="ct-icon-if-conditions" ng-if="(component.options['+o+"]['model']['globalconditions'] && component.options["+o+"]['model']['globalconditions'].length > 0) || component.options["+o+"]['model']['conditionspreview'] === '0'\"></i><span class=\"ct-nicename\" ng-if=\"editableFriendlyName!="+o+'" ng-bind="component.options[\''+e.id+'\'][\'nicename\']" /><span class="ct-nicename ct-nicename-editing" ng-blur="setEditableFriendlyName(0)" ng-change="updateFriendlyName('+o+')" ng-if="editableFriendlyName=='+o+'" contenteditable="true" data-plaintext="true" data-defaulttext="'+l+'" ng-Model="component.options[\''+e.id+"']['nicename']\" focus-me=\"true\" />"+r+'</div><div class="ct-dom-tree-horizontal-dash"></div></div>'}if(e.children){if("oxy_icon_box"==e.name){e=angular.copy(e);var h=angular.copy(e);h.name="oxy_icon_box_button_area",h.actualID=h.id,h.id=99999,h.children.splice(0,1),e.children.splice(1,0,h),e.children.length=2}k.generateDOMTreeNavigator(e,void 0,x,!0)}parseInt(e.id)<1e5&&(x.HTML+="</div>"),void 0===C&&(k.componentsTreeNavigator=x.HTML),k.findComponentItem(k.componentsTree.children,e.id,k.loadComponentNiceName)}else e.children&&k.generateDOMTreeNavigator(e,C,x);if(e.id==C){N=!0,k.removeDOMTreeNavigatorNode(e.id);var b=e.options.ct_parent<1e5?e.options.ct_parent:0;0===b&&k.innerContentRoot&&k.innerContentRoot.id&&(b=k.innerContentRoot.id);var f=window.parent.document.getElementById("ct-dom-tree-node-"+b);f=angular.element(f),k.cleanInsert(x.HTML,f,t+3,w),jQuery(f).removeClass("ct-dom-tree-no-children")}}})},k.updateDOMTreeNavigator=function(e,t){var o=window.parent.document.getElementById("ct-dom-tree");if(!o)return!1;c.showSidePanel,k.log&&console.log("updateDOMTreeNavigator()",e),k.functionStart("updateDOMTreeNavigator");var n={HTML:""},a=0;k.innerContentRoot&&k.innerContentRoot.id&&(a=k.innerContentRoot.id);var r='<div id="ct-dom-tree-node-'+a+'" ng-attr-tree-id="'+a+'" dragula="\'ct-dom-tree\'" class="oxy-dom-tree-root ct-accept-drops ct-elements-managers-bottom"><span></span><span></span><div  ng-mousedown="triggerCodeMirrorBlur(0);" ng-click="activateComponent(0, \'root\')" ng-class="{\'ct-dom-tree-node-selected\' : parentScope.isActiveId(0)}" ng-attr-tree-id="'+a+'" ng-click="activateComponent(0, \'root\')" class="ct-dom-tree-body-anchor ct-dom-tree-node-anchor ct-dom-tree-parent"><span class="ct-icon ct-dom-parent-icon"></span>'+(window.parent.document.getElementsByTagName("BODY")[0].classList.contains("ct_inner")?"Inner Content":"Body")+"</div>";void 0===e&&(o=angular.element(o)).empty(),k.functionStart("generateDOMTreeNavigator"),t||k.generateDOMTreeNavigator(k.componentsTree,e,n,!1),k.functionEnd("generateDOMTreeNavigator"),r+=n.HTML+"</div></div>",void 0===e&&k.cleanInsert(r,o),k.functionEnd("updateDOMTreeNavigator")},k.removeDOMTreeNavigatorNode=function(e){k.log&&console.log("try removeDOMTreeNavigatorNode()",e);var t=window.parent.document.getElementById("ct-dom-tree-node-"+e);t=angular.element(t);var o=jQuery(t).parent();0<t.length&&k.log&&console.log("DOMTreeNavigatorNode() removed",e,t),t.remove(),void 0!==t.scope()&&t.scope().$destroy(),t=null,jQuery(o).children().length<=3&&jQuery(o).addClass("ct-dom-tree-no-children")},k.toggleNode=function(e,t){if(void 0!==t&&(angular.element("#ct-sidepanel").trigger(t.type),t.stopPropagation()),k.latestDroppedDOMParent!=e){var o=angular.element("div[ng-attr-tree-id="+e+"]",window.parent.document);void 0===k.toggledNodes[e]&&o.hasClass("ct-dom-tree-node-expanded")?(k.toggledNodes[e]=!1,angular.element("div[ng-attr-tree-id="+e+"]",window.parent.document).removeClass("ct-dom-tree-node-expanded")):k.toggledNodes[e]=!k.toggledNodes[e]}else k.latestDroppedDOMParent=null},k.expandAllNodes=function(){for(var e in k.component.options)k.component.options.hasOwnProperty(e)&&(k.toggledNodes[e]=!0)},k.collapseAllNodes=function(){k.toggledNodes=[]},k.highlightDOMNode=function(r,e){if(k.log&&console.log("highlightDOMNode()",r),!(1e5<r)){if(!c.isShowTab("sidePanel","DOMTree")||!c.showSidePanel)return!1;e&&e.stopPropagation(),jQuery("#ct-dom-tree-node-"+r,window.parent.document).parents(".ct-dom-tree-node:not(.ct-dom-tree-node-expanded)").each(function(){var e=jQuery(this).attr("ng-attr-tree-id");k.toggledNodes[e]=!0});var i=s(function(){var e=0;k.innerContentRoot&&k.innerContentRoot.id&&(e=k.innerContentRoot.id);var t=jQuery("#ct-dom-tree-node-"+e,window.parent.document),o=t.scrollTop(),n=jQuery("#ct-dom-tree-node-"+r,window.parent.document);if(n.offset()){t.scrollTop(0);var a=n.offset().top;t.scrollTop(o),t.stop().animate({scrollTop:a-t.offset().top-120},500),s.cancel(i)}},500,!1)}},k.openLoadFolder=function(e,t,o,n){k.experimental_components[t].fresh?(o&&angular.element(n.target).addClass("oxygen-small-progress"),k.getComponentsListFromSource(e,t,function(e){o&&(c.tabs.components=[],angular.element(n.target).removeClass("oxygen-small-progress")),k.openFolder(e,t),c.applyMenuAim()})):(o&&(c.tabs.components=[]),k.openFolder(e,t))},k.openFolder=function(e,t){k.closeAllFolders(),k.openFolders[e]=void 0===t||t,"categories-categories"===e&&(void 0!==k.libraryCategories&&null!==k.libraryCategories||(k.libraryCategories={},k.libraryPages={},k.getStuffFromSource(k.processLibraryStuff)));s(function(){jQuery(".oxygen-folder-"+e+" .ct-add-item-button-image",window.parent.document).each(function(){jQuery(this).attr("src",jQuery(this).data("src"))})},0,!1);c.applyMenuAim()},k.processLibraryStuff=function(e){var t=(e=JSON.parse(e)).items,o=(e.key,parseInt(e.next));if(t){var n=t.components;n&&_.each(n,function(e){var t=e.category;void 0===t&&(t="Other"),k.libraryCategories[t]=k.libraryCategories[t]||{},k.libraryCategories[t].slug=btoa(t).replace(/=/g,""),k.libraryCategories[t].contents=k.libraryCategories[t].contents||[],k.libraryCategories[t].contents.push(e)});var a=t.pages;a&&_.each(a,function(e){if("ct_template"!==e.type){var t=e.category;void 0===t&&(t="Other"),k.libraryPages[t]=k.libraryPages[t]||{},k.libraryPages[t].slug=btoa(t).replace(/=/g,""),k.libraryPages[t].contents=k.libraryPages[t].contents||[],k.libraryPages[t].contents.push(e)}})}k.getStuffFromSource(k.processLibraryStuff,o),c.applyMenuAim()},k.closeAllFolders=function(e){k.openFolders={}},k.isShowFolder=function(e){return!!k.openFolders[e]},k.hasOpenFolders=function(){return 0<Object.keys(k.openFolders).length}}]);
...
CTFrontendBuilder.controller("ControllerAJAX",["$scope","$parentScope","$http","$timeout",function(y,g,f,x){y.postsData=[],y.showErrorModal=function(e,o,t,n){var r="";r=e&&0<e?("string"==typeof o?"<h4>"+o+"</h4>":"")+"<p><strong>"+("string"==typeof t?t:"")+" "+e+"</strong></p><p>Your server returned a "+e+" error for the request to "+n+".</p><p><a href='http://oxygenbuilder.com/documentation/troubleshooting/troubleshooting-guide/' style='text-decoration: underline; color: #fff;' target='_blank'>Troubleshooting Guide &raquo;</a></p>":("string"==typeof o?"<h4>"+o+"</h4>":"")+"<p><strong>"+("string"==typeof t?t:"")+"</strong></p>",y.showNoticeModal("<div>"+r+"</div>")},y.savePage=function(a){a||g.showLoadingOverlay("savePage()"),g.disableContentEdit();var e={classes:y.classes,custom_selectors:y.customSelectors,style_sets:y.styleSets,style_folders:y.styleFolders,style_sheets:y.styleSheets,page_settings:y.pageSettingsMeta,global_settings:y.globalSettings,easy_posts_templates:y.easyPostsCustomTemplates,comments_list_templates:y.commentsListCustomTemplates,typekit_fonts:y.typeKitFonts,global_colors:y.globalColorSets,preview:(y.previewType,y.template.postData.permalink)};y.googleFontsCache||(e.google_fonts_cache=y.googleFontsList),angular.forEach(y.activeSelectors,function(e,o){y.findComponentItem(y.componentsTree.children,o,y.updateComponentActiveSelector,e)});var o={params:e,tree:y.componentsTree};o=angular.toJson(o),e={action:"ct_save_components_tree",post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};(jQuery("body").hasClass("ct_inner")||jQuery("body",window.parent.document).hasClass("ct_inner"))&&(e.ct_inner=!0),f({url:y.getAJAXRequestURL(),method:"POST",params:e,data:o,transformResponse:!1}).success(function(o,t,e,n){try{var r;if(a)0!=(r=JSON.parse(o)).post_saved&&y.allSaved();else 0===(r=JSON.parse(o))?y.showErrorModal(0,"YOUR PAGE WAS NOT SAVED BECAUSE YOU ARE NOT LOGGED IN. Open a new browser tab and log back in to WordPress. Then attempt to save the page again."):0==r.post_saved?(console.log(o),y.showErrorModal(0,"Error occurred while saving")):y.allSaved(),g.hideLoadingOverlay("savePage()")}catch(e){console.log(o),console.log(e),a||y.showErrorModal(t,"Error occurred while saving",e)}}).error(function(e,o,t,n){console.log(e,o),a||g.hideLoadingOverlay("savePage()")}).then(null,function(e){y.showErrorModal(e.status,"Error occurred while saving",e.statusText,e.config.url)})},y.updatePageCSS=function(){g.showLoadingOverlay("updatePageCSS()"),f({url:CtBuilderAjax.permalink,method:"POST",params:{xlink:"css",action:"save-css"},transformResponse:!1}).success(function(e,o,t,n){g.hideLoadingOverlay("updatePageCSS()")}).error(function(e,o,t,n){console.log(e,o),g.hideLoadingOverlay("updatePageCSS()")}).then(null,function(e){y.showErrorModal(e.status,"Error occurred while saving CSS",e.statusText,e.config.url)})},y.updateComponentActiveSelector=function(e,o,t){o&&o.options&&(o.options.activeselector=t)},y.saveComponentAsView=function(a,e,s){var o={action:"ct_save_component_as_view",name:y.componentizeOptions.name,post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce,block:s},i=s?"Block":"Re-usable part";if(e.constructor===Array)var t=e;else t=[e];f({url:CtBuilderAjax.ajaxUrl,method:"POST",params:o,data:{id:0,name:"root",depth:0,children:t}}).success(function(e,o,t,n){if(g.hideLoadingOverlay("saveComponentAsView()"),0!=e){var r=s?"Manage Blocks in the WordPress admin at Oxygen &gt; Block Library.":"";y.showNoticeModal("<div>"+i+" '"+y.componentizeOptions.name+"' created. "+r+"</div>","ct-notice"),s||y.replaceReusablePart(a,e)}else y.showErrorModal(0,'Error occurred while saving "'+i+'".')}).error(function(e,o,t,n){console.log(e,o),g.hideLoadingOverlay("saveComponentAsView()")}).then(null,function(e){y.showErrorModal(e.status,'Error occurred while saving "'+i+'".',e.statusText,e.config.url)})},y.postComponentize=function(e,o){g.showLoadingOverlay("postComponentize()");var t={action:"ct_componentize",id_to_update:y.componentizeOptions.idToUpdate,name:y.componentizeOptions.name,design_set_id:y.componentizeOptions.designSetId,category_id:y.componentizeOptions.categoryId,screenshot:y.componentizeOptions.assetId,post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce},n=angular.copy(o);if(y.addComponentClassesStyles(n),o.constructor===Array)var r=n;else r=[n];f({url:CtBuilderAjax.ajaxUrl,method:"POST",params:t,transformResponse:!1,data:{id:0,name:"root",depth:0,children:r}}).success(function(e,o,t,n){"ok"==(e=JSON.parse(e)).status?alert('Re-usable part "'+y.componentizeOptions.name+'" saved successfully.'):"error"==e.status?y.showErrorModal(0,e.message):y.showErrorModal(0,'Unknown error occurred while saving "Re-usable part".'),g.hideLoadingOverlay("postComponentize()")}).error(function(e,o,t,n){console.log(e,o),g.hideLoadingOverlay("postComponentize()")}).then(null,function(e){y.showErrorModal(e.status,'Error occurred while saving "Re-usable part".',e.statusText,e.config.url)})},y.postAsset=function(e,r){if(void 0!==e){g.showLoadingOverlay("postAsset()");var o={action:"ct_post_asset",file_name:e.name,file_type:e.type,post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};f({url:CtBuilderAjax.ajaxUrl,method:"POST",params:o,transformResponse:!1,data:e}).success(function(e,o,t,n){"ok"==(e=JSON.parse(e)).status?(y.componentizeOptions.assetId=e.asset_id,r()):"error"==e.status?y.showErrorModal(0,"Error occurred while posting asset:"+e.message):y.showErrorModal(0,"Unknown error occurred while posting asset."),g.hideLoadingOverlay("postAsset()")}).error(function(e,o,t,n){console.log(e,o),g.hideLoadingOverlay("postAsset()")}).then(null,function(e){y.showErrorModal(e.status,"Error occurred while posting asset.",e.statusText,e.config.url)})}else alert("No asset provided")},y.pageComponentize=function(){g.showLoadingOverlay("pageComponentize()");var r={action:"ct_componentize_page",name:y.componentizeOptions.pageName,design_set_id:y.componentizeOptions.designSetId,screenshot:y.componentizeOptions.assetId,post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce},e=angular.copy(y.componentsTree);y.addComponentClassesStyles(e),f({url:CtBuilderAjax.ajaxUrl,method:"POST",params:r,transformResponse:!1,data:e}).success(function(e,o,t,n){"ok"==(e=JSON.parse(e)).status?alert('Re-usable page "'+r.name+'" saved successfully.'):"error"==e.status?y.showErrorModal(0,e.message):y.showErrorModal(0,'Unknown error occurred while saving "Re-usable page".'),g.hideLoadingOverlay("pageComponentize()")}).error(function(e,o,t,n){console.log(e,o),g.hideLoadingOverlay("pageComponentize()")}).then(null,function(e){y.showErrorModal(e.status,'Error occurred while saving "Re-usable page".',e.statusText,e.config.url)})},y.loadComponentsTree=function(a,s,i,l){y.log&&console.log("loadComponentsTree()",s,i,l),g.showLoadingOverlay("loadComponentsTree()"),void 0===s&&(s=CtBuilderAjax.postId);var e={action:"ct_get_components_tree",id:s,post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};jQuery("body").hasClass("ct_inner")&&(e.ct_inner=!0),f({url:CtBuilderAjax.ajaxUrl,method:"POST",params:e,transformResponse:!1}).success(function(o,e,t,n){try{var r=JSON.parse(o);a(r,s,i,l)}catch(e){console.log(o,e),y.showErrorModal(0,"Error occurred while loading post: "+s,e)}g.hideLoadingOverlay("loadComponentsTree()")}).error(function(e,o,t,n){console.log(e,o)}).then(null,function(e){y.showErrorModal(e.status,"Error occurred while loading post: "+s,e.statusText,e.config.url)})},y.renderInnerContent=function(s,e){var o=CtBuilderAjax.permalink,t={};o="term"===y.previewType?(t.term=y.template.postData.term,y.template.postData&&y.template.postData.permalink?y.template.postData.permalink:CtBuilderAjax.ajaxUrl):(t.post=y.template.postData,y.template.postData&&y.template.postData.permalink?t.post.permalink:CtBuilderAjax.ajaxUrl);var n={action:"ct_render_innercontent",post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};f({url:o,method:"POST",params:n,transformResponse:!1}).success(function(e,o,t,n){if(0!==parseInt(e)){var r=y.getComponentById(s);r.html();var a=angular.element("<div>");a.html(e),r.append(a),y.adjustResizeBox()}}).error(function(e,o,t,n){console.log(e,o)}).then(null,function(e){y.showErrorModal(e.status,"Error occurred while rendering innercontent",e.statusText,e.config.url)})},y.evalCondition=function(r){var e;if(void 0===r&&(r=y.component.active.id),0<(e=y.getComponentById(r).closest(".oxy-dynamic-list")).length){var o=e.attr("ng-attr-component-id");y.dynamicListAction(o,r)}else if(y.component.options[r].original&&y.component.options[r].original.conditions&&0<y.component.options[r].original.conditions.length){var t=CtBuilderAjax.permalink,n={};t="term"===y.previewType?(n.term=y.template.postData.term,y.template.postData&&y.template.postData.permalink?y.template.postData.permalink:CtBuilderAjax.permalink):(n.post=y.template.postData,y.template.postData&&y.template.postData.permalink?n.post.permalink:CtBuilderAjax.permalink);var a={action:"ct_eval_condition",post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};f({url:t,method:"POST",params:a,data:JSON.stringify(y.component.options[r]),transformResponse:!1}).success(function(e,o,t,n){void 0!==(e=JSON.parse(e)).result&&y.setOptionModel("conditionsresult",e.result,r,y.component.options[r].name)}).error(function(e,o,t,n){console.log(e,o),y.adjustResizeBox()}).then(null,function(e){y.showErrorModal(e.status,"Error occurred while evaluation condition",e.statusText,e.config.url)})}else delete iframeScope.component.options[r].model.conditionsresult},y.renderShortcode=function(c,e,p,u){if(y.component.options[c]&&y.component.options[c].original&&"true"==y.component.options[c].original.dont_render){y.getComponentById(c).html("")}else{var m=CtBuilderAjax.permalink,o={};m="term"===y.previewType?(o.term=y.template.postData.term,y.template.postData&&y.template.postData.permalink?y.template.postData.permalink:CtBuilderAjax.permalink):(o.post=y.template.postData,y.template.postData&&y.template.postData.permalink?o.post.permalink:CtBuilderAjax.permalink);var g,h={action:"ct_render_shortcode",shortcode_name:e,post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce},t=y.getComponentById(c),n=!1,r=[];if(t)for(var a=t.parent().closest(".oxy-dynamic-list");a&&0<a.length;)n=parseInt(a.attr("ng-attr-component-id")),y.component.options[n].original.use_acf_repeater?(a=a.parent().closest(".oxy-dynamic-list"),r.push(y.component.options[n].original.acf_repeater)):(n=parseInt(a.attr("ng-attr-component-id")),a=!1);if(n&&u){var s=y.component.options[n];u.queryOptions={query_args:s.original.query_args,wp_query:y.component.options[n].original.use_acf_repeater?"default":s.original.wp_query,query_post_ids:s.original.query_post_ids,query_post_types:s.original.query_post_types,query_taxonomies_any:s.original.query_taxonomies_any,query_taxonomies_all:s.original.query_taxonomies_all,query_authors:s.original.query_authors,query_order:s.original.query_order,query_order_by:s.original.query_order_by,query_all_posts:s.original.query_all_posts,query_ignore_sticky_posts:s.original.query_ignore_sticky_posts,query_count:s.original.query_count},g=JSON.stringify(u.queryOptions),0<r.length&&(u.acfRepeaterFields=r.reverse(),g+=JSON.stringify(u.acfRepeaterFields))}if(p&&(y.oxygenShortcodesCache=y.oxygenShortcodesCache||[],u&&u.original&&u.original.full_shortcode&&-1<u.original.full_shortcode.indexOf("[oxygen"))){var i=_.findWhere(y.oxygenShortcodesCache,{id:h.post_id,url:m,full_shortcode:u.original.full_shortcode,queryOptions:g});if(i)return void p(u.original.full_shortcode,i.result)}f({url:m,method:"POST",params:h,data:u?JSON.stringify(u):JSON.stringify(y.component.options[c]),transformResponse:!1}).success(function(e,o,t,n){if(e||""===e){var r=y.getComponentById(c),a=angular.element("<div>");if(a.html(e),p){y.oxygenShortcodesCache=y.oxygenShortcodesCache||[];var s=a.find("#ct-shortcode-links-scripts").html();y.oxygenShortcodesCache.push({id:h.post_id,url:m,full_shortcode:u.original.full_shortcode,queryOptions:g,result:s}),p(u.original.full_shortcode,s)}else{r.html(a.find("#ct-shortcode-links-scripts").html());var i=r.closest("body");i.find('link[data-forId="'+c+'"], script[data-forId="'+c+'"]').remove(),a.find("link, script").each(function(){i.append(angular.element(this).attr("data-forId",c))});var l=x(function(){jQuery.ready(),x.cancel(l)},1e3,!1)}var d=new Event("oxygen-ajax-element-loaded");document.dispatchEvent(d)}else console.log(e,o),p&&p(u.original.full_shortcode,""),y.showErrorModal(0,"Error occurred while rendering shortcode");y.adjustResizeBox()}).error(function(e,o,t,n){console.log(e,o),y.adjustResizeBox()}).then(null,function(e){y.showErrorModal(e.status,"Error occurred while rendering shortcode",e.statusText,e.config.url)})}},y.evalConditionsViaAjax=function(e,r){var o=CtBuilderAjax.permalink,t={};o="term"===y.previewType?(t.term=y.template.postData.term,y.template.postData&&y.template.postData.permalink?y.template.postData.permalink:CtBuilderAjax.permalink):(t.post=y.template.postData,y.template.postData&&y.template.postData.permalink?t.post.permalink:CtBuilderAjax.permalink);var n={action:"ct_eval_conditions",post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};f({url:o,method:"POST",params:n,data:JSON.stringify(e),transformResponse:!1}).success(function(e,o,t,n){e=JSON.parse(e),r&&r(e)}).error(function(e,o,t,n){console.log(e,o)}).then(null,function(e){y.showErrorModal(e.status,"Error occurred while evaluating conditions",e.statusText,e.config.url)})},y.removeChromeModal=function(e){if(e.stopPropagation(),e.preventDefault(),jQuery(e.target).hasClass("ct-chrome-modal-bg")||jQuery(e.target).hasClass("ct-chrome-modal-hide")){var o={action:"ct_remove_chrome_modal",post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};f({url:CtBuilderAjax.ajaxUrl,method:"POST",params:o,transformResponse:!1}).success(function(e,o,t,n){jQuery(".ct-chrome-modal-bg").remove()}).error(function(e,o,t,n){console.log(e,o)}).then(null,function(e){y.showErrorModal(e.status,"Error occurred while dismissing the notice",e.statusText,e.config.url)})}},y.renderDataComponent=function(a,e){var o=CtBuilderAjax.permalink,t={};o="term"===y.previewType?(t.term=y.template.postData.term,y.template.postData&&y.template.postData.permalink?y.template.postData.permalink:CtBuilderAjax.ajaxUrl):(t.post=y.template.postData,y.template.postData&&y.template.postData.permalink?t.post.permalink:CtBuilderAjax.ajaxUrl);var s={action:"ct_render_data_component",component_name:e,post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};f({url:o,method:"POST",params:s,data:JSON.stringify(y.component.options[a]),transformResponse:!1}).success(function(e,o,t,n){if(e||""===e){var r=y.getComponentById(a);switch(s.component_name){case"ct_data_featured_image":case"ct_data_author_avatar":e=JSON.parse(e),r[0].src=e.src;break;default:r.html(e)}}else console.log(e,o),y.showErrorModal(0,"Error occurred while rendering the component")}).error(function(e,o,t,n){console.log(e,o)}).then(null,function(e){y.showErrorModal(e.status,"Error occurred while rendering the component",e.statusText,e.config.url)})},y.renderWidget=function(i,l){if("true"!=y.component.options[i].original.dont_render||l){y.log&&console.log("renderWidget()",i,l);var e=JSON.stringify({options:y.component.options[i]}),o=CtBuilderAjax.ajaxUrl,t={post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};l?(t.action="ct_render_widget_form",g.cleanInsertUI("<span></span>","#ct-dialog-widget-content"),g.showSidebarLoader=!0):(t.action="ct_render_widget",g.showWidgetOverlay(i),o=y.getAJAXRequestURL()),f({url:o,method:"POST",params:t,data:e,transformResponse:!1}).success(function(e,o,t,n){var r=y.getComponentById(i);if(e)if(l){var a=x(function(){g.cleanInsertUI('<form id="ct-widget-form" class="open">'+e+"</form>","#ct-dialog-widget-content"),window.parent.jQuery(window.parent.document).trigger("widget-added",[jQuery("#ct-widget-form",window.parent.document)]),x.cancel(a)},0,!1);g.showSidebarLoader=!1}else{void 0!==window.google&&void 0!==window.google.maps&&"sow-google-map"==y.component.options[i].id.id_base&&delete window.google.maps,r.html(e);a=x(function(){jQuery.ready(),x.cancel(a)},1e3,!1);g.hideWidgetOverlay(i),y.adjustResizeBox()}e&&""!==r.text()||l||r.html("<div class='ct-blank-widget'>Widget Content</div>");var s=new Event("oxygen-ajax-element-loaded");document.dispatchEvent(s)}).error(function(e,o,t,n){y.getComponentById(i).html("<div class='ct-blank-widget'>Widget Content<div>")})}else{y.getComponentById(i).html("")}},y.renderSidebar=function(s,e){var o=JSON.stringify({options:y.component.options[s]}),t={post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce,action:"ct_render_sidebar"};f({url:CtBuilderAjax.ajaxUrl,method:"POST",params:t,data:o,transformResponse:!1}).success(function(e,o,t,n){var r=y.getComponentById(s);e&&r.html(e),e&&""!==r.text()||r.html("<div class='ct-blank-widget'>Sidebar Content</div>");var a=new Event("oxygen-ajax-element-loaded");document.dispatchEvent(a)}).error(function(e,o,t,n){y.getComponentById(s).html("<div class='ct-blank-widget'>Sidebar Content<div>")})},y.renderNavMenu=function(a){void 0===a&&(a=y.component.active.id),y.log&&console.log("renderNavMenu()",a),g.showWidgetOverlay(a);var e=JSON.stringify({options:y.component.options[a]}),o=y.getAJAXRequestURL();params={post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce,action:"oxy_render_nav_menu"},f({url:o,method:"POST",params:params,data:e,transformResponse:!1}).success(function(e,o,t,n){var r=y.getComponentById(a);e?r.html(e):r.html("No menu found"),y.adjustResizeBox(),g.hideWidgetOverlay(a)}).error(function(e,o,t,n){console.log(e,o)}).then(null,function(e){y.showErrorModal(e.status,"Error occurred while rendering menu",e.statusText,e.config.url)})},y.getDynamicDataFromQuery=function(r,e,a,s,o,t,n){void 0===r&&(r=y.component.active.id),y.log&&console.log("getDynamicListData()",action,r);var i=CtBuilderAjax.permalink;if(CtBuilderAjax.oxyTemplate&&!CtBuilderAjax.oxyReusable){if(!y.template.postData||!y.template.postData.permalink)return void y.showErrorModal(0,"Permalink not available for the current post/archive. If it is an archive for a custom post type , make sure that the parameter 'has_archive' for the post type is set to true.");i=y.template.postData.permalink+("/"==y.template.postData.permalink.substr(y.template.postData.permalink.length-1)?"":"/")}else CtBuilderAjax.oxyReusable&&CtBuilderAjax.ctSiteUrl&&(i=CtBuilderAjax.ctSiteUrl+"/");var l={options:y.component.options[r],models:e};if(o){var d=y.component.options[o];l.queryOptions={query_args:d.original.query_args,wp_query:d.original.wp_query,query_post_ids:d.original.query_post_ids,query_post_types:d.original.query_post_types,query_taxonomies_any:d.original.query_taxonomies_any,query_taxonomies_all:d.original.query_taxonomies_all,query_authors:d.original.query_authors,query_order:d.original.query_order,query_order_by:d.original.query_order_by,query_all_posts:d.original.query_all_posts,query_ignore_sticky_posts:d.original.query_ignore_sticky_posts,query_count:d.original.query_count}}t&&0<t.length&&(l.acfRepeaterFields=t.reverse());l=JSON.stringify(l);var c={post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce,action:"oxy_get_dynamic_data_query"};g.showWidgetOverlay(r),f({url:i,method:"POST",params:c,data:l,transformResponse:!1}).success(function(e,o,t,n){e?(e=JSON.parse(e),a&&a(e.results,s,e.pagination?e.pagination:null)):component.html("No data received"),g.hideWidgetOverlay(r)}).error(function(e,o,t,n){console.log(e,o)}).then(null,function(e){y.showErrorModal(e.status,"Error occurred",e.statusText,e.config.url)})},y.renderComponentWithAJAX=function(s,i){void 0===i&&(i=y.component.active.id);var e=y.getComponentById(i);if(e){var o=e.parents(".oxy-product-builder").attr("ng-attr-component-id");y.log&&console.log("renderComponentWithAJAX()",s,i);var t=y.component.options[i];if(o){var n=y.getOption("oxy-product-builder_product_id",o);t.product_builder_id=n}var r={options:t,component:y.findComponentItem(y.componentsTree.children,i,y.getComponentItem)},a=y.getAJAXRequestURL(),l={post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce,action:s},d=y.getComponentById(i),c=!1,p=[];if(d)for(var u=d.parent().closest(".oxy-dynamic-list");u&&0<u.length;)c=parseInt(u.attr("ng-attr-component-id")),y.component.options[c].original.use_acf_repeater?(u=u.parent().closest(".oxy-dynamic-list"),p.push(y.component.options[c].original.acf_repeater)):(c=parseInt(u.attr("ng-attr-component-id")),u=!1);if(c){var m=y.component.options[c];r.queryOptions={query_args:m.original.query_args,wp_query:y.component.options[c].original.use_acf_repeater?"default":m.original.wp_query,query_post_ids:m.original.query_post_ids,query_post_types:m.original.query_post_types,query_taxonomies_any:m.original.query_taxonomies_any,query_taxonomies_all:m.original.query_taxonomies_all,query_authors:m.original.query_authors,query_order:m.original.query_order,query_order_by:m.original.query_order_by,query_all_posts:m.original.query_all_posts,query_ignore_sticky_posts:m.original.query_ignore_sticky_posts,query_count:m.original.query_count},0<p.length&&(r.acfRepeaterFields=p.reverse())}g.showWidgetOverlay(i),"oxy_render_easy_posts"==s&&jQuery(".oxygen-easy-posts-ajax-styles-"+i).remove(),f({url:a,method:"POST",params:l,data:JSON.stringify(r),transformResponse:!1}).success(function(e,o,t,n){var r=y.getComponentById(i);if(e){r.html(e),r.removeClass("oxy-ajax-loading"),"oxy_render_easy_posts"==s&&r.find(".oxygen-easy-posts-ajax-styles-"+i).prependTo("head");var a=new Event("oxygen-ajax-element-loaded");document.dispatchEvent(a)}else r.html("No data received");y.adjustResizeBox(),g.hideWidgetOverlay(i)}).error(function(e,o,t,n){console.log(e,o)}).then(null,function(e){y.showErrorModal(e.status,"Error occurred while rendering the component",e.statusText,e.config.url)})}},y.loadSVGIconSets=function(){var e={action:"ct_get_svg_icon_sets",post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};f({url:CtBuilderAjax.ajaxUrl,method:"POST",params:e,transformResponse:!1}).success(function(o,e,t,n){try{var r=JSON.parse(o);y.SVGSets=r,y.currentSVGSet=Object.keys(r)[0]}catch(e){console.log(o),console.log(e),y.showErrorModal(0,"Error occurred while loading SVG icons")}}).error(function(e,o,t,n){console.log(e,o)}).then(null,function(e){y.showErrorModal(e.status,"Error occurred while loading SVG icons",e.statusText,e.config.url)})},y.loadAttachmentSizes=function(e,r){var o={action:"ct_get_attachment_sizes",post_id:CtBuilderAjax.postId,attachment_id:e,nonce:CtBuilderAjax.nonce};f({url:CtBuilderAjax.ajaxUrl,method:"POST",params:o,transformResponse:!1}).success(function(o,e,t,n){try{o=JSON.parse(o)}catch(e){console.log(o),console.log(e),y.showErrorModal(0,"Error occurred while loading attachment sizes")}r(o)}).error(function(e,o,t,n){console.log(e,o)}).then(null,function(e){y.showErrorModal(e.status,"Error occurred while loading attachment sizes",e.statusText,e.config.url)})},y.loadTemplateData=function(a,e,o){o||g.showLoadingOverlay("loadTemplateData()");var t={action:"ct_get_template_data",template_id:CtBuilderAjax.postId,preview_post_id:e,preview_type:y.previewType,post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};f({url:CtBuilderAjax.ajaxUrl,method:"POST",params:t,transformResponse:!1}).success(function(o,e,t,n){try{var r=JSON.parse(o);a(r)}catch(e){console.log(o),console.log(e),y.showErrorModal(0,"Failed to load template data",e)}g.hideLoadingOverlay("loadTemplateData()")}).error(function(e,o,t,n){console.log(e,o),g.hideLoadingOverlay("loadTemplateData()")}).then(null,function(e){y.showErrorModal(e.status,"Failed to load template data",e.statusText,e.config.url)})},y.loadComponentsTemplates=function(){g.showLoadingOverlay("loadComponentsTemplates()");var e={action:"oxy_get_components_templates",nonce:CtBuilderAjax.nonce,post_id:CtBuilderAjax.postId};f({url:CtBuilderAjax.ajaxUrl,method:"POST",params:e,transformResponse:!1}).success(function(o,e,t,n){try{var r=JSON.parse(o);y.componentsTemplates=r}catch(e){console.log(o),console.log(e),y.showErrorModal(0,"Failed to load templates",e),g.hideLoadingOverlay("loadComponentsTemplates()")}if(CtBuilderAjax.ctTemplate)y.loadTemplateData(y.setTemplateData,null,!0);else if(g.hideLoadingOverlay("loadComponentsTemplates()"),y.componentsTree.children){y.buildComponentsFromTree(y.componentsTree.children);!function e(o){o++,setTimeout(function(){0<y.buildingOxygenTreeCounter&&o<30?e(o):(y.updateDOMTreeNavigator(),y.classesCached=!1,y.outputCSSOptions(),y.component.id++)},500)}(0)}else y.updateDOMTreeNavigator()}).error(function(e,o,t,n){console.log(e,o),CtBuilderAjax.ctTemplate?y.loadTemplateData(y.setTemplateData,null,!0):(g.hideLoadingOverlay("loadComponentsTemplates()"),y.componentsTree.children&&(y.buildComponentsFromTree(y.componentsTree.children),y.component.id++))}).then(null,function(e){y.showErrorModal(e.status,"Failed to load templates",e.statusText,e.config.url)})},y.loadPostData=function(a,s,i){if(y.postsData[s])a(y.postsData[s],i);else{g.showLoadingOverlay("loadPostData()");var e={action:"ct_get_post_data",id:s,post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce,preview_post_id:y.template.postData.ID};f({url:CtBuilderAjax.ajaxUrl,method:"POST",params:e,transformResponse:!1}).success(function(o,e,t,n){try{var r=JSON.parse(o);a(r,i),y.postsData[s]=r}catch(e){console.log(o),console.log(e),y.showErrorModal(0,"Failed to load post data. ID: "+s,e)}g.hideLoadingOverlay("loadPostData()")}).error(function(e,o,t,n){console.log(e,o),g.hideLoadingOverlay("loadPostData()")}).then(null,function(e){y.showErrorModal(e.status,"Failed to load post data. ID: "+s,e.statusText,e.config.url)})}},y.execCode=function(e,r,a){var o=y.getAJAXRequestURL(),t={code:y.b64EncodeUnicode(e),query:CtBuilderAjax.query};t=JSON.stringify(t),f({method:"POST",transformResponse:!1,url:o,params:{action:"ct_exec_code",post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce},data:t}).success(function(e,o,t,n){0===e.trim().length&&(e=""),-1<e.indexOf("<html")&&(e=jQuery("<div>").append(e).find(".ct-code-block").html()),(e=jQuery("<div>").append(e)).find("script").remove(),e=e.html(),a(e,r)}).error(function(e,o,t,n){console.log(e,o)})},y.getStuffFromSource=function(r,e){void 0===e&&setTimeout(function(){angular.element(".oxygen-sidebar-breadcrumb",window.parent.document).addClass("oxygen-small-progress")},100);var o={action:"ct_new_style_api_call",call_type:"get_stuff_from_source",post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};if(0===parseInt(e))return angular.element(".oxygen-sidebar-breadcrumb",window.parent.document).removeClass("oxygen-small-progress"),!1;null!=e&&(o.next=e),f({method:"GET",transformResponse:!1,url:CtBuilderAjax.ajaxUrl,params:o}).success(function(e,o,t,n){r(e)}).error(function(e,o,t,n){console.log(e,o)})},y.getComponentsListFromSource=function(i,l,d){setTimeout(function(){angular.element(".oxygen-sidebar-breadcrumb",window.parent.document).addClass("oxygen-small-progress")},200),f({method:"GET",transformResponse:!1,url:CtBuilderAjax.ajaxUrl,params:{action:"ct_new_style_api_call",call_type:"get_items_from_source",name:l,post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce}}).success(function(e,o,t,n){var r=!1;if(e&&""!=e.trim()||(r=!0),r||(e=JSON.parse(e)),r||!e.components)return y.showErrorModal(0,"Items not loaded. "+(e.error?e.error:"Try again!")),void angular.element(".oxygen-sidebar-breadcrumb",window.parent.document).removeClass("oxygen-small-progress");if(angular.element(".oxygen-sidebar-breadcrumb",window.parent.document).removeClass("oxygen-small-progress"),delete y.experimental_components[l].fresh,y.experimental_components[l].items={},_.each(e.components,function(e){var o=e.category;o&&(y.experimental_components[l].items[o]=y.experimental_components[l].items[o]||{},y.experimental_components[l].items[o].slug=btoa(o).replace(/=/g,""),y.experimental_components[l].items[o].contents=y.experimental_components[l].items[o].contents||[],y.experimental_components[l].items[o].contents.push(e))}),CtBuilderAjax.freeVersion&&_.each(y.experimental_components[l].items,function(e,o){var t=Math.round(e.contents.length/10);t<1?t=1:4<t&&(t=4);for(var n=0;n<e.contents.length;n++)e.contents[n].firstFew=n<t?1:0}),y.experimental_components[l].pages=y.experimental_components[l].pages||[],y.experimental_components[l].templates=y.experimental_components[l].templates||[],_.each(e.pages,function(e){"ct_template"===e.type?y.experimental_components[l].templates.push(e):y.experimental_components[l].pages.push(e)}),CtBuilderAjax.freeVersion){var a=Math.round(y.experimental_components[l].pages.length/10);a<1?a=1:4<a&&(a=4);for(var s=0;s<y.experimental_components[l].pages.length;s++)y.experimental_components[l].pages[s].firstFew=s<a?1:0;(a=Math.round(y.experimental_components[l].templates.length/10))<1?a=1:4<a&&(a=4);for(s=0;s<y.experimental_components[l].templates.length;s++)y.experimental_components[l].templates[s].firstFew=s<a?1:0}d(i),angular.element(".oxygen-sidebar-breadcrumb",window.parent.document).removeClass("oxygen-small-progress")}).error(function(e,o,t,n){console.log(e,o),angular.element(".oxygen-sidebar-breadcrumb",window.parent.document).removeClass("oxygen-small-progress")})},y.getPageFromSource=function(e,r,a,s){g.showLoadingOverlay("getPageFromSource()"),f({method:"GET",transformResponse:!1,url:CtBuilderAjax.ajaxUrl,params:{action:"ct_new_style_api_call",nonce:CtBuilderAjax.nonce,call_type:"get_page_from_source",id:e,post_id:CtBuilderAjax.postId,source:btoa(r)}}).success(function(e,o,t,n){s(e,r,a),g.hideLoadingOverlay()}).error(function(e,o,t,n){g.hideLoadingOverlay(),console.log(e,o)})},y.getComponentFromSource=function(e,r,a,o,s){g.showLoadingOverlay("getComponentFromSource()"),f({method:"GET",transformResponse:!1,url:CtBuilderAjax.ajaxUrl,params:{action:"ct_new_style_api_call",nonce:CtBuilderAjax.nonce,post_id:CtBuilderAjax.postId,call_type:"get_component_from_source",id:e,page:o,source:btoa(r)}}).success(function(e,o,t,n){g.hideLoadingOverlay(),s(e,!1,r,a)}).error(function(e,o,t,n){g.hideLoadingOverlay(),console.log(e,o)})},y.loadedControllers=[],y.loadControlsWithAJAX=function(r){if(!y.loadedControllers[r]){y.loadedControllers[r]=!0,g.showSidebarLoader=!0;var e=CtBuilderAjax.ajaxUrl,o={action:"oxy_load_controls_"+r,post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};f({method:"POST",url:e,params:o}).success(function(e,o,t,n){e?g.compileInsertUI(e,"#oxygen-sidebar-control-panel-basic-styles",0):console.log("No controls for "+r),g.showSidebarLoader=!1}).error(function(e,o,t,n){console.log(e,o),g.showSidebarLoader=!1})}},y.getSoundCloudTrackID=function(e){g.showLoadingOverlay("getSoundCloudTrackID()");var o=CtBuilderAjax.ajaxUrl,t={action:"oxy_get_soundcloud_track_id",soundcloud_url:e,post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};f({method:"POST",url:o,params:t}).success(function(e,o,t,n){e?y.setOptionModel("soundcloud_track_id",e):y.showErrorModal(0,"Error retrieving SoundCloud Track ID. Please check the URL you specified"),g.hideLoadingOverlay()}).error(function(e,o,t,n){console.log(e,o),g.hideLoadingOverlay()})},y.getAJAXRequestURL=function(){var e=CtBuilderAjax.permalink;return CtBuilderAjax.oxyTemplate&&(e=y.template.postData&&y.template.postData.permalink?y.addTrailingSlash(y.template.postData.permalink):CtBuilderAjax.oxyReusable?y.addTrailingSlash(CtBuilderAjax.ctSiteUrl)+"?post_id="+CtBuilderAjax.postId:CtBuilderAjax.ajaxUrl),e},y.addTrailingSlash=function(e){return(e=e.replace(/\/+$/,""))+"/"}}]);
...
CTFrontendBuilder.controller("ControllerOptions",["$scope","$parentScope","$timeout",function(y,_,v){y.changesToApply=[],y.optionsHierarchy={background:{color:["background-color"],image:["background","background-image","overlay-color","video_background","video_background_overlay","background-blend-mode"],size:["background-size","background-repeat","background-attachment","background-position-left","background-position-top","background-size-width","background-size-height","background-clip"]},position:{margin_padding:["container-padding-top","container-padding-right","container-padding-bottom","container-padding-left","padding-top","padding-right","padding-bottom","padding-left","margin-top","margin-right","margin-bottom","margin-left","container-padding-top-unit","container-padding-right-unit","container-padding-bottom-unit","container-padding-left-unit","padding-top-unit","padding-right-unit","padding-bottom-unit","padding-left-unit","margin-top-unit","margin-right-unit","margin-bottom-unit","margin-left-unit"],size:["width","min-width","max-width","height","min-height","max-height","section-width","header-width","header-row-width","width-unit","min-width-unit","max-width-unit","height-unit","min-height-unit","max-height-unit"]},layout:{position:["display","float","visibility","z-index","clear","overflow","position","top","right","bottom","left","flex-direction","align-items","justify-content","flex-wrap","flex-reverse","align-content","order"]},typography:{typography:["font-family","font-size","font-weight","color","text-align","line-height","letter-spacing","text-decoration","font-style","text-transform","-webkit-font-smoothing"]},borders:{border:["border-top-color","border-top-style","border-top-width","border-right-color","border-right-style","border-right-width","border-bottom-color","border-bottom-style","border-bottom-width","border-left-color","border-left-style","border-left-width"],radius:["border-top-left-radius","border-top-right-radius","border-bottom-left-radius","border-bottom-right-radius","border-radius"]},effects:{opacity:["opacity"],transform:["transform"],transition:["transition-duration","transition-duration-unit","transition-timing-function","transition-delay","transition-delay-unit","transition-property"],"box-shadow":["box-shadow-inset","box-shadow-color","box-shadow-horizontal-offset","box-shadow-vertical-offset","box-shadow-blur","box-shadow-spread"],"text-shadow":["text-shadow-color","text-shadow-horizontal-offset","text-shadow-vertical-offset","text-shadow-blur"],"css-filter":["filter","filter-amount-blur","filter-amount-brightness","filter-amount-contrast","filter-amount-grayscale","filter-amount-hue-rotate","filter-amount-invert","filter-amount-saturate","filter-amount-sepia"],"animation-on-scroll":["aos-enable","aos-type","aos-easing","aos-duration","aos-offset","aos-delay","aos-anchor","aos-anchor-placement","aos-once"]},cssjs:{css:["custom-css"],js:["custom-js"]},"code-php":["code-php"],"code-css":["code-css"],"code-js":["code-js"]},y.builtinComponents={},y.lastSetEasyPostsTemplate=[],y.addNewColor=function(o,t,e){if(y.log&&console.log("addNewColor()",o,t,e),CtBuilderAjax.freeVersion)return _.hideAddNewColorDialog(),_.showDialogWindow(),void(_.dialogForms.showProGlobalColorEditDialog=!0);if("latest"==e&&(e=_.addNewColorDialogValue),void 0===e||""==e)return y.showErrorModal(0,"Color value is not defined"),_.hideAddNewColorDialog(),!1;if(void 0===o||""==o)return y.showErrorModal(0,"Color name is not defined"),_.hideAddNewColorDialog(),!1;var n=y.getGlobalColorSet(t);if(y.getGlobalColorbyName(o,n.name))return y.showErrorModal(0,"'"+o+"' already exist in '"+n.name+"' set"),_.newGlobalSettingsColorName="",_.hideAddNewColorDialog(),!1;void 0!==t&&""!==t||(t=0),y.globalColorSets.colorsIncrement++,y.globalColorSets.colors.push({id:y.globalColorSets.colorsIncrement,name:o,value:e,set:t}),y.parentScope.setGlobalColor(y.globalColorSets.colorsIncrement),_.hideAddNewColorDialog(),_.newGlobalColorName="",_.newGlobalColorValue="",_.newGlobalSettingsColorName="",_.showAddGlobalColorPanel=!1},y.addNewColorSet=function(o){return y.log&&console.log("addNewColorSet()",o),CtBuilderAjax.freeVersion?(_.showDialogWindow(),void(_.dialogForms.showProGlobalColorEditDialog=!0)):null==o||""==o?(y.showErrorModal(0,"Color Set name is not defined"),!1):y.getGlobalColorSetbyName(o)?(y.showErrorModal(0,"'"+o+"' name is already taken"),!1):(y.globalColorSets.setsIncrement++,y.globalColorSets.sets.push({id:y.globalColorSets.setsIncrement,name:o}),_.newGlobalColorSetName="",void(_.addGlobalColorSetPanel=!1))},y.isGlobalColorValue=function(o){return 0===o.indexOf("color(")},y.getGlobalColorID=function(o){if(y.log&&console.log("getGlobalColorID()",o),!o||"string"!=typeof o)return!1;if(0!==o.indexOf("color("))return!1;var t=/\(([^)]+)\)/.exec(o);return null!=t&&t[1]},y.getGlobalColorValue=function(o){y.log&&console.log("getGlobalColorValue()",o);var t=y.getGlobalColorID(o);if(!1===t)return o;var e=y.globalColorSets.colors.find(function(o){return o.id==t});return void 0===e||void 0===e.value?o:e.value},y.getGlobalColorNiceName=function(o){y.log&&console.log("getGlobalColorValue()",o);var t=y.getGlobalColorID(o);if(!1===t)return!1;var e=y.globalColorSets.colors.find(function(o){return o.id==t});if(void 0===e||void 0===e.value)return!1;var n=y.getGlobalColorSet(e.set);return void 0!==n&&void 0!==n.name&&n.name+" - "+e.name},y.getGlobalColor=function(t){return y.log&&console.log("getGlobalColor()",t),y.globalColorSets.colors.find(function(o){return o.id==t})},y.getGlobalColorbyName=function(t,o){y.log&&console.log("getGlobalColorbyName()",t,o);var e=y.getGlobalColorSetbyName(o);return y.globalColorSets.colors.find(function(o){return o.name==t&&o.set==e.id})},y.getGlobalColorSet=function(t){return y.log&&console.log("getGlobalColorSet()",t,y.globalColorSets.sets),y.globalColorSets.sets.find(function(o){return o.id==t})},y.getGlobalColorSetbyName=function(t){return y.log&&console.log("getGlobalColorSet()",t,y.globalColorSets.sets),y.globalColorSets.sets.find(function(o){return o.name==t})},y.deleteGlobalColorSet=function(t,o){if(!confirm("Are you sure to delete this set?"))return!1;var e=y.globalColorSets.sets.findIndex(function(o){return o.id==t});for(var e in y.globalColorSets.sets.splice(e,1),y.globalColorSets.colors){if(y.globalColorSets.colors.hasOwnProperty(e))y.globalColorSets.colors[e].set===t&&(y.globalColorSets.colors[e]=null)}y.globalColorSets.colors=y.globalColorSets.colors.filter(function(o){return null!==o}),!0===o&&(_.toggleSettingsPanel(!0),_.switchTab("settings","colors")),y.unsavedChanges()},y.deleteGlobalColor=function(t,o){var e=y.globalColorSets.colors.findIndex(function(o){return o.id==t});y.globalColorSets.colors.splice(e,1),y.unsavedChanges()},y.globalColorSetHasColors=function(t){return y.globalColorSets.colors.find(function(o){return o.set==t})},y.replaceGlobalColors=function(o){return void 0===o?o:o.replace(/color\(\d+\)/g,function(o){return y.getGlobalColorValue(o)})},y.replaceGlobalWooSettings=function(o){return void 0===o?o:(o=o.replace(/%%ASSETS_PATH%%/g,CtBuilderAjax.wooAssetsPath)).replace(/var\(.*?\)/g,function(o){if(o=(o=o.replace("var(","")).replace(")",""),y.globalSettings.woo&&y.globalSettings.woo[o]){var t="";y.globalSettings.woo[o+"-unit"]&&(t=y.globalSettings.woo[o+"-unit"]),o=y.globalSettings.woo[o]+t}return o=y.getGlobalColorValue(o)})},y.parseAPIOptions=function(o,t,e){return y.log&&console.log("replaceComponentOptions()",o,t,e),void 0!==o&&void 0!==t&&o&&t?o.replace(/%%\S+%%/g,function(o){return"%%ELEMENT_ID%%"===o?y.component.options[t].selector:(o=o.replace(/%%/g,""),"{{component.options["+t+"]['model']['"+o+"']}}")}):o},y.replaceComponentOptions=function(o,t,e){return y.log&&console.log("replaceComponentOptions()",o,t,e),void 0!==o&&void 0!==t&&o&&t?o.replace(/%%\S+%%/g,function(o){return"%%ELEMENT_ID%%"===o?y.component.options[t].selector:(o=o.replace(/%%/g,""),y.APIPresets.typography&&-1<y.APIPresets.typography.indexOf(o)?y.generateTypographyCSS(e,o):e?e[o]?e[o]+y.getOptionUnit(o):"":y.getOption(o,t)+y.getOptionUnit(o))}):o},y.updateTreeComponentOptions=function(o,t,e){y.log&&console.log("updateTreeComponentOptions()",o,t,e);var n=y.defaultOptions[t.name];y.currentState;n.ct_content&&(t.options.ct_content=n.ct_content)},y.updateTreeComponentOption=function(o,t,e){y.log&&console.log("updateTreeComponentOption()",o,t,e);var n=y.defaultOptions[t.name],i=y.currentState,s=e.optionName,r="";if(-1===y.optionsWhiteList.indexOf(s)&&-1===y.optionsWhiteListNoMedia.indexOf(s)&&(i="original"),0<=e.optionName.indexOf("fake_")&&0<=e.optionName.indexOf("hover_")&&(i="hover",s=s.replace("fake_","")),r="selector"==s?y.component.options[e.id][s]:!y.isEditing("id")||y.isEditing("state")||y.isEditing("media")?y.component.options[e.id].model[s]:y.component.options[e.id].id[s],0<=e.optionName.indexOf("fake_")&&0<=e.optionName.indexOf("hover_")&&(s=s.replace("hover_","")),"ct_column"==e.tag&&"width"==s)return t.options[i]||(t.options[i]={}),t.options[i][s]=r,y.component.options[e.id][i][s]=r,!0;if(y.isEditing("class")&&(0<=y.optionsWhiteList.indexOf(s)||0<=y.optionsWhiteListNoMedia.indexOf(s)||"icon-style"==s||"button-style"==s||"gradient"==s))y.classes[y.currentClass]&&(y.cache.classStyles[y.currentClass]="","icon-style"==s||"button-style"==s?y.classes[y.currentClass].original[s]=r:"selector"==s||"ct_id"==s||"ct_parent"==s||"ct_content"==s||"classes"==s||"url"==s&&e.isShortcode||(!y.isEditing("media")||0<=y.optionsWhiteListNoMedia.indexOf(s)?(y.classes[y.currentClass][i]||(y.classes[y.currentClass][i]={}),""==r?delete y.classes[y.currentClass][i][s]:y.classes[y.currentClass][i][s]=angular.copy(r)):(y.classes[y.currentClass].media||(y.classes[y.currentClass].media={}),y.classes[y.currentClass].media[y.currentMedia]||(y.classes[y.currentClass].media[y.currentMedia]={}),y.classes[y.currentClass].media[y.currentMedia][i]||(y.classes[y.currentClass].media[y.currentMedia][i]={}),""==r?delete y.classes[y.currentClass].media[y.currentMedia][i][s]:y.classes[y.currentClass].media[y.currentMedia][i][s]=r)));else if(y.isEditing("media")&&0<=y.optionsWhiteList.indexOf(s)&&"selector"!=s&&"ct_id"!=s&&"ct_parent"!=s)y.setMediaParameter(e.id,s,r,i),t.options.media||(t.options.media={}),t.options.media[y.currentMedia]||(t.options.media[y.currentMedia]={}),t.options.media[y.currentMedia][i]||(t.options.media[y.currentMedia][i]={}),""==r||null==r?(delete t.options.media[y.currentMedia][i][s],delete y.component.options[e.id].media[y.currentMedia][i][s],y.isObjectEmpty(t.options.media[y.currentMedia][i])&&delete t.options.media[y.currentMedia][i],y.isObjectEmpty(t.options.media[y.currentMedia])&&delete t.options.media[y.currentMedia],y.isObjectEmpty(t.options.media)&&delete t.options.media):t.options.media[y.currentMedia][i][s]=r;else if(y.component.options[e.id][i]||(y.component.options[e.id][i]={}),t.options[i]||(t.options[i]={}),-1<y.allowedEmptyOptions.indexOf(s)&&"original"==i?y.component.options[e.id][i][s]=r:void 0===r&&"original"==i?y.component.options[e.id][i][s]=n[s]:""===r?delete y.component.options[e.id][i][s]:y.component.options[e.id][i][s]=r,0<s.indexOf("-unit")){var a=s.replace("-unit","");y.component.options[e.id][i][s]!=n[s]||y.component.options[e.id][i][a]!=n[a]||y.component.options[e.id].id[a]?y.component.options[e.id][i][s]==n[s]?delete t.options[i][s]:(t.options[i][s]=r,t.options[i][a]=y.component.options[e.id][i][a]):(delete t.options[i][s],delete t.options[i][a])}else if(void 0!==n[s+"-unit"]&&n[s+"-unit"]!==y.component.options[e.id][i][s+"-unit"])""!=r&&null!=r?t.options[i][s]=r:(delete t.options[i][s],delete y.component.options[e.id][i][s],"original"==i&&(y.component.options[e.id][i][s]=n[s]));else if("ct_content"==s){var l=y.getComponentById(e.id),c=!1;if(l&&(c=l.attr("contenteditable")),c){var d=angular.element("<span>"+r+"</span>"),p=!1;angular.forEach(d.find("*"),function(o){var t=angular.element(o),e=t.attr("ng-attr-component-id");e&&(t.replaceWith('<span id="ct-placeholder-'+e+'"></span>'),p=!0)}),t.options[s]=p?d.prop("innerHTML"):r}else t.options[s]=r}else"selector"==s||"ct_id"==s||"ct_parent"==s||"classes"==s||"url"==s&&e.isShortcode?t.options[s]=r:i&&(""!==r&&void 0!==r||-1!==y.allowedEmptyOptions.indexOf(s)?t.options[i][s]=r:delete t.options[i][s])},y.updateTreeComponentTag=function(o,t,e){t.name=e,y.component.active.id==o&&(y.component.active.name=e),y.component.options[o].nicename&&""!==y.component.options[o].nicename.trim()&&(y.component.options[t.id].nicename=y.calcDefaultComponentTitle(t));var n=v(function(){y.rebuildDOM(o),y.updateDOMTreeNavigator(o),v.cancel(n)},0,!1)},y.applyComponentDefaultOptions=function(o,t,e){for(var n in y.log&&console.log("applyComponentDefaultOptions()",o,t),y.component.options[o]||(y.component.options[o]={}),y.component.options[o].original||(y.component.options[o].original={}),y.component.options[o].id||(y.component.options[o].id={}),y.defaultOptions[t])if(y.defaultOptions[t].hasOwnProperty(n)){var i=y.defaultOptions[t][n];y.component.options[o].original[n]=i,("font-family"==n||-1<n.indexOf("font-family"))&&y.loadWebFont(i)}y.component.options[o].selector||(y.component.options[o].selector=t.slice(3)+"-"+o+"-"+CtBuilderAjax.postId),e&&!y.component.options[o].source_id&&(y.component.options[o].source_id=e.source_id),y.component.options[o].name||(y.component.options[o].name=t),e&&e.options&&e.options.ct_category&&(y.component.options[o].ct_category=e.options.ct_category),y.component.options[o].model=angular.copy(y.component.options[o].original)},y.applyComponentSavedOptions=function(o,t){for(var e in y.log&&console.log("applyComponentSavedOptions()",o,t),y.checkGlobalFont(t.options),t.options)if(t.options.hasOwnProperty(e)){var n=t.options[e];if("object"==typeof n&&"classes"!=e){for(var i in y.component.options[o][e]||(y.component.options[o][e]={}),n)if(n.hasOwnProperty(i)){var s=n[i];"original"==e&&(y.component.options[o].id[i]=s),y.component.options[o][e][i]=s,y.log,("font-family"==i||-1<i.indexOf("font-family"))&&y.loadWebFont(s)}}else"object"!=typeof n&&("selector"==e?y.component.options[o][e]=n:y.component.options[o].original[e]=n)}y.component.options[o].model=angular.copy(y.component.options[o].original),t.options.oxy_builtin&&(y.builtinComponents[o]=!0)},y.applyModelOptions=function(o,t){if(void 0===o&&(o=y.component.active.id),void 0===t&&(t=y.component.active.name),y.log&&console.log("applyModelOptions()",o,t),0!==o&&"0"!==o){if(y.component.options[o]||(y.component.options[o]=[]),y.component.options[o].model={},angular.extend(y.component.options[o].model,y.component.options[o].original),y.isEditing("id")&&(y.isEditing("media")?(y.component.options[o].model={},y.component.options[o].media&&y.component.options[o].media[y.currentMedia]&&(y.component.options[o].model=angular.copy(y.component.options[o].media[y.currentMedia][y.currentState]||{}))):y.isEditing("state")&&(y.component.options[o].model=angular.copy(y.component.options[o][y.currentState]||{}))),y.isEditing("class")&&"object"==typeof y.classes[y.currentClass])if(y.component.options[o].model=angular.copy(y.classes[y.currentClass].original||{}),y.isEditing("media"))for(var e in y.component.options[o].model={},y.classes[y.currentClass].media&&y.classes[y.currentClass].media[y.currentMedia]&&(y.component.options[o].model=angular.copy(y.classes[y.currentClass].media[y.currentMedia][y.currentState]||{})),y.classes[y.currentClass][y.currentState])y.classes[y.currentClass][y.currentState].hasOwnProperty(e)&&-1<y.optionsWhiteListNoMedia.indexOf(e)&&(y.component.options[o].model[e]=y.classes[y.currentClass][y.currentState][e]);else y.component.options[o].model={},y.classes[y.currentClass]&&y.classes[y.currentClass][y.currentState]&&(y.component.options[o].model=angular.copy(y.classes[y.currentClass][y.currentState]||{}));for(var n in y.isEditing("custom-selector")&&!y.isEditing("class")&&y.customSelectors[y.selectorToEdit]&&(y.isEditing("media")?(y.component.options[o].model={},y.customSelectors[y.selectorToEdit].media&&y.customSelectors[y.selectorToEdit].media[y.currentMedia]&&(y.component.options[o].model=angular.copy(y.customSelectors[y.selectorToEdit].media[y.currentMedia][y.currentState]||{}))):(y.component.options[o].model={},y.customSelectors[y.selectorToEdit]&&y.customSelectors[y.selectorToEdit][y.currentState]&&(y.component.options[o].model=angular.copy(y.customSelectors[y.selectorToEdit][y.currentState]||{})))),y.component.options[o].model)(y.component.options[o].model.hasOwnProperty(n)&&"font-family"==n||-1<n.indexOf("font-family"))&&y.loadWebFont(y.component.options[o].model[n]);for(var n in y.component.options[o].model)y.component.options[o].model.hasOwnProperty(n)&&y.component.options[o].model[n+"-unit"]&&(!y.isEditing("id")||y.isEditing("media")||y.isEditing("state")||y.component.options[o].model[n+"-unit"]==y.defaultOptions[t][n+"-unit"]||y.component.options[o].id[n]||delete y.component.options[o].model[n]);if(!y.isEditing("custom-selector"))for(var e in y.component.options[o].original)y.component.options[o].original.hasOwnProperty(e)&&-1===y.optionsWhiteList.indexOf(e)&&(!y.isEditing("class")||"icon-style"!=e&&"button-style"!=e&&"gradient"!=e?y.isEditing("class")&&-1<y.optionsWhiteListNoMedia.indexOf(e)||(y.component.options[o].model[e]=y.component.options[o].original[e]):y.component.options[o].model[e]=angular.copy(y.classes[y.currentClass].original[e]));if("ct_section"==t)for(var i in sectionOptions=["container-padding-top","container-padding-top-unit","container-padding-bottom","container-padding-bottom-unit","container-padding-left","container-padding-left-unit","container-padding-right","container-padding-right-unit"],sectionOptions)sectionOptions.hasOwnProperty(i)&&(e=sectionOptions[i],null!=y.component.options[o].model[e]&&""!=y.component.options[o].model[e]||(y.component.options[o].model[e]=y.globalSettings.sections[e]))}},y.setOption=function(e,t,o,n,i){(y.cancelDeleteUndo(),y.log&&(console.log("setOption() '"+o+"' for '"+t+"' id:"+e+" tag to '"+y.component.options[e].model[o]+"'"),y.functionStart("setOption()")),null==y.component.options[e].model[o]&&(y.component.options[e].model[o]=""),y.adjustResizeBox(),_.disableSelectorDetectorMode&&_.disableSelectorDetectorMode(),o&&0===o.indexOf("aos-")&&"aos-enable"!==o&&"aos-type"!==o)&&(s=y.getComponentById(e)).attr("data-"+o,y.component.options[e].model[o]);if("aos-type"==o){var s=y.getComponentById(e),r=y.getOption("aos-type",e)||y.pageSettingsMeta.aos.type||y.pageSettings.aos.type||y.globalSettings.aos.type;r?s.attr("data-aos",r):s.removeAttr("data-aos")}if(!y.isEditing("id")||y.isEditing("media")||y.isEditing("state")||(void 0!==y.component.options[e].model[o]?(y.component.options[e].id||(y.component.options[e].id={}),y.component.options[e].id[o]=angular.copy(y.component.options[e].model[o])):""==y.component.options[e].model[o]&&(-1===y.allowedEmptyOptions.indexOf(o)?(delete y.component.options[e].id[o],y.component.options[e].model[o+"-unit"]?y.component.options[e].model[o+"-unit"]==y.defaultOptions[t][o+"-unit"]&&(y.component.options[e].model[o]=y.defaultOptions[t][o],y.component.options[e].original[o]=y.defaultOptions[t][o]):"ct_content"!=o&&(y.component.options[e].model[o]=y.defaultOptions[t][o],y.component.options[e].original[o]=y.defaultOptions[t][o])):(y.component.options[e].id||(y.component.options[e].id={}),y.component.options[e].id[o]=y.component.options[e].model[o]))),y.isEditing("class")&&""==y.currentClass)return alert("Please choose the class from the list or set a new one."),y.functionEnd("setOption()"),!1;if("ct_column"==t&&"width"==o&&(100<y.component.options[e].model[o]&&(y.component.options[e].model[o]=100),y.component.options[e].model[o]<0&&(y.component.options[e].model[o]=0)),o&&"custom-css"==o){var a=y.component.options[e].model[o],l=!0,c="";if(0<a.length&&(-1<a.indexOf("{")||-1<a.indexOf("}")?(l=!1,c="The Custom CSS field contains one or more curly braces. The CSS will not be saved until all curly braces are removed."):-1==a.indexOf(":")&&(l=!1,c="The Custom CSS field contains invalid CSS. The CSS will not be saved until this is corrected."),!l))return jQuery(".oxygen-code-error-container",_.oxygenUIElement).show().html(c),!1;jQuery(".oxygen-code-error-container",_.oxygenUIElement).hide().html("")}if(o&&-1<o.indexOf("border-all"))return y.setOptionModel(o.replace("-all-","-top-"),y.component.options[e].model[o]),y.setOptionModel(o.replace("-all-","-right-"),y.component.options[e].model[o]),y.setOptionModel(o.replace("-all-","-bottom-"),y.component.options[e].model[o]),y.setOptionModel(o.replace("-all-","-left-"),y.component.options[e].model[o]),void y.functionEnd("setOption()");if("flex-direction"==o&&("column"==y.component.options[e].model[o]||"row"==y.component.options[e].model[o]))var d=v(function(){y.setOptionModel("display","flex",e,t),v.cancel(d)},0,!1);if("display"==o&&"flex"!=y.component.options[e].model[o]&&y.setOptionModel("flex-direction","unset",e,t),0<=["container-padding-top","container-padding-bottom","container-padding-left","container-padding-right"].indexOf(o)&&""==y.component.options[e].model[o])d=v(function(){y.applyModelOptions(e,t),y.parentScope.safeApply(),v.cancel(d)},0,!1);if(-1<["layout","link","lightbox","image_aspect_ratio","images_per_row","space_around_image","image_min_width","gallery_captions","caption_color","caption_background_color","gallery_captions_only_hover","hide_captions_below","image_opacity_hover","image_opacity","transition_duration","gallery_thumbnail_size"].indexOf(o)&&"oxy_gallery"==t)d=v(function(){y.renderComponentWithAJAX("oxy_render_gallery"),v.cancel(d)},0,!1);if("selector"==o&&"oxy_tabs_contents"==t)d=v(function(){var o=jQuery(y.getComponentById(e)).data("oxy-tabs-wrapper"),t=jQuery("#"+o).attr("ng-attr-component-id");y.setOptionModel("tabs_contents_wrapper",y.component.options[e].selector,t,"oxy_tabs"),y.$apply(),v.cancel(d)},0,!1);if("selector"==o&&"oxy_tabs"==t)d=v(function(){var o=jQuery(y.getComponentById(e)).data("oxy-tabs-contents-wrapper"),t=jQuery("#"+o).attr("ng-attr-component-id");y.setOptionModel("tabs_wrapper",y.component.options[e].selector,t,"oxy_tabs_contents"),y.$apply(),v.cancel(d)},0,!1);if("dont_render"==o&&"ct_widget"==t)d=v(function(){y.renderWidget(e,!1),v.cancel(d)},0,!1);if("oxy_social_icons"==t&&o&&0<=y.socialIcons.networks.indexOf(o.replace("icon-",""))&&(""==y.component.options[e].model[o]||""!=y.component.options[e].model[o]&&""==y.component.options[e].original[o]))d=v(function(){y.rebuildDOM(e),v.cancel(d)},0,!1);if(-1<["progress_bar_animation_stripes","progress_bar_animate_width","progress_bar_animation_stripes_duration","progress_bar_animation_width_duration"].indexOf(o))d=v(function(){y.rebuildDOM(e),v.cancel(d)},0,!1);"soundcloud_url"==o&&y.getSoundCloudTrackID(y.component.options[e].model[o]),"hide_in_sticky"==o&&"yes"==y.component.options[e].model[o]&&"yes"==y.getOption("show_in_sticky_only",e)&&y.setOptionModel("show_in_sticky_only","",e,t),"show_in_sticky_only"==o&&"yes"==y.component.options[e].model[o]&&"yes"==y.getOption("hide_in_sticky",e)&&y.setOptionModel("hide_in_sticky","",e,t);var p={id:e,tag:t,optionName:o,isShortcode:n,isData:0===t.lastIndexOf("ct_data",0)};if(y.isEditing("custom-selector")){var m=p.optionName,u=y.component.options[p.id].model[m];if(!("selector"==m||"ct_id"==m||"ct_parent"==m||"ct_content"==m||"classes"==m||"url"==m&&p.isShortcode))return y.updateCustomSelectorValue(m,u),delete y.cache.classStyles[y.currentClass],y.outputCSSOptions(),y.unsavedChanges(),void y.functionEnd("setOption()")}else void 0!==o?(y.findComponentItem(y.componentsTree.children,e,y.updateTreeComponentOption,p),0<=o.indexOf("hover_")&&"oxy_posts_grid"!=t&&(p.optionName="fake_"+p.optionName,y.findComponentItem(y.componentsTree.children,e,y.updateTreeComponentOption,p))):y.findComponentItem(y.componentsTree.children,e,y.updateTreeComponentOptions,p);if(y.unsavedChanges(),void 0!==o&&0===o.indexOf("aos-")){if("undefined"!=typeof AOS)d=v(function(){AOS.refreshHard(),v.cancel(d)},0,!1)}else if("undefined"!=typeof AOS)d=v(function(){AOS.refresh(),v.cancel(d)},0,!1);if("aos-type"==o)var g=y.getComponentById(e),f=v(function(){g.css("transitionDuration","0s").removeClass("aos-animate"),v.cancel(f)},100,!1),h=v(function(){g.css("transitionDuration","").addClass("aos-animate"),v.cancel(h)},200,!1);if(n&&y.renderShortcode(e,t),p.isData&&y.renderDataComponent(e,t),"ct_content"==o||i)y.functionEnd("setOption()");else{if("ct_video"===t&&"src"===o)if(-1!==y.component.options[e].model[o].indexOf("[oxygen")){y.applyShortcodeResults(e,y.component.options[e].model[o],function(o){y.setOptionModel("embed_src",y.getYoutubeVimeoEmbedUrl(o.trim()),e,t)})}else y.setOptionModel("embed_src",y.getYoutubeVimeoEmbedUrl(y.component.options[e].model[o]),e,t);if("background-image"===o||"ct_image"===t&&"src"===o)if(-1!==y.component.options[e].model[o].indexOf("[oxygen"))y.component.options[e].model[o+"dynamic"]=!0,y.setOption(e,t,o+"dynamic",!1,!0);else if(!0===y.component.options[e].original[o+"dynamic"]&&-1===y.component.options[e].model[o].indexOf("[oxygen")){y.component.options[e].model[o+"dynamic"]=!1,y.setOption(e,t,o+"dynamic",!1,!0);var b=(p=y.getComponentById(e)).closest(".oxy-dynamic-list");0<b.length&&!b.hasClass("oxy-dynamic-list-edit")?y.updateRepeaterQuery(parseInt(b.attr("ng-attr-component-id"))):y.rebuildDOM(e)}y.outputCSSOptions(e),y.isNotSelectedYet(e)&&void 0!==o&&y.switchEditToId(!0),y.functionEnd("setOption()")}},y.setOptionModel=function(o,t,e,n,i){void 0===e&&(e=y.component.active.id),void 0===n&&(n=y.component.active.name),y.classesCached=!1,y.log&&(console.log("setOptionModel()",o,t,e,n,i),y.functionStart("setOptionModel()")),-1<o.indexOf(".")?(2==(o=o.split(".")).length&&(y.component.options[e].model[o[0]][o[1]]=t),3==o.length&&(y.component.options[e].model[o[0]][o[1]][o[2]]=t)):(y.component.options[e].model[o]=t,y.setOption(e,n,o,!1,i)),y.functionEnd("setOptionModel()")},y.getOption=function(o,t){return void 0===t&&(t=y.component.active.id),-1<o.indexOf(".")?2==(o=o.split(".")).length&&y.component.options[t].model[o[0]]&&y.component.options[t].model[o[0]][o[1]]?y.component.options[t].model[o[0]][o[1]]:3==o.length&&y.component.options[t].model[o[0]]&&y.component.options[t].model[o[0]][o[1]]&&y.component.options[t].model[o[0]][o[1]][o[2]]?y.component.options[t].model[o[0]][o[1]][o[2]]:void 0:y.component.options[t].model&&void 0!==y.component.options[t].model[o]?y.component.options[t].model[o]:""},y.getCSSOptions=function(o,t,e,n){var i={};if(e)i=angular.copy(e);else{if(void 0===o)return{};void 0===t&&(t=y.currentState),y.component.options[o]&&(i=angular.copy(y.component.options[o][t]))}for(var s in i=i||{},y.log&&console.log("getCSSOptions()",o,t,i),i)if(i.hasOwnProperty(s)&&("ct_video"!=n||"padding-bottom"!=s))if(s.indexOf("-unit")<0){if(n||(n=o&&0<o?y.component.options[o].name:"all"),null==y.defaultOptions[n][s+"-unit"])continue;if("container-padding-top"==s||"container-padding-bottom"==s||"container-padding-left"==s||"container-padding-right"==s){var r=i[s+"-unit"]?i[s+"-unit"]:y.globalSettings.sections[s+"-unit"];i[s]&&(i[s]+=r)}else if("auto"==i[s+"-unit"])i[s]="auto";else{r=i[s+"-unit"]?i[s+"-unit"]:y.defaultOptions[n][s+"-unit"];i[s]&&(i[s]+=r)}delete i[s+"-unit"]}else"auto"==i[s]&&(i[s.replace("-unit","")]="auto");for(var s in i)i.hasOwnProperty(s)&&0<s.indexOf("-unit")&&delete i[s];if(i["background-position-top"]||i["background-position-left"]){var a=i["background-position-top"]||"0%",l=i["background-position-left"]||"0%";i["background-position"]=l,i["background-position"]+=" "+a}if(i["background-position-top"]=null,i["background-position-left"]=null,"manual"==i["background-size"]){var c=i["background-size-width"]||"auto",d=i["background-size-height"]||"auto";i["background-size"]=c,i["background-size"]+=" "+d}for(var s in i["background-size-width"]=null,i["background-size-height"]=null,i)i.hasOwnProperty(s)&&-1<s.indexOf("font-family")&&"global"==i[s][0]&&(i[s]=e?y.getGlobalFont(i[s][1]):y.getComponentFont(o,!1,t));return i},y.checkOptionChanged=function(o,t){if(y.log,y.isEditing("custom-selector"))return!1;var e=!1,n=!1;if(y.isEditing("state")&&y.isEditing("id")){if(y.component.options[o][y.currentState]&&(n=y.component.options[o][y.currentState][t]),!n)return!1;if(e=y.component.options[o].original[t],"font-family"==t&&n&&"global"==n[0]&&"global"==e[0]&&n[1]==e[1])return!1;if(e&&n!=e)return"ct-option-different"}else if(y.classes[y.currentClass]&&y.classes[y.currentClass][y.currentState]&&y.classes[y.currentClass][y.currentState][t])return"ct-option-different"},y.isEditing=function(o){switch(o){case"id":return!1===y.currentClass&&0<=y.component.active.id;case"class":return!1!==y.currentClass;case"state":return"original"!=y.currentState;case"pseudo-element":return!!y.isPseudoElement(y.currentState);case"custom-selector":return!1!==y.selectorToEdit;case"style-sheet":return!1!==y.stylesheetToEdit&&void 0!==y.stylesheetToEdit;case"media":return"default"!==y.currentMedia;default:return!1}},y.switchEditToId=function(o){y.log&&console.log("switchEditToId()",y.component.active.id);var t=y.isEditing("id");if(!0!==o&&y.setCustomSelectorToEdit(!1),y.activeSelectors[y.component.active.id]||!0===o||y.setCurrentClass(!1),void 0!==o&&!0===o&&(y.activeSelectors=y.activeSelectors||{},y.activeSelectors[y.component.active.id]=!1,y.setCurrentClass(!1)),y.switchState("original"),y.showClasses=!1,t)return!1},y.setEditingStateToDefault=function(o){y.log&&console.log("setEditingStateToDefault()"),y.switchEditToId(!0),o||y.setCurrentMedia("default");var t=v(function(){y.$apply(),v.cancel(t)},0,!1)},y.pageSettingsUpdate=function(){y.mediaList["page-width"].maxSize=y.getPageWidth()+"px",y.mediaList["page-width"].title="Page container ("+y.getPageWidth()+"px) and below",y.getPageSetting("overlay-header-above")&&"never"!=y.getPageSetting("overlay-header-above")?jQuery("body").addClass("oxy-overlay-header"):jQuery("body").removeClass("oxy-overlay-header"),y.updateAllComponentsCacheStyles(),y.outputCSSOptions(),y.outputPageSettingsCSS(),_.adjustViewportContainer(),y.unsavedChanges()},y.$watch("globalSettings.scripts",function(){y.updateScriptsSettings()},!0),y.$watch("pageSettingsMeta.scripts",function(){y.updateScriptsSettings()},!0),y.updateScriptsSettings=function(){var o=!1;y.pageSettingsMeta.scripts&&"true"==y.pageSettingsMeta.scripts.scroll_to_hash?(o=y.pageSettingsMeta.scripts,""===y.pageSettingsMeta.scripts.scroll_to_hash_time&&(o.scroll_to_hash_time=y.pageSettings.scripts.scroll_to_hash_time)):o=y.pageSettings.scripts&&"true"==y.pageSettings.scripts.scroll_to_hash?y.pageSettings.scripts:y.globalSettings.scripts,o&&"true"==o.scroll_to_hash?(jQuery("body").addClass("oxygen-scroll-to-hash-links"),jQuery("body").attr("data-oxygen-scroll-to-hash-links",o.scroll_to_hash_time)):jQuery("body").removeClass("oxygen-scroll-to-hash-links")},y.getPageSetting=function(o,t){return void 0!==y.pageSettingsMeta[o]&&""!==y.pageSettingsMeta[o]?y.pageSettingsMeta[o]:void 0!==y.pageSettings[o]&&""!==y.pageSettings[o]?y.pageSettings[o]:1==t&&void 0!==y.globalSettings[o]&&""!==y.globalSettings[o]?y.globalSettings[o]:""},y.setOptionUnit=function(o,t,e){var n=o+"-unit",i=y.component.active.id,s=y.component.active.name;-1<n.indexOf(".")?(2==(n=n.split(".")).length&&y.component.options[i].model[n[0]]&&(y.component.options[i].model[n[0]][n[1]]=t),3==n.length&&y.component.options[i].model[n[0]]&&y.component.options[i].model[n[0]][n[1]]&&(y.component.options[i].model[n[0]][n[1]][n[2]]=t),y.setOption(i,s,n[0],!1,e)):(y.component.options[i].model[n]=t,y.setOption(i,s,n,!1,e)),y.applyModelOptions()},y.getOptionUnit=function(o){var t=o+"-unit",e=y.component.active.id;if(-1<t.indexOf(".")){if(2==(t=t.split(".")).length)return y.component.options[e].model[t[0]]&&y.component.options[e].model[t[0]][t[1]]?y.component.options[e].model[t[0]][t[1]]:y.defaultOptions.all[t[1]];if(3==t.length)return y.component.options[e].model[t[0]]&&y.component.options[e].model[t[0]][t[1]]&&y.component.options[e].model[t[0]][t[1]][t[2]]?y.component.options[e].model[t[0]][t[1]][t[2]]:y.defaultOptions.all[t[2]]}else{if(y.component.options[e].model&&y.component.options[e].model[t])return y.component.options[e].model[t];if(y.defaultOptions.all[t])return y.defaultOptions.all[t]}return""},y.getGlobalOptionUnit=function(o,t){var e=t+"-unit";return"page"==o&&y.pageSettingsMeta&&y.pageSettingsMeta[e]?y.pageSettingsMeta[e]:"global"==o&&y.globalSettings&&y.globalSettings[e]?y.globalSettings[e]:""},y.getComponentSelector=function(o){return null==o&&(o=y.component.active.id),y.component.options[o].selector},y.applyComponentJS=function(o,t,e){y.applyingComponentJS=!0,jQuery(".oxygen-code-error-container",_.oxygenUIElement).hide().html(""),y.log&&console.log("applyComponentJS()",o,t),null==o&&(o=y.component.active.id),null==t&&(t=y.component.active.name),null==e&&(e=!0),e&&y.setOption(o,t,"custom-js",!1,!1);var n=y.getOption("custom-js",o);y.defaultOptions[t]["custom-js"]!==n&&y.outputJSScript("ct_custom_js_",o,n),y.applyingComponentJS=!1},y.isInherited=function(o,t,e){if(void 0===e&&(e=y.getOption(t,o)),y.getOption(t,o)!=e)return!1;if(Array.isArray(e)&&0===e.length)return!0;if(y.isEditing("id")&&!y.isEditing("media")&&!y.isEditing("state")&&(void 0===y.component.options[o].id||y.component.options[o].id[t]==e||angular.equals(e,y.component.options[o].id[t])))return!1;if(y.isEditing("id")&&!y.isEditing("media")&&y.isEditing("state")&&y.component.options[o][y.currentState]&&y.component.options[o][y.currentState][t]==e)return!1;if(y.isEditing("id")&&y.isEditing("media")&&y.component.options[o].media&&y.component.options[o].media[y.currentMedia]&&y.component.options[o].media[y.currentMedia][y.currentState]&&y.component.options[o].media[y.currentMedia][y.currentState][t]==e)return!1;if(y.isEditing("class")&&!y.isEditing("media")&&y.classes[y.currentClass]&&y.classes[y.currentClass][y.currentState]&&y.classes[y.currentClass][y.currentState][t]==e)return!1;if(y.isEditing("class")&&y.isEditing("media")&&y.classes[y.currentClass]&&y.classes[y.currentClass].media&&y.classes[y.currentClass].media[y.currentMedia]&&y.classes[y.currentClass].media[y.currentMedia][y.currentState]&&y.classes[y.currentClass].media[y.currentMedia][y.currentState][t]==e)return!1;if(y.isEditing("custom-selector")&&!y.isEditing("class")){if(y.isEditing("media")&&y.customSelectors[y.selectorToEdit]&&y.customSelectors[y.selectorToEdit].media&&y.customSelectors[y.selectorToEdit].media[y.currentMedia]&&y.customSelectors[y.selectorToEdit].media[y.currentMedia][y.currentState]&&y.customSelectors[y.selectorToEdit].media[y.currentMedia][y.currentState][t]==e)return!1;if(y.customSelectors[y.selectorToEdit]&&y.customSelectors[y.selectorToEdit][y.currentState]&&y.customSelectors[y.selectorToEdit][y.currentState][t]==e)return!1}return!0},y.isBorderHasStyles=function(o){var t=y.isInherited(y.component.active.id,"border-"+o+"-width");return style=y.isInherited(y.component.active.id,"border-"+o+"-style"),color=y.isInherited(y.component.active.id,"border-"+o+"-color"),!(t&&style&&color)},y.isTabHasOptions=function(o,t){if(void 0===o){for(var o in y.optionsHierarchy)if(y.optionsHierarchy.hasOwnProperty(o))for(var e in y.optionsHierarchy[o])if(y.optionsHierarchy[o].hasOwnProperty(e)){var n=y.optionsHierarchy[o][e];for(var i in n){var s=n[i];if(!1===y.isInherited(y.component.active.id,s)&&""!=y.getOption(s,y.component.active.id))return!0}}}else if(void 0===t){for(var e in y.optionsHierarchy[o])if(y.optionsHierarchy[o].hasOwnProperty(e)){n=y.optionsHierarchy[o][e];for(var i in n){s=n[i];if(!1===y.isInherited(y.component.active.id,s)&&""!=y.getOption(s,y.component.active.id))return!0}}}else{if(!y.optionsHierarchy[o][t])return!1;n=y.optionsHierarchy[o][t];for(var i in n){s=n[i];if(!1===y.isInherited(y.component.active.id,s)&&""!=y.getOption(s,y.component.active.id))return!0}}},y.checkGlobalOptions=function(t){try{t=JSON.parse(t)}catch(o){return void console.log(t)}void 0!==t.display&&void 0!==t.text&&(y.globalSettings.fonts.Display==t.display&&y.globalSettings.fonts.Text==t.text||confirm("This Design Set's recommended fonts are:\rDisplay: "+t.display+"\rText: "+t.text+"\rWould you like to change your fonts to the recommended fonts?")&&(y.setGlobalFont("Display",t.display),y.setGlobalFont("Text",t.text)));void 0!==t["page-width"]&&(y.getPageWidth()!=t["page-width"]&&confirm("This Design Set's recommended page width is "+t["page-width"]+"px, but the width of this page is "+y.getPageWidth()+"px. Would you like to change your page width to "+t["page-width"]+"px?")&&(y.pageSettings["max-width"]=t["page-width"],y.pageSettingsUpdate()))},y.resetGlobalStylesToDefault=function(){confirm("Are you sure you wish to reset your Global Settings to the defaults?")&&(angular.copy(y.globalSettingsDefaults.fonts,y.globalSettings.fonts),angular.copy(y.globalSettingsDefaults.headings,y.globalSettings.headings),angular.copy(y.globalSettingsDefaults.body_text,y.globalSettings.body_text),angular.copy(y.globalSettingsDefaults.links,y.globalSettings.links),angular.copy(y.globalSettingsDefaults.sections,y.globalSettings.sections),y.globalSettings["max-width"]=y.globalSettingsDefaults["max-width"],y.pageSettingsUpdate())},y.setFirstTimeOptions=function(o,t){"ct_slider"==t&&(y.setOptionModel("slider-arrow-color","darker",o,t),y.setOptionModel("slider-dot-color","#ffffff",o,t),y.setOptionModel("slider-show-arrows","yes",o,t),y.setOptionModel("slider-show-dots","yes",o,t),y.setOptionModel("slider-autoplay","no",o,t),y.setOptionModel("slider-autoplay-delay","3000",o,t),y.setOptionModel("slider-infinite","no",o,t),y.setOptionModel("slider-animation","horizontal",o,t),y.setOptionModel("slider-animation-speed","750",o,t)),"oxy_nav_menu"==t&&(y.setOptionModel("menu_responsive","page-width",o,t),y.setOptionModel("menu_responsive_padding_size","0",o,t),y.setOptionModel("menu_responsive_icon_size","40",o,t),y.setOptionModel("menu_responsive_icon_margin","10",o,t),y.setOptionModel("dropdowns","on",o,t),y.setOptionModel("menu_dropdown_arrow","on",o,t),y.setOptionModel("menu_padding-top","20",o,t),y.setOptionModel("menu_padding-left","20",o,t),y.setOptionModel("menu_padding-right","20",o,t),y.setOptionModel("menu_padding-bottom","20",o,t),y.setOptionModel("menu_hover_background-color","#eee",o,t),y.setOptionModel("menu_hover_border-top-width","3",o,t),y.setOptionModel("menu_flex-direction","row",o,t)),"oxy_social_icons"==t&&(y.setOptionModel("icon-facebook","https://facebook.com"),y.setOptionModel("icon-instagram","https://instagram.com"),y.setOptionModel("icon-twitter","https://twitter.com")),"oxy_header"==t&&(y.setOptionModel("sticky-media","page-width"),y.setOptionModel("sticky_scroll_distance","300")),"oxy_soundcloud"==t&&(y.setOptionModel("height","300"),y.setOptionModel("height-unit","px"),y.setOptionModel("width","100"),y.setOptionModel("width-unit","%"),y.setOptionModel("soundcloud_url","https://soundcloud.com/nathaniel-eliason/13-learning-spanish-and-more"),y.setOptionModel("soundcloud_track_id","331837379")),"oxy_superbox"==t&&(y.setOptionModel("superbox_secondary_opacity_start","0"),y.setOptionModel("superbox_secondary_opacity_finish","1"))},y.isFlexPossible=function(o){return null==o&&(o=y.component.active.name),-1<["ct_div_block","ct_section","ct_link"].indexOf(o)},y.setTextAlign=function(){var t=v(function(){var o=y.component.active.id;if("column"==y.component.options[o].model["flex-direction"])switch(y.component.options[o].model["align-items"]){case"flex-start":y.setOptionModel("text-align","left");break;case"center":y.setOptionModel("text-align","center");break;case"flex-end":y.setOptionModel("text-align","right");break;case"stretch":y.setOptionModel("text-align","justify");break;default:y.setOptionModel("text-align","")}if("row"==y.component.options[o].model["flex-direction"])switch(y.component.options[o].model["justify-content"]){case"flex-start":y.setOptionModel("text-align","left");break;case"center":y.setOptionModel("text-align","center");break;case"flex-end":y.setOptionModel("text-align","right");break;case"space-between":case"space-around":y.setOptionModel("text-align","justify");break;default:y.setOptionModel("text-align","")}v.cancel(t)},11,!1)},y.setEasyPostsTemplate=function(o,t){if(void 0===t&&(t=!0),t&&!confirm("Current settings for this element will be overwritten. Are you sure?"))return!1;y.setOptionModel("code-php",o.code_php),y.setOption(y.component.active.id,y.component.active.name,"code-php"),y.setOptionModel("code-css",o.code_css),y.setOption(y.component.active.id,y.component.active.name,"code-css");var e=["title_size","title_size-unit","title_color","title_hover_color","meta_size","meta_size-unit","meta_color","content_size","content_size-unit","content_color","read_more_display_as","read_more_size","read_more_size-unit","read_more_text_color","read_more_text_hover_color","read_more_button_color","read_more_button_hover_color","paginate_color","paginate_alignment","paginate_link_color","paginate_link_hover_color","posts_per_page","posts_5050_below","posts_100_below"];for(var n in e){var i=e[n];y.setOptionModel(i,o[i])}y.lastSetEasyPostsTemplate[y.component.active.id]=o.name,y.renderComponentWithAJAX("oxy_render_easy_posts")},y.addEasyPostsTemplate=function(){if(y.newEasyPostsTemplate&&""!==y.newEasyPostsTemplate){var o={name:y.newEasyPostsTemplate,code_php:y.getOption("code-php"),code_css:y.getOption("code-css")},t=["title_size","title_size-unit","title_color","title_hover_color","meta_size","meta_size-unit","meta_color","content_size","content_size-unit","content_color","read_more_display_as","read_more_size","read_more_size-unit","read_more_text_color","read_more_text_hover_color","read_more_button_color","read_more_button_hover_color","paginate_color","paginate_alignment","paginate_link_color","paginate_link_hover_color","posts_per_page","posts_5050_below","posts_100_below"];for(var e in t){var n=t[e];o[n]=y.getOption(n)}y.easyPostsCustomTemplates.push(o),y.newEasyPostsTemplate="",alert("Your preset was saved successfully"),y.unsavedChanges()}else alert("Please set the preset name")},y.deleteEasyPostsTemplate=function(o,t){void 0!==t&&t.stopPropagation(),y.easyPostsCustomTemplates.splice(o,1)},y.setCommentsListTemplate=function(o){y.setOptionModel("code-php",o.code_php),y.setOption(y.component.active.id,y.component.active.name,"code-php"),y.setOptionModel("code-css",o.code_css),y.setOption(y.component.active.id,y.component.active.name,"code-css"),y.lastSetCommentsListTemplate=o.name,y.renderComponentWithAJAX("oxy_render_comments_list")},y.addCommentsListTemplate=function(){y.newCommentsListTemplate&&""!==y.newCommentsListTemplate?(y.commentsListCustomTemplates.push({name:y.newCommentsListTemplate,code_php:y.getOption("code-php"),code_css:y.getOption("code-css")}),y.newCommentsListTemplate="",alert("Your preset was saved successfully"),y.unsavedChanges()):alert("Please set the preset name")},y.deleteCommentsListTemplate=function(o,t){void 0!==t&&t.stopPropagation(),y.commentsListCustomTemplates.splice(o,1)},y.getPageWidth=function(o){return o||void 0===y.getPageSetting("max-width")||""==y.getPageSetting("max-width")?parseInt(y.globalSettings["max-width"]):parseInt(y.getPageSetting("max-width"))},y.reEnablePricingBoxText=function(){""==y.getOption("pricing_box_package_regular")&&y.setOptionModel("pricing_box_package_regular","monthly $399"),""==y.getOption("pricing_box_package_subtitle")&&y.setOptionModel("pricing_box_package_subtitle","for small business"),""!=y.getOption("pricing_box_content")&&"<br>"!=y.getOption("pricing_box_content")||y.setOptionModel("pricing_box_content","my features<br />another feature<br />my last feature<br />")},y.getSuperBoxEditingModeTitle=function(){switch(y.getOption("superbox_editing_mode")){case"primary_only":return"Show Primary Only";case"secondary_only":return"Show Secondary Only";case"as_hovered":return"As If Hovered";case"as_not_hovered":return"As If Not Hovered";default:return"Live"}},y.unsetAllBorders=function(o,t){null==o&&(o="");y.component.active.id;if(void 0===t)t=["border-all-width","border-all-width-unit","border-all-style","border-all-color","border-top-width","border-top-width-unit","border-top-style","border-top-color","border-right-width","border-right-width-unit","border-right-style","border-right-color","border-bottom-width","border-bottom-width-unit","border-bottom-style","border-bottom-color","border-left-width","border-left-width-unit","border-left-style","border-left-color"];for(var e in t){var n=t[e];y.setOptionModel(o+n,null)}},y.unsetOptions=function(o){for(var t in o){var e=o[t],n=y.defaultOptions[y.component.active.name][e];y.setOptionModel(e,null),y.component.options[y.component.active.id].id[e]=null,y.component.options[y.component.active.id].model[e]=n,y.component.options[y.component.active.id].original[e]=n}},y.addComponentTransform=function(){var o=y.objectToArrayObject(y.getOption("transform")),t=typeof o;"string"!==t&&"undefined"!==t||(o=[]),o.push({"transform-type":"rotate"}),y.setOptionModel("transform",o)},y.removeComponentTransform=function(o,t){var e=y.objectToArrayObject(y.getOption("transform"));e.splice(t,1),y.setOptionModel("transform",e)},y.isAJAXElement=function(o){return!!y.componentsTemplates[o]&&!(!y.componentsTemplates[o].phpCallback||"true"!=y.componentsTemplates[o].phpCallback)}}]);
...
CTFrontendBuilder.controller("ControllerCSS",["$scope","$parentScope","$http","$timeout",function(to,l,e,o){var t,n;to.idStylesContainer=document.getElementById("ct-id-styles"),to.classStylesContainer=document.getElementById("ct-class-styles"),to.customSelectorsExample={"#my-custom-id":{original:{color:"red","font-size":"24px"}}},to.selectedCSSFolder=null,to.expandedFolder=[],to.expandedSelectorFolder=[],to.expandedStylesets=[],to.selectedSelectorFolder=null,to.selectedNodeType=null,to.selectedStyleSet=null,to.selectorDetector={mode:!1},to.cssFolderMenuOpen=!1,to.selectorFolderMenuOpen=!1,to.componentSelector={},to.selectorToEdit=!1,to.selectorHighlighted=!0,to.expandedStyleSets=[],to.globalWooSettingsAdded=[],to.excludeProperties=["ct_content","ct_id","ct_parent","tag","url","src","alt","target","icon-id","section-width","custom-width","header-width","header-custom-width","header-row-width","header-row-custom-width","container-padding-top","container-padding-right","container-padding-bottom","container-padding-left","background-position-top","background-position-left","background-size-width","background-size-height","video-padding-bottom","use-custom","custom-code","embed-src","button-style","button-size","button-color","button-text-color","gradient","background","overlay-color","icon-size","icon-style","icon-color","icon-background-color","use-acf-repeater","acf-repeater","background-imagedynamic","srcdynamic","urldynamic","globalConditionsResult","conditionspreview","conditionstype","custom-js","border-all-width","border-all-style","border-all-color","function_name","full_shortcode","gutter","code-css","code-php","code-js","class_name","id_base","pretty_name","friendly_name","separator","date_format","size","meta_key","hover_color","flex-reverse","stack-columns-vertically","reverse-column-order","set-columns-width-50","menu_id","video_background","video_background_media","video_background_hide","aos-type","aos-duration","aos-easing","aos-offset","aos-delay","aos-anchor","aos-anchor-placement","aos-once","aos-enable","transform"],to.cache.idCSS="",to.cache.idStyles={},to.cache.classCSS="",to.cache.classStyles={},to.cache.selectorCSS="",to.cache.selectorStyles={},to.cache.mediaCSS="",to.cache.mediaStyles={},to.contentAdded=[],to.socialIcons=[],to.socialIcons.networks=["facebook","instagram","twitter","linkedin","rss","youtube"],to.socialIcons.networkColors={facebook:"#3b5998",instagram:"#c32aa3",twitter:"#00b6f1",linkedin:"#007bb6",rss:"#ee802f",youtube:"#ff0000"},to.socialIcons.networkHoverColors={facebook:"#5b79b8",instagram:"#e34ac3",twitter:"#20d6ff",linkedin:"#209bd6",rss:"#ffa04f",youtube:"#ff4444"},to.mappedSelectors={},to.filterStylesheets=function(o){var e=to.styleSheets.filter(function(e){return e.id==o.parent});return!(0<e.length&&0===e[0].status)&&-1!==parseInt(o.parent)},to.setSelectedSelectorFolder=function(e){to.setSelectedNodeType("selectorfolder"),to.selectedSelectorFolder=e},to.getCSSFolder=function(e){return to.styleSheets.find(function(e){return e.id===iframeScope.selectedCSSFolder})},to.setSelectedCSSFolder=function(e){to.selectedCSSFolder=e},to.setActiveCSSFolder=function(e){to.setSelectedNodeType("cssfolder")},to.setSelectedNodeType=function(e){"stylesheet"!==e&&l.toggleSidebar(!0),to.selectedNodeType=e},to.greaterThan=function(o,t){return function(e){return e[o]>t}},to.equalsTo=function(o,t){return function(e){return e[o]===t}},to.toggleCSSFolder=function(e){to.cssFolderMenuOpen=null,e.status=1==e.status?0:1},to.toggleSelectorFolder=function(e){e.status=1==e.status?0:1},to.checkNewCustomSelector=function(e){void 0===to.customSelectors[e]&&(to.customSelectors[e]={set_name:"Uncategorized Custom Selectors",original:{}}),void 0===to.customSelectors[e].set_name&&(to.customSelectors[e].set_name="Uncategorized Custom Selectors"),void 0===to.customSelectors[e].original&&(to.customSelectors[e].original={})},to.setCustomSelectorToEdit=function(e){if(to.styleSetActive=!1,0<to.component.active.id&&(to.activeSelectors[to.component.active.id]=void 0!==to.activeSelectors[to.component.active.id]?to.activeSelectors[to.component.active.id]:to.component.options[to.component.active.id].model.activeselector,to.activeSelectors[to.component.active.id]&&to.setCurrentClass(!!to.activeSelectors[to.component.active.id]&&to.activeSelectors[to.component.active.id])),to.log&&console.log("setCustomSelectorToEdit()",e),"string"==typeof(to.selectorToEdit=e)){to.activateComponent(-1,"ct_selector");var o=e.substr(1);to.classes[o]?(to.setCurrentClass(o),to.populateSelectorFolderDropdown(!0),to.setSelectedNodeType("class")):(to.setCurrentClass(!1),to.populateSelectorFolderDropdown(),to.setSelectedNodeType("selector")),to.customSelectors[e]&&(to.expandedStyleSets[to.customSelectors[e].set_name]=!0)}to.highlightSelector(!0,e),l.cleanEmptySelectors&&""!==e&&l.cleanEmptySelectors()},to.setStyleSetActive=function(){to.setSelectedNodeType("styleset"),to.styleSetActive=!0,to.selectorToEdit=!1,to.currentClass=!1},to.populateSelectorFolderDropdown=function(e){var o,t="";e?(o=to.classes[to.currentClass])&&(t=o.parent):to.selectedStyleSet?t=to.styleSets[to.selectedStyleSet].parent:(o=to.customSelectors[to.selectorToEdit])&&(t=o.parent);to.currentActiveFolder=t},to.setStyleSheetToEdit=function(e){var o=_.findWhere(to.styleSheets,{id:e.parent});to.currentActiveStylesheetFolder=o?o.name:"",to.cancelDeleteUndo(),to.log&&console.log("setStyleSheetToEdit()",e),to.activateComponent(0),to.stylesheetToEdit=e,to.parentScope.switchActionTab("styleSheet"),to.setSelectedNodeType("stylesheet"),to.parentScope.expandSidebar()},to.highlightSelector=function(e,o,t){if(to.log&&console.log("highlightSelector()",e,o),!1===o)return to.outputCSSStyles("ct-selector-highlight",""),!1;t&&t.stopPropagation();var r="";if(void 0===o&&(o=to.selectorToEdit),to.selectorHighlighted=void 0===e?!to.selectorHighlighted:e,to.selectorHighlighted){var a=[];try{a=o.indexOf(".")<0&&o.indexOf("#")<0&&o.indexOf("body")<0?angular.element(o,".oxygen-body"):angular.element(o)}catch(e){console.log(e)}if(0==a.length)return to.selectorHighlighted=!1,to.outputCSSStyles("ct-selector-highlight",""),!1}var i="";i="original"==to.currentState||"hover"==to.currentState||"active"==to.currentState||"focus"==to.currentState?"":":"+to.currentState,to.selectorHighlighted&&(r=o+i+"{outline: 1px dashed rgb(19, 187, 38); outline-offset: 0px;}",o.indexOf(".")<0&&o.indexOf("#")<0&&o.indexOf("body")<0&&(r=".oxygen-body "+r)),to.outputCSSStyles("ct-selector-highlight",r)},to.deleteSelectorFolder=function(o){if(to.styleFolders.hasOwnProperty(o)){if((_.findWhere(to.styleSets,{parent:o})||_.findWhere(to.classes,{parent:o}))&&!confirm("Are you sure you wish to delete this folder and all classes and selectors inside it?"))return!1;angular.forEach(iframeScope.styleSets,function(e){e.parent===o&&delete iframeScope.styleSets[e.key]}),angular.forEach(iframeScope.classes,function(e){e.parent===o&&delete iframeScope.classes[e.key]}),delete to.styleFolders[o]}},to.toggleUncategorizedFolderContents=function(e){e?(_.each(_.filter(to.styleSets,function(e){return void 0===e.parent||null===e.parent}),function(e){e.parent=-1}),_.each(_.filter(to.classes,function(e){return void 0===e.parent||null===e.parent}),function(e){e.parent=-1})):(_.each(_.filter(to.styleSets,function(e){return-1===e.parent||"-1"===e.parent}),function(e){delete e.parent}),_.each(_.filter(to.classes,function(e){return-1===e.parent||"-1"===e.parent}),function(e){delete e.parent}))},to.toggleUncategorizedStyleSheets=function(e){e?_.each(_.filter(to.styleSheets,function(e){return void 0===e.parent||null===e.parent||0===parseInt(e.parent)}),function(e){e.parent=-1}):_.each(_.filter(to.styleSheets,function(e){return-1===e.parent||"-1"===e.parent}),function(e){e.parent=0})},to.addSelectorFolder=function(){to.cancelDeleteUndo();var e=prompt("Provide a name for the folder").trim();/^[a-z_-][a-z\d_-]*$/i.test(e)?to.styleFolders.hasOwnProperty(e)?alert("'"+e+"' already exist."):to.styleFolders[e]={status:1}:alert("Bad folder name. Special characters and spaces are not allowed")},to.addSelectorItem=function(){to.cancelDeleteUndo();var e=prompt("Type a valid CSS selector").trim();try{document.querySelector(e)}catch(e){return alert("Not a valid selector"),!1}if(to.customSelectors.hasOwnProperty(e))alert("'"+e+"' already exist.");else{to.customSelectors[e]={set_name:"Uncategorized Custom Selectors",original:{}},to.selectedSelectorFolder&&to.styleFolders.hasOwnProperty(to.selectedSelectorFolder)&&(to.customSelectors[e].parent=to.selectedSelectorFolder),to.setCustomSelectorToEdit(e),to.selectedStyleSet=e,to.expandedStyleSets["Uncategorized Custom Selectors"]=!0;var o=to.styleSets["Uncategorized Custom Selectors"].parent;void 0===o?iframeScope.expandedSelectorFolder[0]=!0:-1===o?iframeScope.expandedSelectorFolder.uncategorized=!0:iframeScope.expandedSelectorFolder[o]=!0}},to.addStyleSheet=function(e){to.cancelDeleteUndo();var o=prompt("Enter a name for the "+(e?"Folder":"Stylesheet"));if(o){o=o.trim();if(/^[a-z_-][a-z\d_-]*$/i.test(o))if(0<to.styleSheets.filter(function(e){return e.name==o}).length)alert("'"+o+"' already exist. Please choose another name.");else{var t=1;if(0<to.styleSheets.length&&(t=_.max(to.styleSheets,function(e){return e.id}).id+1),e)to.styleSheets.push({id:t,name:o,status:1,folder:1});else{var r=-1===to.selectedCSSFolder||null===to.selectedCSSFolder?0:to.selectedCSSFolder,a={id:t,name:o,css:"",parent:r};for(key in to.styleSheets.push(a),iframeScope.expandedFolder)iframeScope.expandedFolder[key]=!1;iframeScope.expandedFolder[r]=!0,iframeScope.setStyleSheetToEdit(a)}}else alert("Bad stylesheet name. Special characters and spaces are not allowed")}},to.deleteStyleSheet=function(o){if(to.cancelDeleteUndo(),o.folder){if(!confirm("Are you sure you wish to delete this folder and all stylesheets inside it?"))return!1}else if(!confirm('Delete "'+o.name+'" stylesheet from install? (Changes will take effect on Save).'))return!1;to.log&&console.log("deleteStyleSheet()",selector),to.styleSheets.splice(to.styleSheets.indexOf(o),1),o.folder&&(to.styleSheets=to.styleSheets.filter(function(e){return e.parent!=o.id})),angular.element(document.getElementById("ct-style-sheet-"+o.name)).remove(),to.stylesheetToEdit===o&&(to.stylesheetToEdit=!1,l.actionTabs.styleSheet=!1,l.toggleSidebar(!0)),to.selectedNodeType=null},to.deleteCustomSelector=function(e){return to.cancelDeleteUndo(),"Uncategorized Custom Selector"===e?(alert("Sorry, you can't delete the Style Set named Uncategorized Custom Selectors"),!1):!!confirm('Are you sure to delete "'+e+'" selector?')&&(to.log&&console.log("deleteCustomSelector()",e),delete to.customSelectors[e],to.selectorToEdit=!1,-1==to.component.active.id&&to.activateComponent(0,"root"),to.classesCached=!1,to.outputCSSOptions(),void to.unsavedChanges())},to.updateCustomSelectorValue=function(e,o){if(to.cancelDeleteUndo(),to.log&&console.log("updateCustomSelectorValue()",e,o),""===to.selectorToEdit)return!1;var t=to.currentState,r=to.selectorToEdit.substr(1);to.classes[r]?(to.classes[r][t]||(to.classes[r][t]={}),""==o?delete to.classes[r][t][e]:to.classes[r][t][e]=o):to.isEditing("media")?(to.customSelectors[to.selectorToEdit].media||(to.customSelectors[to.selectorToEdit].media={}),to.customSelectors[to.selectorToEdit].media[to.currentMedia]||(to.customSelectors[to.selectorToEdit].media[to.currentMedia]={}),to.customSelectors[to.selectorToEdit].media[to.currentMedia][t]||(to.customSelectors[to.selectorToEdit].media[to.currentMedia][t]={}),""==o?delete to.customSelectors[to.selectorToEdit].media[to.currentMedia][t][e]:to.customSelectors[to.selectorToEdit].media[to.currentMedia][t][e]=o):(to.customSelectors[to.selectorToEdit]||(to.customSelectors[to.selectorToEdit]={set_name:"Uncategorized Custom Selectors"}),to.customSelectors[to.selectorToEdit][t]||(to.customSelectors[to.selectorToEdit][t]={}),""==o?delete to.customSelectors[to.selectorToEdit][t][e]:to.customSelectors[to.selectorToEdit][t][e]=o)},to.outputCSSStyles=function(e,o){var t=document.getElementById(e),r="";r='<style id="'+e+'">',r+=o,r+="</style>",t?t.innerHTML=o:angular.element("head").append(r)},to.deleteCSSStyles=function(e){var o=document.getElementById(e);o&&angular.element(o).remove()},to.generateDynamicBackgrounds=function(t,e,r,a,o){void 0===o&&(o=to.componentsTree),to.dynamicBackgrounds=to.dynamicBackgrounds||{};var i={lock:!0};"id"===r?(to.dynamicBackgrounds[t]=to.dynamicBackgrounds[t]||{},to.dynamicBackgrounds[t]=i):"class"===r?(to.dynamicBackgrounds.classes=to.dynamicBackgrounds.classes||{},to.dynamicBackgrounds.classes[t]=to.dynamicBackgrounds.classes[t]||{},to.dynamicBackgrounds.classes[t]=i):"selector"===r&&(to.dynamicBackgrounds.selectors=to.dynamicBackgrounds.selectors||{},to.dynamicBackgrounds.selectors[t]=to.dynamicBackgrounds.selectors[t]||{},to.dynamicBackgrounds.selectors[t]=i);var n={};if("id"===r){var l=to.findComponentItem(o.children,t,to.getComponentItem);n=l?l.options:{}}else"class"===r?n=to.classes[t]||{}:"selector"===r&&(n=to.customSelectors[t]||{});var s=0;for(key in n)if(!(-1<["ct_id","ct_parent","set_name","parent","key","status","friendly_name","selector","activeselector","classes","nicename"].indexOf(key)))if("media"===key){i.media={};var c=n.media;for(bpKey in c)for(stateKey in i.media[bpKey]={},c[bpKey])"id"===r&&c[bpKey][stateKey]["background-image"]&&-1<c[bpKey][stateKey]["background-image"].indexOf("[oxygen")&&(i.media[bpKey][stateKey]=c[bpKey][stateKey]["background-image"],s++)}else"id"===r&&n[key]&&n[key]["background-image"]&&-1<n[key]["background-image"].indexOf("[oxygen")&&(i[key]=n[key]["background-image"],s++);for(key in i)if("lock"!==key)if("media"===key){c=i.media;for(bpKey in c)for(stateKey in c[bpKey])to.applyShortcodeResults(t,i.media[bpKey][stateKey],function(e,o){if("selector"===r?to.dynamicBackgrounds.selectors[t].media[o.bpKey][o.stateKey]=e.trim():"class"===r?to.dynamicBackgrounds.classes[t].media[o.bpKey][o.stateKey]=e.trim():"id"===r&&(to.dynamicBackgrounds[t].media[o.bpKey][o.stateKey]=e.trim()),0===--s)return delete i.lock,void a()},{id:t,bpKey:bpKey,stateKey:stateKey})}else to.applyShortcodeResults(t,i[key],function(e,o){if("selector"===r?to.dynamicBackgrounds.selectors[t][o.key]=e.trim():"class"===r?to.dynamicBackgrounds.classes[t][o.key]=e.trim():"id"===r&&(to.dynamicBackgrounds[t][o.key]=e.trim()),0===--s)return delete i.lock,void a()},{id:t,key:key});0===s&&(delete i.lock,a())},to.outputCSSOptions=function(e,r,o){to.globalWooSettingsAdded=[],to.log&&(console.log("outputCSSOptions()",e),to.functionStart("outputCSSOptions()"));if(to.bufferedOutputStyles=to.bufferedOutputStyles||{},to.bufferedOutputStyles.keys=to.bufferedOutputStyles.keys||[],(to.isEditing("class")||to.isEditing("id")||1==r)&&to.bufferedOutputStyles.keys.indexOf("id")<0&&to.bufferedOutputStyles.keys.push("id"),!to.isEditing("class")&&to.classesCached||to.bufferedOutputStyles.keys.indexOf("classes")<0&&to.bufferedOutputStyles.keys.push("classes"),to.bufferedOutputStyles.keys.indexOf("selectors")<0&&to.bufferedOutputStyles.keys.push("selectors"),(to.isEditing("class")||to.isEditing("id")||1==r)&&(void 0!==e&&0<e?to.updateComponentCacheStyles(e,function(){to.cache.idCSS="",Object.keys(to.cache.idStyles).map(function(e,o){to.cache.idCSS+=to.cache.idStyles[e]}),to.outputCSSStylesAfterWait("id",to.cache.idCSS)}):(Object.keys(to.cache.idStyles).map(function(e,o){to.cache.idCSS+=to.cache.idStyles[e]}),to.outputCSSStylesAfterWait("id",to.cache.idCSS))),to.isEditing("class")||!to.classesCached)if(to.classesCached)void 0!==to.classes[to.currentClass]&&void 0!==to.classes[to.currentClass].parent&&void 0!==to.styleFolders[to.classes[to.currentClass].parent]&&1!==to.styleFolders[to.classes[to.currentClass].parent].status||-1!==parseInt(to.classes[to.currentClass].parent)&&(to.cache.classStyles[to.currentClass]=to.getSingleClassCSS(to.currentClass)),to.cache.classCSS="",Object.keys(to.cache.classStyles).map(function(e,o){to.cache.classCSS+=to.cache.classStyles[e]}),to.outputCSSStylesAfterWait("classes",to.cache.classCSS),"";else{to.cache.classStyles=[];var a=Object.keys(to.classes),i=function(e){var o=function(){0<a.length?i(a.shift()):(to.cache.classCSS="",Object.keys(to.cache.classStyles).map(function(e,o){to.cache.classCSS+=to.cache.classStyles[e]}),to.outputCSSStylesAfterWait("classes",to.cache.classCSS),"",to.classesCached=!0)};if(to.classes.hasOwnProperty(e)){var t=to.classes[e];to.cache.classStyles[e]="",(void 0===to.classes[e].parent||void 0===to.styleFolders[to.classes[e].parent]||1===to.styleFolders[to.classes[e].parent].status)&&-1!==parseInt(to.classes[e].parent)?to.generateDynamicBackgrounds(e,r,"class",function(){to.cache.classStyles[e]=to.getSingleClassCSS(e,t),o()}):o()}else o()};0<a.length?i(a.shift()):(to.cache.classCSS="",to.outputCSSStylesAfterWait("classes",to.cache.classCSS),to.classesCached=!0)}to.cache.selectorStyles=[],to.cache.selectorCSS="";var n=Object.keys(to.customSelectors),l=function(e){var o=function(){0<n.length?l(n.shift()):(to.cache.selectorCSS="",Object.keys(to.cache.selectorStyles).map(function(e,o){to.cache.selectorCSS+=to.cache.selectorStyles[e]}),to.outputCSSStylesAfterWait("selectors",to.cache.selectorCSS))};if(to.customSelectors.hasOwnProperty(e)){var t=to.customSelectors[e];to.cache.selectorStyles[e]="",!(void 0!==to.customSelectors[e].set_name&&void 0!==to.styleSets[to.customSelectors[e].set_name]&&void 0!==to.styleSets[to.customSelectors[e].set_name].parent&&void 0!==to.styleFolders[to.styleSets[to.customSelectors[e].set_name].parent]&&void 0!==to.styleFolders[to.styleSets[to.customSelectors[e].set_name].parent].status&&1!==to.styleFolders[to.styleSets[to.customSelectors[e].set_name].parent].status||void 0!==to.styleSets[to.customSelectors[e].set_name]&&-1===parseInt(to.styleSets[to.customSelectors[e].set_name].parent))?to.generateDynamicBackgrounds(e,r,"selector",function(){to.cache.selectorStyles[e]=to.getSingleSelectorCSS(e,t),o()}):o()}else o()};0<n.length?l(n.shift()):to.outputCSSStylesAfterWait("selectors",to.cache.selectorCSS),to.functionEnd("outputCSSOptions()")},to.outputCSSStylesAfterWait=function(e,o){"id"===e&&(to.idStylesContainer.innerHTML=o),"classes"===e&&(to.classStylesContainer.innerHTML=o),"selectors"===e&&to.outputCSSStyles("ct-custom-selectors",o)},to.updateComponentCacheStyles=function(e,o,t){to.contentAdded=[],to.log&&console.log("updateComponentCacheStyles()",e,to.component.options[e]),to.generateDynamicBackgrounds(e,!1,"id",function(){to.cache.idStyles[e]=to.getSingleComponentCSS(to.component.options[e],e,null,null,t),o&&o()})},to.updateAllComponentsCacheStyles=function(){for(var e in to.functionStart("updateAllComponentsCacheStyles()"),to.component.options)to.component.options.hasOwnProperty(e)&&to.updateComponentCacheStyles(e,function(){to.cache.idCSS="",Object.keys(to.cache.idStyles).map(function(e,o){to.cache.idCSS+=to.cache.idStyles[e]}),to.outputCSSStylesAfterWait("id",to.cache.idCSS)});to.functionEnd("updateAllComponentsCacheStyles()")},to.removeComponentCacheStyles=function(e){delete to.cache.idStyles[e]},to.getDynamicBackground=function(e,o){var t;return"id"===e&&to.dynamicBackgrounds[o.id]?t=to.dynamicBackgrounds[o.id]:"class"===e&&to.dynamicBackgrounds.classes[o.id]?t=to.dynamicBackgrounds.classes[o.id]:"selector"===e&&to.dynamicBackgrounds.selectors[o.id]&&(t=to.dynamicBackgrounds.selectors[o.id]),o.media?t.media[o.media]["id"===o.stateName?"original":o.stateName]:t["id"===o.stateName?"original":o.stateName]},to.getSingleComponentCSS=function(e,o,t,r,a){if("ct_reusable"==e.name&&e.original){to.reusableCSS={},to.reusableCSS.styles="  ";var i=e.original.view_id;return to.postsData[i]&&(to.generateTreeCSS(to.postsData[i].post_tree,to.reusableCSS),to.outputCSSStyles("ct-re-usable-styles-"+i,to.reusableCSS.styles)),""}to.log&&(console.log("getSingleComponentCSS()",o,e,t),to.functionStart("getSingleComponentCSS()"));var n="",l="",s="",c=to.defaultOptions[e.name];for(var p in null==e.original&&(e.original=[]),e)if(e.hasOwnProperty(p)){var d=e[p];if("original"==p&&!t)continue;if(0!=o&&"object"==typeof d&&"model"!=p&&"classes"!=p&&"media"!=p){var g,_,m,y,u,b,h=angular.copy(e[p]),x=to.getCSSOptions(o,p,h,e.name);if(mergedOriginalOptions=angular.copy(e.original),originalOptions=to.getCSSOptions(o,"original",mergedOriginalOptions,e.name),s="id"==p||t&&"original"==p||p==to.currentState&&o==to.component.active.id&&to.isEditing("id")&&("hover"==p||"active"==p||"focus"==p)?"":":"+p,l="ct_paragraph"==e.name?" p":"",a){n+="#"+e.selector+'[ng-attr-component-id="'+o+'"]'+l+s+"{",n+=to.getBackgroundLayersCSS(x,e.name,"id",o,r,p)||"",n+="}";continue}if("ct_columns"==e.name){var S=to.getWidth(e.original.gutter);n+="#"+e.selector+" .ct-column"+s+"{",n+="margin-right:"+S.value/2+S.unit+";",n+="margin-left:"+S.value/2+S.unit+";",n+="}"}if("true"==e.original.dont_render&&(n+="#"+e.selector+"{",e.original["placeholder-width"]&&(n+="width:"+e.original["placeholder-width"]+(e.original["placeholder-width-unit"]||c["placeholder-width-unit"])+";"),e.original["placeholder-height"]&&(n+="height:"+e.original["placeholder-height"]+(e.original["placeholder-height-unit"]||c["placeholder-height-unit"])+";"),n+="}"),"ct_section"==e.name){n+="#"+e.selector+">.ct-section-inner-wrap"+s+"{",null==x["section-width"]&&(x["section-width"]=c["section-width"]),x["section-width"],"custom"==x["section-width"]&&x["custom-width"]&&(n+="max-width:"+x["custom-width"]+";"),"full-width"==x["section-width"]&&(n+="max-width:100%;"),x["container-padding-top"]&&(n+="padding-top:"+x["container-padding-top"]+";"),x["container-padding-right"]&&(n+="padding-right:"+x["container-padding-right"]+";"),x["container-padding-bottom"]&&(n+="padding-bottom:"+x["container-padding-bottom"]+";"),x["container-padding-left"]&&(n+="padding-left:"+x["container-padding-left"]+";"),x.display&&(n+="display:"+x.display+";");var f="reverse"==x["flex-reverse"]?"-reverse":"";x["flex-direction"]&&(n+="flex-direction:"+x["flex-direction"]+f+";"),x["justify-content"]&&(n+="justify-content:"+x["justify-content"]+";"),x["align-content"]&&(n+="align-content:"+x["align-content"]+";"),x["align-items"]&&(n+="align-items:"+x["align-items"]+";"),x["flex-wrap"]&&(n+="flex-wrap:"+x["flex-wrap"]+";"),n+="}",e.original.video_background_hide&&(n+="@media (max-width: "+to.getMediaMaxSize(e.original.video_background_hide)+") {",n+="#"+e.selector+" .oxy-video-container { display: none; }",n+="}"),e.original.video_background_overlay&&(n+="#"+e.selector+" .oxy-video-overlay { background-color: "+e.original.video_background_overlay+"; }")}if("oxy_dynamic_list"==e.name&&(to.mapCSSProperty("paginate_size","font-size",".oxy-repeater-pages"),to.mapCSSProperty("paginate_color","color",".oxy-repeater-pages"),to.mapCSSProperty("paginate_alignment","justify-content",".oxy-repeater-pages"),to.mapCSSProperty("paginate_wrap_alignment","justify-content",".oxy-repeater-pages-wrap"),to.mapCSSProperty("paginate_link_color","color",".oxy-repeater-pages a.page-numbers"),to.mapCSSProperty("paginate_link_hover_color","color",".oxy-repeater-pages a.page-numbers:hover"),to.mapCSSProperty("paginate_padding_top","padding-top",".oxy-repeater-pages"),to.mapCSSProperty("paginate_padding_left","padding-left",".oxy-repeater-pages"),to.mapCSSProperty("paginate_padding_right","padding-right",".oxy-repeater-pages"),to.mapCSSProperty("paginate_padding_bottom","padding-bottom",".oxy-repeater-pages"),to.mapCSSProperty("paginate_margin_top","margin-top",".oxy-repeater-pages"),to.mapCSSProperty("paginate_margin_left","margin-left",".oxy-repeater-pages"),to.mapCSSProperty("paginate_margin_right","margin-right",".oxy-repeater-pages"),to.mapCSSProperty("paginate_margin_bottom","margin-bottom",".oxy-repeater-pages"),to.mapCSSProperty("paginate_width","width",".oxy-repeater-pages"),to.mapCSSProperty("paginate_min_width","min-width",".oxy-repeater-pages"),to.mapCSSProperty("paginate_max_width","max-width",".oxy-repeater-pages"),to.mapCSSProperty("paginate_height","height",".oxy-repeater-pages"),to.mapCSSProperty("paginate_min_height","min-height",".oxy-repeater-pages"),to.mapCSSProperty("paginate_max_height","max-height",".oxy-repeater-pages"),to.mapCSSProperty("paginate_flex_direction","flex-direction",".oxy-repeater-pages"),to.mapCSSProperty("paginate_flex_wrap","flex-wrap",".oxy-repeater-pages"),to.mapCSSProperty("paginate_border_all_color","border-color",".oxy-repeater-pages"),to.mapCSSProperty("paginate_border_top_color","border-top-color",".oxy-repeater-pages"),to.mapCSSProperty("paginate_border_left_color","border-left-color",".oxy-repeater-pages"),to.mapCSSProperty("paginate_border_bottom_color","border-bottom-color",".oxy-repeater-pages"),to.mapCSSProperty("paginate_border_right_color","border-right-color",".oxy-repeater-pages"),to.mapCSSProperty("paginate_border_all_width","border-width",".oxy-repeater-pages"),to.mapCSSProperty("paginate_border_top_width","border-top-width",".oxy-repeater-pages"),to.mapCSSProperty("paginate_border_left_width","border-left-width",".oxy-repeater-pages"),to.mapCSSProperty("paginate_border_bottom_width","border-bottom-width",".oxy-repeater-pages"),to.mapCSSProperty("paginate_border_right_width","border-right-width",".oxy-repeater-pages"),to.mapCSSProperty("paginate_border_all_style","border-style",".oxy-repeater-pages"),to.mapCSSProperty("paginate_border_top_style","border-top-style",".oxy-repeater-pages"),to.mapCSSProperty("paginate_border_left_style","border-left-style",".oxy-repeater-pages"),to.mapCSSProperty("paginate_border_bottom_style","border-bottom-style",".oxy-repeater-pages"),to.mapCSSProperty("paginate_border_right_style","border-right-style",".oxy-repeater-pages"),to.mapCSSProperty("paginate_border_radius","border-radius",".oxy-repeater-pages"),to.mapCSSProperty("paginate_border_top_left_radius","border-top-left-radius",".oxy-repeater-pages"),to.mapCSSProperty("paginate_border_top_right_radius","border-top-right-radius",".oxy-repeater-pages"),to.mapCSSProperty("paginate_border_bottom_right_radius","border-bottom-right-radius",".oxy-repeater-pages"),to.mapCSSProperty("paginate_border_bottom_left_radius","border-bottom-left-radius",".oxy-repeater-pages"),to.mapCSSProperty("paginatelink_border_all_color","border-color",".oxy-repeater-pages a"),to.mapCSSProperty("paginatelink_border_top_color","border-top-color",".oxy-repeater-pages a"),to.mapCSSProperty("paginatelink_border_left_color","border-left-color",".oxy-repeater-pages a"),to.mapCSSProperty("paginatelink_border_bottom_color","border-bottom-color",".oxy-repeater-pages a"),to.mapCSSProperty("paginatelink_border_right_color","border-right-color",".oxy-repeater-pages a"),to.mapCSSProperty("paginatelink_border_all_width","border-width",".oxy-repeater-pages a"),to.mapCSSProperty("paginatelink_border_top_width","border-top-width",".oxy-repeater-pages a"),to.mapCSSProperty("paginatelink_border_left_width","border-left-width",".oxy-repeater-pages a"),to.mapCSSProperty("paginatelink_border_bottom_width","border-bottom-width",".oxy-repeater-pages a"),to.mapCSSProperty("paginatelink_border_right_width","border-right-width",".oxy-repeater-pages a"),to.mapCSSProperty("paginatelink_border_all_style","border-style",".oxy-repeater-pages a"),to.mapCSSProperty("paginatelink_border_top_style","border-top-style",".oxy-repeater-pages a"),to.mapCSSProperty("paginatelink_border_left_style","border-left-style",".oxy-repeater-pages a"),to.mapCSSProperty("paginatelink_border_bottom_style","border-bottom-style",".oxy-repeater-pages a"),to.mapCSSProperty("paginatelink_border_right_style","border-right-style",".oxy-repeater-pages a"),to.mapCSSProperty("paginatelink_border_radius","border-radius",".oxy-repeater-pages a"),to.mapCSSProperty("paginatelink_border_top_left_radius","border-top-left-radius",".oxy-repeater-pages a"),to.mapCSSProperty("paginatelink_border_top_right_radius","border-top-right-radius",".oxy-repeater-pages a"),to.mapCSSProperty("paginatelink_border_bottom_right_radius","border-bottom-right-radius",".oxy-repeater-pages a"),to.mapCSSProperty("paginatelink_border_bottom_left_radius","border-bottom-left-radius",".oxy-repeater-pages a"),to.mapCSSProperty("paginatelinkactive_border_all_color","border-color",".oxy-repeater-pages span.current"),to.mapCSSProperty("paginatelinkactive_border_top_color","border-top-color",".oxy-repeater-pages span.current"),to.mapCSSProperty("paginatelinkactive_border_left_color","border-left-color",".oxy-repeater-pages span.current"),to.mapCSSProperty("paginatelinkactive_border_bottom_color","border-bottom-color",".oxy-repeater-pages span.current"),to.mapCSSProperty("paginatelinkactive_border_right_color","border-right-color",".oxy-repeater-pages span.current"),to.mapCSSProperty("paginatelinkactive_border_all_width","border-width",".oxy-repeater-pages span.current"),to.mapCSSProperty("paginatelinkactive_border_top_width","border-top-width",".oxy-repeater-pages span.current"),to.mapCSSProperty("paginatelinkactive_border_left_width","border-left-width",".oxy-repeater-pages span.current"),to.mapCSSProperty("paginatelinkactive_border_bottom_width","border-bottom-width",".oxy-repeater-pages span.current"),to.mapCSSProperty("paginatelinkactive_border_right_width","border-right-width",".oxy-repeater-pages span.current"),to.mapCSSProperty("paginatelinkactive_border_all_style","border-style",".oxy-repeater-pages span.current"),to.mapCSSProperty("paginatelinkactive_border_top_style","border-top-style",".oxy-repeater-pages span.current"),to.mapCSSProperty("paginatelinkactive_border_left_style","border-left-style",".oxy-repeater-pages span.current"),to.mapCSSProperty("paginatelinkactive_border_bottom_style","border-bottom-style",".oxy-repeater-pages span.current"),to.mapCSSProperty("paginatelinkactive_border_right_style","border-right-style",".oxy-repeater-pages span.current"),to.mapCSSProperty("paginatelinkactive_border_radius","border-radius",".oxy-repeater-pages span.current"),to.mapCSSProperty("paginatelinkactive_border_top_left_radius","border-top-left-radius",".oxy-repeater-pages span.current"),to.mapCSSProperty("paginatelinkactive_border_top_right_radius","border-top-right-radius",".oxy-repeater-pages span.current"),to.mapCSSProperty("paginatelinkactive_border_bottom_right_radius","border-bottom-right-radius",".oxy-repeater-pages span.current"),to.mapCSSProperty("paginatelinkactive_border_bottom_left_radius","border-bottom-left-radius",".oxy-repeater-pages span.current"),to.mapCSSProperty("paginate_background_color","background-color",".oxy-repeater-pages"),to.mapCSSProperty("paginate_background_image","background-image",".oxy-repeater-pages"),to.mapCSSProperty("paginate_background_size","background-size",".oxy-repeater-pages"),to.mapCSSProperty("paginate_background_size_width","background-size-width",".oxy-repeater-pages"),to.mapCSSProperty("paginate_background_size_height","background-size-height",".oxy-repeater-pages"),to.mapCSSProperty("paginate_background_repeat","background-repeat",".oxy-repeater-pages"),to.mapCSSProperty("paginatelink_background_color","background-color",".oxy-repeater-pages a"),to.mapCSSProperty("paginatelink_background_image","background-image",".oxy-repeater-pages a"),to.mapCSSProperty("paginatelink_background_size","background-size",".oxy-repeater-pages a"),to.mapCSSProperty("paginatelink_background_size_width","background-size-width",".oxy-repeater-pages a"),to.mapCSSProperty("paginatelink_background_size_height","background-size-height",".oxy-repeater-pages a"),to.mapCSSProperty("paginatelink_background_repeat","background-repeat",".oxy-repeater-pages a"),to.mapCSSProperty("paginatelinkactive_background_color","background-color",".oxy-repeater-pages span.current"),to.mapCSSProperty("paginatelinkactive_background_image","background-image",".oxy-repeater-pages span.current"),to.mapCSSProperty("paginatelinkactive_background_size","background-size",".oxy-repeater-pages span.current"),to.mapCSSProperty("paginatelinkactive_background_size_width","background-size-width",".oxy-repeater-pages span.current"),to.mapCSSProperty("paginatelinkactive_background_size_height","background-size-height",".oxy-repeater-pages span.current"),to.mapCSSProperty("paginatelinkactive_background_repeat","background-repeat",".oxy-repeater-pages span.current"),to.mapCSSProperty("paginatelink_padding_top","padding-top",".oxy-repeater-pages a"),to.mapCSSProperty("paginatelink_padding_left","padding-left",".oxy-repeater-pages a"),to.mapCSSProperty("paginatelink_padding_right","padding-right",".oxy-repeater-pages a"),to.mapCSSProperty("paginatelink_padding_bottom","padding-bottom",".oxy-repeater-pages a"),to.mapCSSProperty("paginatelink_margin_top","margin-top",".oxy-repeater-pages a"),to.mapCSSProperty("paginatelink_margin_left","margin-left",".oxy-repeater-pages a"),to.mapCSSProperty("paginatelink_margin_right","margin-right",".oxy-repeater-pages a"),to.mapCSSProperty("paginatelink_margin_bottom","margin-bottom",".oxy-repeater-pages a"),to.mapCSSProperty("paginatelink_width","width",".oxy-repeater-pages a"),to.mapCSSProperty("paginatelink_min_width","min-width",".oxy-repeater-pages a"),to.mapCSSProperty("paginatelink_max_width","max-width",".oxy-repeater-pages a"),to.mapCSSProperty("paginatelink_height","height",".oxy-repeater-pages a"),to.mapCSSProperty("paginatelink_min_height","min-height",".oxy-repeater-pages a"),to.mapCSSProperty("paginatelink_max_height","max-height",".oxy-repeater-pages a"),to.mapCSSProperty("paginatelinkactive_padding_top","padding-top",".oxy-repeater-pages span.current"),to.mapCSSProperty("paginatelinkactive_padding_left","padding-left",".oxy-repeater-pages span.current"),to.mapCSSProperty("paginatelinkactive_padding_right","padding-right",".oxy-repeater-pages span.current"),to.mapCSSProperty("paginatelinkactive_padding_bottom","padding-bottom",".oxy-repeater-pages span.current"),to.mapCSSProperty("paginatelinkactive_margin_top","margin-top",".oxy-repeater-pages span.current"),to.mapCSSProperty("paginatelinkactive_margin_left","margin-left",".oxy-repeater-pages span.current"),to.mapCSSProperty("paginatelinkactive_margin_right","margin-right",".oxy-repeater-pages span.current"),to.mapCSSProperty("paginatelinkactive_margin_bottom","margin-bottom",".oxy-repeater-pages span.current"),to.mapCSSProperty("paginatelinkactive_width","width",".oxy-repeater-pages span.current"),to.mapCSSProperty("paginatelinkactive_min_width","min-width",".oxy-repeater-pages span.current"),to.mapCSSProperty("paginatelinkactive_max_width","max-width",".oxy-repeater-pages span.current"),to.mapCSSProperty("paginatelinkactive_height","height",".oxy-repeater-pages span.current"),to.mapCSSProperty("paginatelinkactive_min_height","min-height",".oxy-repeater-pages span.current"),to.mapCSSProperty("paginatelinkactive_max_height","max-height",".oxy-repeater-pages span.current"),to.mapCSSProperty("paginatelinkhover_background_color","background-color",".oxy-repeater-pages a:hover"),to.mapCSSProperty("paginatelinkhover_background_image","background-image",".oxy-repeater-pages a:hover"),to.mapCSSProperty("paginatelinkhover_background_size","background-size",".oxy-repeater-pages a:hover"),to.mapCSSProperty("paginatelinkhover_background_size_width","background-size-width",".oxy-repeater-pages a:hover"),to.mapCSSProperty("paginatelinkhover_background_size_height","background-size-height",".oxy-repeater-pages a:hover"),to.mapCSSProperty("paginatelinkhover_background_repeat","background-repeat",".oxy-repeater-pages a:hover"),to.mapCSSProperty("paginatelinkactivehover_background_color","background-color",".oxy-repeater-pages span.current:hover"),to.mapCSSProperty("paginatelinkactivehover_background_image","background-image",".oxy-repeater-pages span.current:hover"),to.mapCSSProperty("paginatelinkactivehover_background_size","background-size",".oxy-repeater-pages span.current:hover"),to.mapCSSProperty("paginatelinkactivehover_background_size_width","background-size-width",".oxy-repeater-pages span.current:hover"),to.mapCSSProperty("paginatelinkactivehover_background_size_height","background-size-height",".oxy-repeater-pages span.current:hover"),to.mapCSSProperty("paginatelinkactivehover_background_repeat","background-repeat",".oxy-repeater-pages span.current:hover"),to.mapCSSProperty("paginatelinkhover_padding_top","padding-top",".oxy-repeater-pages a:hover"),to.mapCSSProperty("paginatelinkhover_padding_left","padding-left",".oxy-repeater-pages a:hover"),to.mapCSSProperty("paginatelinkhover_padding_right","padding-right",".oxy-repeater-pages a:hover"),to.mapCSSProperty("paginatelinkhover_padding_bottom","padding-bottom",".oxy-repeater-pages a:hover"),to.mapCSSProperty("paginatelinkhover_margin_top","margin-top",".oxy-repeater-pages a:hover"),to.mapCSSProperty("paginatelinkhover_margin_left","margin-left",".oxy-repeater-pages a:hover"),to.mapCSSProperty("paginatelinkhover_margin_right","margin-right",".oxy-repeater-pages a:hover"),to.mapCSSProperty("paginatelinkhover_margin_bottom","margin-bottom",".oxy-repeater-pages a:hover"),to.mapCSSProperty("paginatelinkhover_width","width",".oxy-repeater-pages a:hover"),to.mapCSSProperty("paginatelinkhover_min_width","min-width",".oxy-repeater-pages a:hover"),to.mapCSSProperty("paginatelinkhover_max_width","max-width",".oxy-repeater-pages a:hover"),to.mapCSSProperty("paginatelinkhover_height","height",".oxy-repeater-pages a:hover"),to.mapCSSProperty("paginatelinkhover_min_height","min-height",".oxy-repeater-pages a:hover"),to.mapCSSProperty("paginatelinkhover_max_height","max-height",".oxy-repeater-pages a:hover"),to.mapCSSProperty("paginatelinkactivehover_padding_top","padding-top",".oxy-repeater-pages span.current:hover"),to.mapCSSProperty("paginatelinkactivehover_padding_left","padding-left",".oxy-repeater-pages span.current:hover"),to.mapCSSProperty("paginatelinkactivehover_padding_right","padding-right",".oxy-repeater-pages span.current:hover"),to.mapCSSProperty("paginatelinkactivehover_padding_bottom","padding-bottom",".oxy-repeater-pages span.current:hover"),to.mapCSSProperty("paginatelinkactivehover_margin_top","margin-top",".oxy-repeater-pages span.current:hover"),to.mapCSSProperty("paginatelinkactivehover_margin_left","margin-left",".oxy-repeater-pages span.current:hover"),to.mapCSSProperty("paginatelinkactivehover_margin_right","margin-right",".oxy-repeater-pages span.current:hover"),to.mapCSSProperty("paginatelinkactivehover_margin_bottom","margin-bottom",".oxy-repeater-pages span.current:hover"),to.mapCSSProperty("paginatelinkactivehover_width","width",".oxy-repeater-pages span.current:hover"),to.mapCSSProperty("paginatelinkactivehover_min_width","min-width",".oxy-repeater-pages span.current:hover"),to.mapCSSProperty("paginatelinkactivehover_max_width","max-width",".oxy-repeater-pages span.current:hover"),to.mapCSSProperty("paginatelinkactivehover_height","height",".oxy-repeater-pages span.current:hover"),to.mapCSSProperty("paginatelinkactivehover_min_height","min-height",".oxy-repeater-pages span.current:hover"),to.mapCSSProperty("paginatelinkactivehover_max_height","max-height",".oxy-repeater-pages span.current:hover"),to.mapCSSProperty("paginatelinkhover_border_all_color","border-color",".oxy-repeater-pages a:hover"),to.mapCSSProperty("paginatelinkhover_border_top_color","border-top-color",".oxy-repeater-pages a:hover"),to.mapCSSProperty("paginatelinkhover_border_left_color","border-left-color",".oxy-repeater-pages a:hover"),to.mapCSSProperty("paginatelinkhover_border_bottom_color","border-bottom-color",".oxy-repeater-pages a:hover"),to.mapCSSProperty("paginatelinkhover_border_right_color","border-right-color",".oxy-repeater-pages a:hover"),to.mapCSSProperty("paginatelinkhover_border_all_width","border-width",".oxy-repeater-pages a:hover"),to.mapCSSProperty("paginatelinkhover_border_top_width","border-top-width",".oxy-repeater-pages a:hover"),to.mapCSSProperty("paginatelinkhover_border_left_width","border-left-width",".oxy-repeater-pages a:hover"),to.mapCSSProperty("paginatelinkhover_border_bottom_width","border-bottom-width",".oxy-repeater-pages a:hover"),to.mapCSSProperty("paginatelinkhover_border_right_width","border-right-width",".oxy-repeater-pages a:hover"),to.mapCSSProperty("paginatelinkhover_border_all_style","border-style",".oxy-repeater-pages a:hover"),to.mapCSSProperty("paginatelinkhover_border_top_style","border-top-style",".oxy-repeater-pages a:hover"),to.mapCSSProperty("paginatelinkhover_border_left_style","border-left-style",".oxy-repeater-pages a:hover"),to.mapCSSProperty("paginatelinkhover_border_bottom_style","border-bottom-style",".oxy-repeater-pages a:hover"),to.mapCSSProperty("paginatelinkhover_border_right_style","border-right-style",".oxy-repeater-pages a:hover"),to.mapCSSProperty("paginatelinkhover_border_radius","border-radius",".oxy-repeater-pages a:hover"),to.mapCSSProperty("paginatelinkhover_border_top_left_radius","border-top-left-radius",".oxy-repeater-pages a:hover"),to.mapCSSProperty("paginatelinkhover_border_top_right_radius","border-top-right-radius",".oxy-repeater-pages a:hover"),to.mapCSSProperty("paginatelinkhover_border_bottom_right_radius","border-bottom-right-radius",".oxy-repeater-pages a:hover"),to.mapCSSProperty("paginatelinkhover_border_bottom_left_radius","border-bottom-left-radius",".oxy-repeater-pages a:hover"),to.mapCSSProperty("paginatelinkactivehover_border_all_color","border-color",".oxy-repeater-pages span.current:hover"),to.mapCSSProperty("paginatelinkactivehover_border_top_color","border-top-color",".oxy-repeater-pages span.current:hover"),to.mapCSSProperty("paginatelinkactivehover_border_left_color","border-left-color",".oxy-repeater-pages span.current:hover"),to.mapCSSProperty("paginatelinkactivehover_border_bottom_color","border-bottom-color",".oxy-repeater-pages span.current:hover"),to.mapCSSProperty("paginatelinkactivehover_border_right_color","border-right-color",".oxy-repeater-pages span.current:hover"),to.mapCSSProperty("paginatelinkactivehover_border_all_width","border-width",".oxy-repeater-pages span.current:hover"),to.mapCSSProperty("paginatelinkactivehover_border_top_width","border-top-width",".oxy-repeater-pages span.current:hover"),to.mapCSSProperty("paginatelinkactivehover_border_left_width","border-left-width",".oxy-repeater-pages span.current:hover"),to.mapCSSProperty("paginatelinkactivehover_border_bottom_width","border-bottom-width",".oxy-repeater-pages span.current:hover"),to.mapCSSProperty("paginatelinkactivehover_border_right_width","border-right-width",".oxy-repeater-pages span.current:hover"),to.mapCSSProperty("paginatelinkactivehover_border_all_style","border-style",".oxy-repeater-pages span.current:hover"),to.mapCSSProperty("paginatelinkactivehover_border_top_style","border-top-style",".oxy-repeater-pages span.current:hover"),to.mapCSSProperty("paginatelinkactivehover_border_left_style","border-left-style",".oxy-repeater-pages span.current:hover"),to.mapCSSProperty("paginatelinkactivehover_border_bottom_style","border-bottom-style",".oxy-repeater-pages span.current:hover"),to.mapCSSProperty("paginatelinkactivehover_border_right_style","border-right-style",".oxy-repeater-pages span.current:hover"),to.mapCSSProperty("paginatelinkactivehover_border_radius","border-radius",".oxy-repeater-pages span.current:hover"),to.mapCSSProperty("paginatelinkactivehover_border_top_left_radius","border-top-left-radius",".oxy-repeater-pages span.current:hover"),to.mapCSSProperty("paginatelinkactivehover_border_top_right_radius","border-top-right-radius",".oxy-repeater-pages span.current:hover"),to.mapCSSProperty("paginatelinkactivehover_border_bottom_right_radius","border-bottom-right-radius",".oxy-repeater-pages span.current:hover"),to.mapCSSProperty("paginatelinkactivehover_border_bottom_left_radius","border-bottom-left-radius",".oxy-repeater-pages span.current:hover"),to.mapCSSProperty("paginate_link_transition","transition",".oxy-repeater-pages > *")),"oxy_posts_grid"==e.name&&(to.mapCSSProperty("title_size","font-size",".oxy-post-title"),to.mapCSSProperty("title_color","color",".oxy-post-title"),to.mapCSSProperty("title_hover_color","color",".oxy-post-title:hover"),to.mapCSSProperty("meta_size","font-size",".oxy-post-meta"),to.mapCSSProperty("meta_color","color",".oxy-post-meta"),to.mapCSSProperty("content_size","font-size",".oxy-post-content"),to.mapCSSProperty("content_color","color",".oxy-post-content"),to.mapCSSProperty("read_more_size","font-size",".oxy-read-more"),to.mapCSSProperty("read_more_text_color","color",".oxy-read-more"),to.mapCSSProperty("read_more_button_color","background-color",".oxy-read-more"),to.mapCSSProperty("read_more_text_hover_color","color",".oxy-read-more:hover"),to.mapCSSProperty("read_more_button_hover_color","background-color",".oxy-read-more:hover"),to.mapCSSProperty("paginate_color","color",".oxy-easy-posts-pages"),to.mapCSSProperty("paginate_alignment","text-align",".oxy-easy-posts-pages"),to.mapCSSProperty("paginate_link_color","color",".oxy-easy-posts-pages a.page-numbers"),to.mapCSSProperty("paginate_link_hover_color","color",".oxy-easy-posts-pages a.page-numbers:hover"),"button"==e.original.read_more_display_as?(n+="#"+e.selector+" .oxy-read-more {",n+="text-decoration:none;",n+="padding:0.75em 1.5em;",n+="line-height:1;",n+="border-radius:3px;",n+="display:inline-block;",n+="}"):(to.unmapCSSProperty("background-color",".oxy-read-more"),to.unmapCSSProperty("background-color",".oxy-read-more:hover")),n+="@media (max-width: "+to.getMediaMaxSize(e.original.posts_5050_below)+") {",n+="#"+e.selector+" .oxy-post { width: 50% !important; }",n+="}",n+="@media (max-width: "+to.getMediaMaxSize(e.original.posts_100_below)+") {",n+="#"+e.selector+" .oxy-post { width: 100% !important; }",n+="}"),"oxy_comment_form"==e.name&&(to.mapCSSProperty("form_field_border_color","border-color","input, textarea"),to.mapCSSProperty("form_field_text_color","color","input, textarea"),to.mapCSSProperty("field_border_radius","border-radius","input, textarea"),to.mapCSSProperty("submit_button_background_color","background-color","#submit"),to.mapCSSProperty("submit_button_text_color","color","#submit")),"oxy_login_form"==e.name&&(to.mapCSSProperty("form_field_border_color","border-color","input, textarea"),to.mapCSSProperty("form_field_text_color","color","input, textarea"),to.mapCSSProperty("field_border_radius","border-radius","input, textarea"),to.mapCSSProperty("submit_button_background_color","background-color","input[type=submit]"),to.mapCSSProperty("submit_button_text_color","color","input[type=submit]")),"oxy_search_form"==e.name&&(to.mapCSSProperty("form_field_border_color","border-color","input, textarea"),to.mapCSSProperty("form_field_text_color","color","input, textarea"),to.mapCSSProperty("field_border_radius","border-radius","input, textarea"),to.mapCSSProperty("submit_button_background_color","background-color","input[type=submit]"),to.mapCSSProperty("submit_button_text_color","color","input[type=submit]")),"ct_video"==e.name){n=n+"#"+e.selector+">.oxygen-vsb-responsive-video-wrapper"+s+"{";var v=e.original["video-padding-bottom"]||c["video-padding-bottom"];v&&(n+="padding-bottom:"+v+";"),n+="}"}if("ct_new_columns"==e.name&&e.original["set-columns-width-50"]&&"never"!=e.original["set-columns-width-50"]&&(n+="@media (max-width: "+to.getMediaMaxSize(e.original["set-columns-width-50"])+") {",n+="#"+e.selector+"> .ct-div-block {width: 50% !important;}",n+="}"),"ct_new_columns"==e.name){var C=parseInt(to.getMediaMaxSize(e.original["reverse-column-order"]))||0,k=parseInt(to.getMediaMaxSize(e.original["stack-columns-vertically"]))||0,w="",P="";"always"==e.original["reverse-column-order"]&&(C=9999999999),e.original["stack-columns-vertically"]&&"never"!=e.original["stack-columns-vertically"]&&(P+="@media (max-width: "+to.getMediaMaxSize(e.original["stack-columns-vertically"])+") {",P+="#"+e.selector+"> .ct-div-block {",P+="width: 100% !important;",P+="}",P+="#"+e.selector+"{",P+=C<k?"flex-direction: column;":"flex-direction: column-reverse;",P+="}",P+="}"),void 0===e.original["stack-columns-vertically"]&&(n+="@media (max-width: "+to.getMediaMaxSize(c["stack-columns-vertically"])+") {",n+="#"+e.selector+"> .ct-div-block {width: 100% !important;}",n+="}"),e.original["reverse-column-order"]&&"never"!=e.original["reverse-column-order"]&&"always"!=e.original["reverse-column-order"]&&(w+="@media (max-width: "+to.getMediaMaxSize(e.original["reverse-column-order"])+") {",w+="#"+e.selector+"{",w+=k<C?"flex-direction: row-reverse;":"flex-direction: column-reverse;",w+="}",w+="}"),"always"==e.original["reverse-column-order"]&&(n+="#"+e.selector+"{flex-direction: row-reverse;}"),k<C?(n+=w,n+=P):(n+=P,n+=w)}if("oxy_header"==e.name){n+="#"+e.selector+" .oxy-header-container"+s+"{",null==x["header-width"]&&(x["header-width"]=c["header-width"]),"custom"==x["header-width"]&&x["header-custom-width"]&&(n+="max-width:"+x["header-custom-width"]+";"),"full-width"==x["header-width"]&&(n+="max-width:100%;"),n+="}",e.original["overlay-header-above"]&&"never"!=e.original["overlay-header-above"]&&("always"!=e.original["overlay-header-above"]&&(n+="@media (min-width: "+to.getMediaMinSize(e.original["overlay-header-above"])+") {"),n+="#"+e.selector+".oxy-header.oxy-overlay-header {position: absolute;left: 0;right: 0;z-index: 20;}#"+e.selector+".oxy-header.oxy-overlay-header:not(.oxy-sticky-header-active) .oxy-header-row,#"+e.selector+".oxy-header.oxy-overlay-header:not(.oxy-sticky-header-active){background-color: initial !important;}#"+e.selector+".oxy-header.oxy-overlay-header .oxygen-hide-in-overlay{display: none}#"+e.selector+".oxy-header.oxy-overlay-header .oxygen-only-show-in-overlay{display: block}","always"!=e.original["overlay-header-above"]&&(n+="}"));var O="";if(e.original["sticky-media"]&&"never"!=e.original["sticky-media"])"always"!=e.original["sticky-media"]&&(O+="@media (min-width: "+to.getMediaMinSize(e.original["sticky-media"])+") {"),O+="#"+e.selector+".oxy-header-wrapper.oxy-header.oxy-sticky-header.oxy-sticky-header-active {",O+="position: fixed; top: 0; left: 0; right: 0; z-index: "+(e.original.sticky_zindex||"2147483640")+";",O+=e.original["sticky-background-color"]?"background-color:"+to.getGlobalColorValue(e.original["sticky-background-color"])+";":"",O+="box-shadow:"+(e.original["sticky-box-shadow"]||c["sticky-box-shadow"])+";",O+="}",O+="#"+e.selector+".oxy-header.oxy-sticky-header-active .oxygen-hide-in-sticky {",O+="display:none;",O+="}",O+="#"+e.selector+".oxy-header.oxy-header .oxygen-show-in-sticky-only {",O+="display: none;",O+="}","always"!=e.original["sticky-media"]&&(O+="}");O&&(n+=O),e.original.sticky_header_fade_in_speed&&(n+="#"+e.selector+".oxy-sticky-header-active {animation-duration: "+e.original.sticky_header_fade_in_speed+"s;}")}if("oxy_header"==e.name||"oxy_header_row"==e.name){var z="";e.original["stack-header-vertically"]&&"never"!=e.original["stack-header-vertically"]&&(z+="@media (max-width: "+to.getMediaMaxSize(e.original["stack-header-vertically"])+") {",z+="#"+e.selector+" .oxy-header-container {",z+="flex-direction: column;",z+="}",z+="#"+e.selector+" .oxy-header-container > div{",z+="justify-content: center;",z+="}",z+="}"),z&&(n+=z)}if("oxy_header_row"==e.name){n+="#"+e.selector+".oxy-header-row .oxy-header-container"+s+"{",null==x["header-row-width"]&&(x["header-row-width"]=c["header-row-width"]),"custom"==x["header-row-width"]&&x["header-row-custom-width"]&&(n+="max-width:"+x["header-row-custom-width"]+";"),"full-width"==x["header-row-width"]&&(n+="max-width:100%;"),"page-width"==x["header-row-width"]&&(n+="max-width:"+to.getPageWidth()+"px;"),n+="}";var T="",G="";e.original["hide-row"]&&"never"!=e.original["hide-row"]&&(T+="@media (max-width: "+to.getMediaMaxSize(e.original["hide-row"])+") {",T+="#"+e.selector+" {",T+="display: none;",T+="}",T+="}"),T&&(n+=T);var V=x.display||"block";G+=".oxy-header.oxy-sticky-header-active > #"+e.selector+".oxygen-show-in-sticky-only {",G+="display: "+V+";",n+=G+="}"}if("ct_slider"==e.name&&(t||"id"!=p||(x["slider-arrow-color"]&&"lighter"==x["slider-arrow-color"]&&(n+="#"+e.selector+" .unslider-arrow {",n+="background-color: rgba(255,255,255,0.2); ",n+="}"),x["slider-dot-color"]&&(n+="#"+e.selector+" .unslider-nav ol li {",n+="border-color: "+to.getGlobalColorValue(x["slider-dot-color"])+"; ",n+="}",n+="#"+e.selector+" .unslider-nav ol li.unslider-active {",n+="background-color: "+to.getGlobalColorValue(x["slider-dot-color"])+"; ",n+="}"),x["slider-remove-padding"]&&"yes"==x["slider-remove-padding"]&&(n+="#"+e.selector+" .unslider {",n+="padding: 0px; ",n+="}",n+="#"+e.selector+" .unslider-wrap.unslider-carousel > li {",n+="padding: 0px; ",n+="}",n+="#"+e.selector+" .unslider-arrow.next {",n+="right: 10px; ",n+="z-index: 100; ",n+="}",n+="#"+e.selector+" .unslider-arrow.prev {",n+="left: 10px; ",n+="z-index: 100; ",n+="}"),x["slider-dots-overlay"]&&"yes"==x["slider-dots-overlay"]&&(n+="#"+e.selector+" .unslider .unslider-nav {",n+="position: absolute; bottom: 0; left: 0; right: 0; z-index:100",n+="}"),x["slider-stretch-slides"]&&"yes"==x["slider-stretch-slides"]&&(n+="#"+e.selector+" .unslider-wrap {",n+="display: flex;",n+="}",n+="#"+e.selector+" .ct-slide {",n+="height: 100%;",n+="}",n+="#"+e.selector+" .unslider,",n+="#"+e.selector+" .oxygen-unslider-container,",n+="#"+e.selector+" .unslider-wrap,",n+="#"+e.selector+" .unslider-wrap li {",n+="height: 100%;",n+="}"),x["slider-stretch-slides"]&&"yes"==x["slider-stretch-slides"]&&x["slider-animation"]&&"fade"==x["slider-animation"]&&(n+="#"+e.selector+" .unslider-fade ul li.unslider-active {",n+="width: 100%;",n+="}"),x["slider-slide-padding"]&&(n+="#"+e.selector+" .ct-slide {",n+="padding: "+x["slider-slide-padding"],n+="}"))),"ct_link_button"==e.name){if(t||"id"!=p)M=!!to.component.options[o]&&to.component.options[o].original["button-style"],A=to.getGlobalColorValue(x["button-color"]),I=x["button-size"],F=to.getGlobalColorValue(x["button-text-color"]);else var M=originalOptions["button-style"]||c["button-style"],A=to.getGlobalColorValue(x["button-color"]),I=x["button-size"],F=to.getGlobalColorValue(x["button-text-color"]);if(n=n+"#"+e.selector+s+"{",1==M&&A&&(n+="background-color: "+to.getGlobalColorValue(A)+";",n+="border: 1px solid "+A+";",F&&(n+="color: "+to.getGlobalColorValue(F)+";")),2==M&&(n+="background-color: transparent;",A?(n+="border: 1px solid "+to.getGlobalColorValue(A)+";",n+="color: "+to.getGlobalColorValue(A)+";"):n+="color: "+to.getGlobalColorValue(c["button-color"])+";"),I){var N=2==M?1:0;n+="padding: "+(parseInt(I)-N)+"px "+(1.6*parseInt(I)-N)+"px;"}n+="}"}if("ct_fancy_icon"==e.name){if(t||"id"!=p)E=!!to.component.options[o]&&to.component.options[o].original["icon-style"],j=to.getGlobalColorValue(x["icon-color"]),B=to.getGlobalColorValue(x["icon-background-color"]),D=x["icon-padding"],W=x["icon-size"];else var E=originalOptions["icon-style"]||c["icon-style"],j=to.getGlobalColorValue(x["icon-color"]),B=to.getGlobalColorValue(x["icon-background-color"])||c["icon-background-color"],D=x["icon-padding"]||c["icon-padding"]+c["icon-padding-unit"],W=x["icon-size"];n=n+"#"+e.selector+s+"{",1==E&&(n+="border: 1px solid;"),2==E&&B&&(n+="background-color: "+to.getGlobalColorValue(B)+";",n+="border: 1px solid "+to.getGlobalColorValue(B)+";"),1!=E&&2!=E||D&&(n+="padding:"+D+";"),j&&(n+="color:"+to.getGlobalColorValue(j)+";"),n+="}",W&&(n=n+"#"+e.selector+s+">svg {",n+="width: "+W+";",n+="height: "+W+";",n+="}")}if("oxy_social_icons"==e.name){E=e.original["icon-style"]||c["icon-style"];var X=to.getGlobalColorValue(e.original["icon-use-brand-colors"])||c["icon-use-brand-colors"];if(n+="#"+e.selector+".oxy-social-icons {",n+="flex-direction: "+(e.original["icon-layout"]||c["icon-layout"])+";",n+="margin-right: -"+(e.original["icon-space-between-icons"]||c["icon-space-between-icons"])+"px;",n+="margin-bottom: -"+(e.original["icon-space-between-icons"]||c["icon-space-between-icons"])+"px;",n+="}",n+="#"+e.selector+".oxy-social-icons a {",n+="font-size: "+(e.original["icon-size"]||c["icon-size"])+"px; ",n+="margin-right: "+(e.original["icon-space-between-icons"]||c["icon-space-between-icons"])+"px;",n+="margin-bottom: "+(e.original["icon-space-between-icons"]||c["icon-space-between-icons"])+"px;","circle"==E?n+="border-radius: 50%;":"square"==E&&(n+="border-radius: 0%;"),"blank"!=E&&(n+="background-color: "+(to.getGlobalColorValue(e.original["icon-background-color"])||c["icon-background-color"])+";"),n+="}",n+="#"+e.selector+".oxy-social-icons a:hover {","blank"!=E&&(n+="background-color: "+(to.getGlobalColorValue(e.original["icon-background-hover-color"])||c["icon-background-hover-color"])+";"),n+="}","yes"==X)for(var Y in to.socialIcons.networks)if(to.socialIcons.networks.hasOwnProperty(Y)){var K=to.socialIcons.networks[Y],H=to.socialIcons.networkColors[K],U=to.socialIcons.networkHoverColors[K];"blank"!=E?(n+="#"+e.selector+".oxy-social-icons a.oxy-social-icons-"+K+" {",n+="background-color: "+H+";",n+="}",n+="#"+e.selector+".oxy-social-icons a.oxy-social-icons-"+K+":hover {",n+="background-color: "+U+";",n+="}",e.original["icon-color"]="#ffffff",e.original["icon-hover-color"]="#ffffff"):(n+="#"+e.selector+".oxy-social-icons a.oxy-social-icons-"+K+" svg {",n+="color: "+H+";",n+="}",n+="#"+e.selector+".oxy-social-icons a.oxy-social-icons-"+K+":hover svg {",n+="color: "+U+";",n+="}")}n+="#"+e.selector+".oxy-social-icons a svg {",n+="blank"!=E?"width: 0.5em; height: 0.5em;":"width: 1em; height: 1em;",n+="color: "+(to.getGlobalColorValue(e.original["icon-color"])||c["icon-color"])+"; ",n+="}",n+="#"+e.selector+".oxy-social-icons a:hover svg {",n+="color: "+(to.getGlobalColorValue(e.original["icon-hover-color"])||c["icon-hover-color"])+"; ",n+="}"}if("oxy_testimonial"==e.name){var L,$,Z,Q,q,R="",J=x.testimonial_image_spacing;if("vertical"==x.testimonial_layout?(R="margin:0;",J=x.testimonial_image_spacing||c.testimonial_image_spacing+c["testimonial_image_spacing-unit"],"bottom"==x.testimonial_image_position?R+="margin-top":R+="margin-bottom"):"bottom"==x.testimonial_image_position?(R="margin:0;",J=x.testimonial_image_spacing||c.testimonial_image_spacing+c["testimonial_image_spacing-unit"],R+="margin-left"):R+="margin-right",R+=": "+J+";","left"==x.testimonial_content_alignment?(L="flex-start",$="left"):"center"==x.testimonial_content_alignment?$=L="center":"right"==x.testimonial_content_alignment&&(L="flex-end",$="right"),"left"==e.original.testimonial_mobile_content_alignment?(Z="flex-start",Q="left"):"center"==e.original.testimonial_mobile_content_alignment?Q=Z="center":"right"==e.original.testimonial_mobile_content_alignment&&(Z="flex-end",Q="right"),"vertical"==x.testimonial_layout?n+="#"+e.selector+" {flex-direction: column;}":"horizontal"==x.testimonial_layout&&(n+="#"+e.selector+" {flex-direction: row;align-items: center;}"),"top"==x.testimonial_image_position?n+="#"+e.selector+" .oxy-testimonial-photo-wrap {order: 1;}":"bottom"==x.testimonial_image_position&&(n+="#"+e.selector+" .oxy-testimonial-photo-wrap {order: 3;}"),n+="#"+e.selector+" .oxy-testimonial-photo {width:"+x.testimonial_image_size+";height:"+x.testimonial_image_size+";"+R+"}",n+="#"+e.selector+" .oxy-testimonial-photo-wrap,#"+e.selector+" .oxy-testimonial-author-wrap,#"+e.selector+" .oxy-testimonial-content-wrap {align-items:"+L+";text-align:"+$+";}",n+="#"+e.selector+" .oxy-testimonial-text {margin-bottom:"+x.testimonial_text_space_below+";"+to.generateTypographyCSS(x,"testimonial_text_typography")+"}",n+="#"+e.selector+" .oxy-testimonial-author {margin-bottom:"+x.testimonial_author_space_below+";"+to.generateTypographyCSS(x,"testimonial_author_typography")+"}",n+="#"+e.selector+" .oxy-testimonial-author-info {margin-bottom:"+x.testimonial_author_info_space_below+";"+to.generateTypographyCSS(x,"testimonial_author_info_typography")+"}",maxSize=to.getMediaMaxSize(e.original.testimonial_vertical_layout_below),maxSize)q="bottom"==x.testimonial_image_position?"top":"bottom",n+="@media (max-width: "+maxSize+"){#"+e.selector+" {flex-direction: column !important;}#"+e.selector+" .oxy-testimonial-photo {margin: 0;margin-"+q+":"+x.testimonial_image_spacing+";}#"+e.selector+" .oxy-testimonial-photo-wrap, #"+e.selector+" .oxy-testimonial-author-wrap, #"+e.selector+" .oxy-testimonial-content-wrap {align-items:"+Z+";text-align:"+Q+";}}"}if("oxy_icon_box"==e.name){var ee,oe,te,re,ae;if("top"==x.icon_box_icon_position?ee="column":"left"==x.icon_box_icon_position?ee="row":"right"==x.icon_box_icon_position?ee="row-reverse":"bottom"==x.icon_box_icon_position&&(ee="column-reverse"),"left"==x.icon_box_icon_position||"right"==x.icon_box_icon_position){var ie=x.icon_box_icon_space_before||c.icon_box_icon_space_before+c["icon_box_icon_space_before-unit"];right=x.icon_box_icon_space_after||c.icon_box_icon_space_after+c["icon_box_icon_space_after-unit"],te="margin-left: "+ie+";\n",te+="margin-right: "+right+";\n",te+="margin-bottom: 0; margin-top: 0;"}else te="margin-top: "+x.icon_box_icon_space_before+";\n",te+="margin-bottom: "+x.icon_box_icon_space_after+";\n";"left"==x.icon_box_icon_position||"right"==x.icon_box_icon_position?oe=x.icon_box_icon_vertical_alignment:"left"==x.icon_box_content_alignment?oe="flex-start":"center"==x.icon_box_content_alignment?oe="center":"right"==x.icon_box_content_alignment&&(oe="flex-end"),ae="left"==x.icon_box_mobile_content_alignment?(re="flex-start","left"):"center"==x.icon_box_mobile_content_alignment?re="center":"right"==x.icon_box_mobile_content_alignment?(re="flex-end","right"):(re="flex-start","left"),n+="#"+e.selector+" {text-align: "+x.icon_box_content_alignment+";flex-direction: "+ee+";}",n+="#"+e.selector+" .oxy-icon-box-icon {"+te+"align-self: "+oe+";}",n+="#"+e.selector+" .oxy-icon-box-heading {"+to.generateTypographyCSS(x,"icon_box_heading_typography")+"margin-top: "+x.icon_box_heading_space_above+";margin-bottom: "+x.icon_box_heading_space_below+";}",n+="#"+e.selector+" .oxy-icon-box-text {"+to.generateTypographyCSS(x,"icon_box_text_typography")+"margin-top: "+x.icon_box_text_space_above+";margin-bottom: "+x.icon_box_text_space_below+";align-self: "+oe+";}",n+="#"+e.selector+" .oxy-icon-box-link {margin-top: "+x.icon_box_link_space_above+";margin-bottom: "+x.icon_box_link_space_below+";}",maxSize=to.getMediaMaxSize(x.icon_box_vertical_layout_below),maxSize&&!t&&(n+="@media (max-width: "+maxSize+"){#"+e.selector+".oxy-icon-box {flex-direction: column !important;text-align: "+ae+";}#"+e.selector+" .oxy-icon-box-icon {margin-left: 0;margin-right: 0;margin-top: "+x.icon_box_icon_space_before+";margin-bottom: "+x.icon_box_icon_space_after+";}#"+e.selector+" .oxy-icon-box-icon, .oxy-icon-box-text {align-self: "+re+";}}")}if("oxy_pricing_box"==e.name)"vertical"==x.pricing_box_price_layout?(_="column","left"==x.pricing_box_price_alignment?g="flex-start":"center"==x.pricing_box_price_alignment?g="center":"right"==x.pricing_box_price_alignment&&(g="flex-end")):"horizontal"==x.pricing_box_price_layout&&(_="row"),"horizontal"==x.pricing_box_price_layout&&("left"==x.pricing_box_price_alignment?m="flex-start":"center"==x.pricing_box_price_alignment?m="center":"right"==x.pricing_box_price_alignment&&(m="flex-end")),"left"==x.pricing_box_global_alignment?y="flex-start":"center"==x.pricing_box_global_alignment?y="center":"right"==x.pricing_box_global_alignment&&(y="flex-end"),"left"==x.pricing_box_graphic_alignment?u="flex-start":"center"==x.pricing_box_graphic_alignment?u="center":"right"==x.pricing_box_graphic_alignment?u="flex-end":y&&(iamge_justify_content=y),"left"==x.pricing_box_cta_alignment?b="flex-start":"center"==x.pricing_box_cta_alignment?b="center":"right"==x.pricing_box_cta_alignment?b="flex-end":y&&(b=y),n+="#"+e.selector+" .oxy-pricing-box-section {"+to.generateArrayOptionsCSS(x,"pricing_box_global")+"text-align:"+x.pricing_box_global_alignment+";}",n+="#"+e.selector+" .oxy-pricing-box-section.oxy-pricing-box-price {justify-content:"+y+";}",n+="#"+e.selector+" .oxy-pricing-box-section.oxy-pricing-box-graphic {"+to.generateArrayOptionsCSS(x,"pricing_box_graphic")+"background-color:"+to.getGlobalColorValue(x.pricing_box_graphic_background)+";text-align:"+x.pricing_box_graphic_alignment+";justify-content:"+u+";}",n+="#"+e.selector+" .oxy-pricing-box-section.oxy-pricing-box-title {"+to.generateArrayOptionsCSS(x,"pricing_box_title")+"text-align:"+x.pricing_box_title_alignment+";background-color:"+to.getGlobalColorValue(x.pricing_box_title_background)+";}",n+="#"+e.selector+" .oxy-pricing-box-title-title {"+to.generateTypographyCSS(x,"pricing_box_title_typography")+"}",n+="#"+e.selector+" .oxy-pricing-box-title-subtitle {"+to.generateTypographyCSS(x,"pricing_box_subtitle_typography")+"}",n+="#"+e.selector+" .oxy-pricing-box-section.oxy-pricing-box-price {"+to.generateArrayOptionsCSS(x,"pricing_box_price")+"text-align:"+x.pricing_box_price_alignment+";background-color:"+to.getGlobalColorValue(x.pricing_box_price_background)+";flex-direction:"+_+";justify-content:"+m+";align-items:"+g+";}",n+="#"+e.selector+" .oxy-pricing-box-currency {"+to.generateTypographyCSS(x,"pricing_box_price_amount_currency_typography")+"}",n+="#"+e.selector+" .oxy-pricing-box-amount-main {"+to.generateTypographyCSS(x,"pricing_box_price_amount_main_typography")+"}",n+="#"+e.selector+" .oxy-pricing-box-amount-decimal {"+to.generateTypographyCSS(x,"pricing_box_price_amount_decimal_typography")+"}",n+="#"+e.selector+" .oxy-pricing-box-term {"+to.generateTypographyCSS(x,"pricing_box_price_amount_term_typography")+"}",n+="#"+e.selector+" .oxy-pricing-box-sale-price {"+to.generateTypographyCSS(x,"pricing_box_price_sale_typography")+"margin-bottom:"+x.pricing_box_price_sale_space_below+";}",n+="#"+e.selector+" .oxy-pricing-box-section.oxy-pricing-box-content {"+to.generateArrayOptionsCSS(x,"pricing_box_content")+"background-color:"+to.getGlobalColorValue(x.pricing_box_content_background)+";text-align:"+x.pricing_box_content_alignment+";"+to.generateTypographyCSS(x,"pricing_box_content_typography")+"}",n+="#"+e.selector+" .oxy-pricing-box-section.oxy-pricing-box-cta {"+to.generateArrayOptionsCSS(x,"pricing_box_cta")+"background-color:"+to.getGlobalColorValue(x.pricing_box_cta_background)+";text-align:"+x.pricing_box_cta_alignment+";justify-content:"+b+";}";if("oxy_progress_bar"==e.name){var ne="",le=[];if("true"==x.progress_bar_stripes&&(ne="background-image: linear-gradient(-45deg,rgba(255,255,255,.12) 25%,transparent 25%,transparent 50%,rgba(255,255,255,.12) 50%,rgba(255,255,255,.12) 75%,transparent 75%,transparent);"),"false"==x.progress_bar_stripes&&(ne="background-image:none;"),"true"==x.progress_bar_animation_stripes){var se=x.progress_bar_animation_stripes_duration||c.progress_bar_animation_stripes_duration;le.stripes="oxy_progress_bar_stripes "+se+" linear infinite"}if("false"==x.progress_bar_animation_stripes&&(le.stripes="none 0s paused"),"true"==x.progress_bar_animate_width){var ce=x.progress_bar_animation_width_duration||c.progress_bar_animation_width_duration;le.width="oxy_progress_bar_width "+ce+" ease-out 1"}"false"==x.progress_bar_animate_width&&(le.width="none 0s paused");var pe=[];for(var Y in le)pe.push(le[Y]);n+="#"+e.selector+s+" .oxy-progress-bar-background {background-color:"+to.getGlobalColorValue(x.progress_bar_background_color)+";"+ne,le.stripes&&(n+="animation:"+le.stripes+";"),n+="}",n+="#"+e.selector+s+" .oxy-progress-bar-progress-wrap {width:"+x.progress_bar_progress+";}",n+="#"+e.selector+s+" .oxy-progress-bar-progress {background-color:"+to.getGlobalColorValue(x.progress_bar_bar_color)+";padding:"+x.progress_bar_bar_padding+";"+ne+"animation:"+pe.join()+";}",n+="#"+e.selector+s+" .oxy-progress-bar-overlay-text {"+to.generateTypographyCSS(x,"progress_bar_left_text_typography")+"}",n+="#"+e.selector+s+" .oxy-progress-bar-overlay-percent {"+to.generateTypographyCSS(x,"progress_bar_right_text_typography")+"}"}if("oxy_toggle"==e.name&&(n+="#"+e.selector+s+" .oxy-expand-collapse-icon {font-size:"+x.toggle_icon_size+";}",n+="#"+e.selector+s+" .oxy-expand-collapse-icon::before,#"+e.selector+s+" .oxy-expand-collapse-icon::after {background-color:"+to.getGlobalColorValue(x.toggle_icon_color)+";}"),"oxy_superbox"==e.name){var de,ge,_e,me,ye,ue=x.superbox_secondary_scale_start,be=x.superbox_secondary_scale_finish,he=x.superbox_primary_scale_start,xe=x.superbox_primary_scale_finish,Se="",fe="",ve="",Ce="",ke=":hover";"as_hovered"==e.original.superbox_editing_mode&&(ke=""),void 0!==ue&&(ge="transform: scale("+ue+");"),void 0!==be&&(_e="transform: scale("+be+");"),void 0!==he&&(me="transform: scale("+he+");"),void 0!==xe&&(ye="transform: scale("+xe+");"),x.superbox_secondary_slide_direction&&(de=to.slide_position(x.superbox_secondary_slide_direction,(x.superbox_secondary_slide_distance||"")+"px"),"in"==x.superbox_secondary_slide_inorout?(Se=de.out_css,fe=de.in_css):"out"==x.superbox_secondary_slide_inorout&&(Se=de.in_css,fe=de.out_css)),x.superbox_primary_slide_direction&&(de=to.slide_position(x.superbox_primary_slide_direction,(x.superbox_primary_slide_distance||"")+"px"),"in"==x.superbox_primary_slide_inorout?(ve=de.out_css,Ce=de.in_css):"out"==x.superbox_primary_slide_inorout&&(ve=de.in_css,Ce=de.out_css));var we=x.superbox_transition_duration;n+="#"+e.selector+" .oxy-superbox-secondary, #"+e.selector+" .oxy-superbox-primary {transition-duration:"+we+";}",n+="#"+e.selector+" .oxy-superbox-secondary {opacity:"+x.superbox_secondary_opacity_start+";"+Se+ge+"}","as_not_hovered"!==e.original.superbox_editing_mode&&(n+="#"+e.selector+ke+" .oxy-superbox-secondary {opacity:"+x.superbox_secondary_opacity_finish+";z-index: 2147483642;"+fe+_e+"}"),n+="#"+e.selector+" .oxy-superbox-primary {opacity:"+x.superbox_primary_opacity_start+";"+ve+me+"}","as_not_hovered"!==e.original.superbox_editing_mode&&(n+="#"+e.selector+ke+" .oxy-superbox-primary {opacity:"+x.superbox_primary_opacity_finish+";"+Ce+ye+"}")}if("oxy_nav_menu"==e.name){oxyNavMenuStyle="#"+e.selector+" .oxy-nav-menu-list"+s+"{",oxyNavMenuStyleItem="#"+e.selector+" .menu-item"+s+" a {",oxyNavMenuStyleActive="#"+e.selector+" .current-menu-item a"+s+"{",oxyNavMenuStyleDropdowns="#"+e.selector+".oxy-nav-menu:not(.oxy-nav-menu-open) .sub-menu"+s+"{",oxyNavMenuStyleDropdownsItem="#"+e.selector+".oxy-nav-menu:not(.oxy-nav-menu-open) .sub-menu .menu-item a"+s+"{",oxyNavMenuStyleNotOpenItem="#"+e.selector+".oxy-nav-menu:not(.oxy-nav-menu-open) .menu-item a"+s+"{",oxyNavMenuStyleDropdownsItemHover="#"+e.selector+".oxy-nav-menu:not(.oxy-nav-menu-open) .oxy-nav-menu-list .sub-menu .menu-item a:hover{",e.original["menu_dropdowns_background-color"]||(oxyNavMenuStyleDropdowns+="background-color:"+to.getGlobalColorValue(e.original["menu_hover_background-color"])+";"),oxyNavMenuStyleDropdownsItem+="border: 0;","row"==e.original["menu_flex-direction"]?(oxyNavMenuStyleDropdownsItem+="padding-top:"+e.original["menu_padding-top"]+"px;",oxyNavMenuStyleDropdownsItem+="padding-bottom:"+e.original["menu_padding-bottom"]+"px;"):(oxyNavMenuStyleDropdownsItem+="padding-left:"+e.original["menu_padding-top"]+"px;",oxyNavMenuStyleDropdownsItem+="padding-rigth:"+e.original["menu_padding-bottom"]+"px;"),e.original["menu_justify-content"]&&(oxyNavMenuStyleNotOpenItem+="justify-content:"+e.original["menu_justify-content"]+";"),"never"!=e.original.menu_responsive&&("always"!=e.original.menu_responsive&&(n+="@media (max-width: "+to.getMediaMaxSize(e.original.menu_responsive)+") {"),n+="#"+e.selector+" .oxy-nav-menu-list {display: none;}",n+="#"+e.selector+" .oxy-menu-toggle {display: initial;}",n+="#"+e.selector+".oxy-nav-menu.oxy-nav-menu-open .oxy-nav-menu-list {display: initial;}","always"!=e.original.menu_responsive&&(n+="}"));var Pe=parseInt(e.original.menu_responsive_icon_size||40),Oe=parseInt(e.original.menu_responsive_icon_size||40)+2*parseInt(e.original.menu_responsive_padding_size||0),ze=parseInt(.8*Pe),Te=parseInt(.15*Pe),Ge=ze/2-Te/2;t||"id"!=p||(n+="#"+e.selector+".oxy-nav-menu.oxy-nav-menu-open {background-color:"+to.getGlobalColorValue(e.original.menu_responsive_background_color)+";margin-top: 0 !important;margin-right: 0 !important;margin-left: 0 !important;margin-bottom: 0 !important;} #"+e.selector+".oxy-nav-menu.oxy-nav-menu-open .menu-item a {color:"+to.getGlobalColorValue(e.original.menu_responsive_link_color)+";padding-top:"+(e.original.menu_responsive_padding_top||e.original["menu_padding-top"])+"px;padding-right:"+(e.original.menu_responsive_padding_right||e.original["menu_padding-right"])+"px;padding-bottom:"+(e.original.menu_responsive_padding_bottom||e.original["menu_padding-bottom"])+"px;padding-left:"+(e.original.menu_responsive_padding_left||e.original["menu_padding-left"])+"px;} #"+e.selector+".oxy-nav-menu.oxy-nav-menu-open .menu-item a:hover {color:"+to.getGlobalColorValue(e.original.menu_responsive_hover_link_color)+"} #"+e.selector+".oxy-nav-menu .menu-item a:hover {text-decoration:"+e.original["menu_text-decoration"]+"} #"+e.selector+" .oxy-nav-menu-hamburger-wrap {width:"+Oe+"px;height:"+Oe+"px;margin-top:"+e.original.menu_responsive_icon_margin+"px;margin-bottom:"+e.original.menu_responsive_icon_margin+"px;background-color:"+to.getGlobalColorValue(e.original.menu_responsive_padding_color)+";} #"+e.selector+" .oxy-nav-menu-hamburger-wrap:hover {background-color:"+to.getGlobalColorValue(e.original.menu_responsive_padding_hover_color)+";} #"+e.selector+" .oxy-nav-menu-hamburger {width:"+Pe+"px;height:"+ze+"px;} #"+e.selector+" .oxy-nav-menu-hamburger .oxy-nav-menu-hamburger-line {height:"+Te+"px;background-color:"+to.getGlobalColorValue(e.original.menu_responsive_icon_color)+";} #"+e.selector+" .oxy-nav-menu-hamburger-wrap:hover  .oxy-nav-menu-hamburger-line {background-color:"+to.getGlobalColorValue(e.original.menu_responsive_icon_hover_color)+";} #"+e.selector+".oxy-nav-menu-open .oxy-nav-menu-hamburger .oxy-nav-menu-hamburger-line:first-child {top:"+Ge+"px;} #"+e.selector+".oxy-nav-menu-open .oxy-nav-menu-hamburger .oxy-nav-menu-hamburger-line:last-child {top:-"+Ge+"px;}",n+="#"+e.selector+" .menu-item > .sub-menu {transition-duration:"+e.original["menu_transition-duration"]+"s; }")}if("oxy_nav_menu"==e.name&&e.original.menu_color&&(n+="#"+e.selector+" .oxy-nav-menu-hamburger-line{",n+="background-color:"+to.getGlobalColorValue(e.original.menu_color)+";",n+="}"),"oxy_header"!=e.name&&"oxy_header_row"!=e.name||!e.original["background-color"]||(n+="#"+e.selector+" .oxy-nav-menu-open,",n+="#"+e.selector+" .oxy-nav-menu:not(.oxy-nav-menu-open) .sub-menu{",n+="background-color:"+to.getGlobalColorValue(e.original["background-color"])+";",n+="}"),x["box-shadow-color"]){var Ve="inset"==x["box-shadow-inset"]?x["box-shadow-inset"]+" ":"",Me=x["box-shadow-horizontal-offset"]?x["box-shadow-horizontal-offset"]+"px ":"",Ae=x["box-shadow-vertical-offset"]?x["box-shadow-vertical-offset"]+"px ":"",Ie=x["box-shadow-blur"]?x["box-shadow-blur"]+"px ":"0px ",Fe=x["box-shadow-spread"]?x["box-shadow-spread"]+"px ":"";x["box-shadow"]=Ve+Me+Ae+Ie+Fe+to.getGlobalColorValue(x["box-shadow-color"])}if(x["text-shadow-color"]){Me=x["text-shadow-horizontal-offset"]?x["text-shadow-horizontal-offset"]+"px ":"",Ae=x["text-shadow-vertical-offset"]?x["text-shadow-vertical-offset"]+"px ":"",Ie=x["text-shadow-blur"]?x["text-shadow-blur"]+"px ":"0px ";x["text-shadow"]=Me+Ae+Ie+to.getGlobalColorValue(x["text-shadow-color"])}if(n+="#"+e.selector+l+s+"{",to.component.options[o]&&to.component.options[o].selector!==e.selector&&!e.original);else if("object"==typeof x)for(var Ne in n+=to.getBackgroundLayersCSS(x,e.name,"id",o,r,p)||"",n+=to.getTransformCSS(x)||"",x)if(!(0<=Ne.indexOf("hover_"))&&!(0<=Ne.indexOf("responsive"))&&!(0<=Ne.indexOf("slider"))&&!(0<=Ne.indexOf("icon"))&&!(0<=Ne.indexOf("soundcloud"))&&"background-size"!=Ne&&"background"!=Ne&&x.hasOwnProperty(Ne)){var Ee=x[Ne];if("custom-css"==Ne)continue;if("ct_fancy_icon"==e.name&&("background"==Ne||"icon-background-color"==Ne||"icon-color"==Ne||"padding"==Ne||"icon-size"==Ne))continue;if(0<=["display","flex-direction","flex-wrap","align-items","align-content","justify-content"].indexOf(Ne)&&"ct_section"==e.name)continue;if(("font-family"==Ne||-1<Ne.indexOf("font-family"))&&(to.loadWebFont(Ee),-1===Ee.indexOf(",")&&"inherit"!==Ee.toLowerCase()&&(Ee="'"+Ee+"'")),Ee=to.getGlobalColorValue(Ee),"content"==Ne.trim().toLowerCase()&&(Ee='"'+Ee.replace('"','\\"')+'"',to.contentAdded["#"+e.selector+l+s]=!0),"flex-direction"==Ne){n+=Ne+":"+Ee+(f="reverse"==x["flex-reverse"]?"-reverse":"")+";";continue}if("filter"==Ne&&x["filter-amount-"+Ee])Ee+="("+x["filter-amount-"+Ee]+")";else if("filter"==Ne)continue;if("oxy_nav_menu"==e.name&&0===Ne.indexOf("menu_dropdowns_"))"menu_dropdowns_background-color"==Ne&&"hover"!==p?oxyNavMenuStyleDropdowns+=Ne.replace("menu_dropdowns_","")+":"+Ee+";":Ee&&to.excludeProperties.indexOf(Ne)<0&&Ne&&(oxyNavMenuStyleDropdownsItem+=Ne.replace("menu_dropdowns_","")+":"+Ee+";"),0==Ne.indexOf("menu_dropdowns_padding")&&(oxyNavMenuStyleDropdownsItemHover+=Ne.replace("menu_dropdowns_","")+":"+Ee+";");else if("oxy_nav_menu"==e.name&&0===Ne.indexOf("menu_active_")){if("menu_active_border-bottom-width"==Ne&&void 0!==e.original["menu_padding-bottom"])Be=0<(Be=parseInt(e.original["menu_padding-bottom"])-parseInt(x["menu_active_border-bottom-width"]))?Be:0,oxyNavMenuStyleActive+="padding-bottom:"+Be+"px;";if("menu_active_border-top-width"==Ne&&void 0!==e.original["menu_padding-top"])Be=0<(Be=parseInt(e.original["menu_padding-top"])-parseInt(x["menu_active_border-top-width"]))?Be:0,oxyNavMenuStyleActive+="padding-top:"+Be+"px;";Ee&&to.excludeProperties.indexOf(Ne)<0&&Ne&&(oxyNavMenuStyleActive+=Ne.replace("menu_active_","")+":"+Ee+";")}else if("oxy_nav_menu"==e.name&&0===Ne.indexOf("menu_")){if("menu_flex-direction"==Ne){oxyNavMenuStyle+="flex-direction:"+Ee;continue}if("menu_justify-content"==Ne||"menu_dropdown_arrow"==Ne)continue;if("menu_border-bottom-width"==Ne&&"hover"==p&&void 0!==e.original["menu_padding-bottom"]){if(Be=0<(Be=parseInt(e.original["menu_padding-bottom"])-parseInt(x["menu_border-bottom-width"]))?Be:0,"row"==e.original["menu_flex-direction"])var je="padding-bottom:";else{je="padding-right:";Ne="border-right-width"}oxyNavMenuStyleItem+=je+Be+"px;"}if("menu_border-top-width"==Ne&&"hover"==p&&void 0!==e.original["menu_padding-top"]){var Be;if(Be=0<(Be=parseInt(e.original["menu_padding-top"])-parseInt(x["menu_border-top-width"]))?Be:0,"row"==e.original["menu_flex-direction"])je="padding-top:";else{je="padding-left:";Ne="border-left-width"}oxyNavMenuStyleItem+=je+Be+"px;"}"menu_-webkit-font-smoothing"==Ne&&(oxyNavMenuStyleItem+="-moz-osx-font-smoothing:"+("antialiased"===Ee?"grayscale":"unset")+";"),"menu_transition-duration"==Ne&&(Ee+="s"),Ee&&to.excludeProperties.indexOf(Ne)<0&&Ne&&(oxyNavMenuStyleItem+=Ne.replace("menu_","")+":"+Ee+";")}else{if("background-image"==Ne)continue;Ee&&to.excludeProperties.indexOf(Ne)<0&&"background-layers"!==Ne&&(void 0===to.notCSSOptions[e.name]||to.notCSSOptions[e.name].indexOf(Ne)<0)&&(n+=Ne+":"+Ee+";"),"-webkit-font-smoothing"==Ne&&(n+="-moz-osx-font-smoothing:"+("antialiased"===Ee?"grayscale":"unset")+";")}}"before"!=p&&"after"!=p||to.contentAdded["#"+e.selector+l+s]||(n+='content:"";',to.contentAdded["#"+e.selector+l+s]=!0),x["custom-css"]&&(n+=to.replaceGlobalColors(x["custom-css"])),n+="}","oxy_nav_menu"==e.name&&(n+=oxyNavMenuStyle+"}"+oxyNavMenuStyleItem+"}"+oxyNavMenuStyleActive+"}"+oxyNavMenuStyleDropdowns+"}"+oxyNavMenuStyleNotOpenItem+"}"+oxyNavMenuStyleDropdownsItem+"}"+oxyNavMenuStyleDropdownsItemHover+"}")}if(void 0!==to.componentsTemplates&&to.componentsTemplates[e.name]&&to.componentsTemplates[e.name].pageCSS&&!0!==to.globalWooSettingsAdded[e.name]){var De=to.componentsTemplates[e.name].pageCSS;De=to.replaceGlobalWooSettings(De),to.globalWooSettingsAdded[e.name]=!0,n+=De}if(void 0!==to.componentsTemplates&&to.componentsTemplates[e.name]&&to.componentsTemplates[e.name].registeredSelectors){var We=to.componentsTemplates[e.name].registeredSelectors,Xe=angular.copy(to.componentsTemplates[e.name].complexProperties),Ye="";for(var Y in We)if(We.hasOwnProperty(Y)){var Ke=We[Y],He="";if(Ke){for(var Ue in Ke)if(Ke.hasOwnProperty(Ue)){if(!x)continue;if("typography"==Ue)He+=to.generateTypographyCSS(x,Ke[Ue]);else if("box-shadow"==Ue)He+=to.generateBoxShadowCSS(x,Ke[Ue]);else if(-1<Ue.indexOf(">")){var Le=Ue.split(">");if(Xe&&Xe[Le[0]]){Ee=Xe[Le[0]];Xe[Le[0]]=Ee.replace("{"+Le[1]+"}",x[Ke[Ue]])}}else if(x[Ke[Ue]]){Ee=to.addFontFamilyQuotes(Ue,x[Ke[Ue]]);He+=Ue+":"+to.getGlobalColorValue(Ee)+";"}else for(var $e in x)if(x.hasOwnProperty($e)&&-1<$e.indexOf(Ke[Ue])){var Ze;Ze=$e.replace(Ke[Ue]+"_","");Ee=to.addFontFamilyQuotes(Ze,x[$e]);He+=Ze+":"+to.getGlobalColorValue(Ee)+";"}}for(var Ue in Xe)if(Xe.hasOwnProperty(Ue)){if(-1<Xe[Ue].indexOf("{"))continue;He+=Ue+":"+to.getGlobalColorValue(Xe[Ue])+";"}}He&&(He=Y+"{"+He+"}",Ye+=to.prefixCSSSelectors(He,e.selector))}n+=Ye}if(x&&void 0!==to.componentsTemplates&&to.componentsTemplates[e.name]){var Qe=to.componentsTemplates[e.name].valuesCSS;for(var $e in Qe)if(Qe.hasOwnProperty($e)&&Qe[$e][x[$e]]){var qe=Qe[$e][x[$e]];n+=to.prefixCSSSelectors(qe,e.selector)}}}if(n+=to.getMappedCSS(e.selector,e.original),e.media){var Re=angular.copy(e.media),Je=to.sortedMediaList();for(var eo in Je){var oo=Je[eo];Re[oo]&&(Re[oo].name=e.name,Re[oo].selector=e.selector,n+="@media (max-width: "+to.mediaList[oo].maxSize+") {",n+=to.getSingleComponentCSS(Re[oo],o,!0,oo),n+="}")}}return to.functionEnd("getSingleComponentCSS()"),n},to.prefixCSSSelectors=function(e,o){if(void 0===e||void 0===o)return e;var t=e.split("}");for(var r in t)if(t.hasOwnProperty(r)){var a=t[r],i=a.split("{");if(3==a.split("{").length){var n=i[0]+"{";i[0]=i[1];var l=!0}var s=i[0].split(",");for(var c in s)s[c]="#"+o+" "+s[c];3==a.split("{").length?t[r]=n+"\n"+s.join(", ")+"{"+i[2]:a[0]&&0!==a[0].length||!l?i[1]&&(t[r]=s.join(", ")+"{"+i[1]):(l=!1,t[r]=s.join(", ")+"{"+i[2]+"}\n")}return e=t.join("}\n")},to.getTransformCSS=function(e){if(e.transform){var o=to.objectToArrayObject(e.transform),t="";for(var r in o)if(o.hasOwnProperty(r)){var a=o[r];"skew"==a["transform-type"]&&(a.skewX&&a.skewY?t+=a["transform-type"]+"("+a.skewX+"deg,"+a.skewY+"deg)":a.skewX&&(t+=a["transform-type"]+"("+a.skewX+"deg)")),"translate"==a["transform-type"]&&(a.translateX&&a.translateY&&a.translateZ?t+="translate3d("+a.translateX+(a["translateX-unit"]||to.defaultOptions.all["translateX-unit"])+","+a.translateY+(a["translateY-unit"]||to.defaultOptions.all["translateY-unit"])+","+a.translateZ+(a["translateZ-unit"]||to.defaultOptions.all["translateZ-unit"])+")":a.translateX&&a.translateY?t+=a["transform-type"]+"("+a.translateX+(a["translateX-unit"]||to.defaultOptions.all["translateX-unit"])+","+a.translateY+(a["translateY-unit"]||to.defaultOptions.all["translateY-unit"])+")":a.translateX?t+=a["transform-type"]+"("+a.translateX+(a["translateX-unit"]||to.defaultOptions.all["translateX-unit"])+")":a.translateY&&(t+="translateY("+a.translateY+(a["translateY-unit"]||to.defaultOptions.all["translateY-unit"])+")")),"rotate"==a["transform-type"]&&a.rotateAngle&&(t+=a["transform-type"]+"("+a.rotateAngle+"deg)"),"rotateX"==a["transform-type"]&&a.rotateXAngle&&(t+=a["transform-type"]+"("+a.rotateXAngle+"deg)"),"rotateY"==a["transform-type"]&&a.rotateYAngle&&(t+=a["transform-type"]+"("+a.rotateYAngle+"deg)"),"perspective"==a["transform-type"]&&a.perspective&&(t+=a["transform-type"]+"("+a.perspective+(a["perspective-unit"]||to.defaultOptions.all["perspective-unit"])+")"),"rotate3d"==a["transform-type"]&&a.rotate3dX&&a.rotate3dY&&a.rotate3dZ&&a.rotate3dAngle&&(t+=a["transform-type"]+"("+a.rotate3dX+","+a.rotate3dY+","+a.rotate3dZ+","+a.rotate3dAngle+"deg)"),"scale"==a["transform-type"]&&(a.scaleX&&a.scaleY&&a.scaleZ?t+="scale3d("+a.scaleX+","+a.scaleY+","+a.scaleZ+")":a.scaleX&&a.scaleY?t+=a["transform-type"]+"("+a.scaleX+","+a.scaleY+")":(a.scaleX&&(t+=" scaleX("+a.scaleX+")"),a.scaleY&&(t+=" scaleY("+a.scaleY+")"),a.scaleZ&&(t+=" scaleZ("+a.scaleZ+")"))),r<o.length-1?t+=" ":t+=";"}return""!==t&&(t="transform:"+t),t}},to.getBackgroundLayersCSS=function(e,o,t,r,a,i){to.getGlobalColorValue(e["background-color"]);var n=[],l=[],s=[];e.gradient&&e.gradient.colors&&(s=e.gradient.colors);var c="";if(s=_.map(s,function(e){return e}),s=_.filter(s,function(e){return e.value}),0<(s=_.map(s,function(e){return e.value=to.getGlobalColorValue(e.value),e})).length){if("radial"===e.gradient["gradient-type"]){c+=" radial-gradient(";var p="";e.gradient["radial-shape"]&&(p+=" "+e.gradient["radial-shape"]),e.gradient["radial-size"]&&(p+=" "+e.gradient["radial-size"]),e.gradient["radial-position-left"]&&(p+=" at "+e.gradient["radial-position-left"]+(e.gradient["radial-position-left-unit"]||"px"),e.gradient["radial-position-top"]&&(p+=" "+e.gradient["radial-position-top"]+(e.gradient["radial-position-top-unit"]||"px"))),0<p.length&&(c+=p+", ")}else c+=" linear-gradient(",e.gradient["linear-angle"]&&(c+=e.gradient["linear-angle"]+"deg, ");if(s){var d=_.filter(s,function(e){return e.value&&0<e.value.length}),g=_.map(d,function(e){return e.value+(e.position?" "+e.position+e["position-unit"]:"")});1===g.length&&g.push(g[0]),c+=g.join(", ")}0<(c+=")").length&&(n.push(c),l.push("auto"))}if(e["overlay-color"]&&(n.push("linear-gradient("+to.getGlobalColorValue(e["overlay-color"])+", "+to.getGlobalColorValue(e["overlay-color"])+")"),l.push("auto")),e["background-size"]&&0<e["background-size"].trim().length?(c="","manual"===e["background-size"]?(e["background-size-width"]&&0<e["background-size-width"].trim().length?c+=" "+e["background-size-width"].trim()+e["background-size-width-unit"].trim():c+=" 0%",e["background-size-height"]&&0<e["background-size-height"].trim().length?c+=" "+e["background-size-height"].trim()+e["background-size-height-unit"].trim():c+=" 0%"):c+=" "+e["background-size"],0<c.length&&l.push(c)):l=[],e.background&&n.push("url("+e.background+")"),e["background-image"]){var m=e["background-image"];-1<m.indexOf("[")&&to.dynamicBackgrounds&&(m=to.getDynamicBackground(t?"id"===t?"id":"selector":"class",{id:r,media:a,stateName:i})),n.push("url("+m+")")}var y=n.join(", ").trim(),u="";return""!==y&&(u="background-image:"+y+";"),0<l.length&&(u+="background-size:"+l.join(", ")+";"),u},to.generateTypographyCSS=function(e,o){var t="";for(var r in e)if(-1<r.indexOf(o)){var a=r.replace(o+"_",""),i=e[r];"color"==a&&(i=to.getGlobalColorValue(i)),t+=a+":"+to.addFontFamilyQuotes(a,i)+";"}return t},to.addFontFamilyQuotes=function(e,o){return("font-family"==e||-1<e.indexOf("font-family"))&&(to.loadWebFont(o),-1===o.indexOf(",")&&"inherit"!==o.toLowerCase()&&(o="'"+o+"'")),o},to.generateBoxShadowCSS=function(e,o){return null!=o?o+="_":o="",e[o+"box-shadow-color"]?"box-shadow:"+("inset"==e[o+"box-shadow-inset"]?e[o+"box-shadow-inset"]+" ":"")+(e[o+"box-shadow-horizontal-offset"]?e[o+"box-shadow-horizontal-offset"]+" ":"")+(e[o+"box-shadow-vertical-offset"]?e[o+"box-shadow-vertical-offset"]+" ":"")+(e[o+"box-shadow-blur"]?e[o+"box-shadow-blur"]+" ":"0px ")+(e[o+"box-shadow-spread"]?e[o+"box-shadow-spread"]+" ":"")+to.getGlobalColorValue(e[o+"box-shadow-color"])+";":""},to.generateArrayOptionsCSS=function(e,o){var t="";for(var r in e)-1<r.indexOf(o)&&(t+=r.replace(o+"_","")+":"+e[r]+";");return t},to.getSingleClassCSS=function(e,o){to.log&&(console.log("getSingleClassCSS()",e),to.functionStart("getSingleClassCSS()")),void 0===o&&(o=to.classes[e]),to.contentAdded=[];var t=to.getSelectorStyles(e,o);if(to.classes[e].media){var r=to.sortedMediaList(!1,!0);for(var a in r){var i=r[a];if(to.classes[e].media[i]){if("page-width"==i)var n=to.getPageWidth("global")+"px";else n=to.mediaList[i].maxSize;o=to.classes[e].media[i],t+="@media (max-width: "+n+") {",t+=to.getSelectorStyles(e,o,!1,i),t+="}"}}}return to.functionEnd("getSingleClassCSS()"),t},to.getSingleSelectorCSS=function(e,o){to.log&&(console.log("getSingleSelectorCSS()",e),to.functionStart("getSingleSelectorCSS()")),void 0===o&&(o=to.customSelectors[e]),to.contentAdded=[];var t=to.getSelectorStyles(e,o,!0);if(to.customSelectors[e].media){var r=to.sortedMediaList();for(var a in r){var i=r[a];to.customSelectors[e].media[i]&&(o=to.customSelectors[e].media[i],t+="@media (max-width: "+to.mediaList[i].maxSize+") {",t+=to.getSelectorStyles(e,o,!0,i),t+="}")}}return to.functionEnd("getSingleSelectorCSS()"),t},to.getSelectorStyles=function(e,o,t,r){if(""===e||!t&&void 0===to.classes[e]||t&&void 0===to.customSelectors[e])return"";var a,i="";for(var n in o)if(o.hasOwnProperty(n)){var l=o[n];if("media"==n||"set_name"==n||"key"==n||"parent"==n||"status"==n||"friendly_name"==n)continue;a=("original"==n||e==to.selectorToEdit&&n==to.currentState||e==to.currentClass&&n==to.currentState)&&("original"==n||"hover"==n||"active"==n||"focus"==n)?"":":"+n;var s=to.getCSSOptions(null,null,l);if((void 0!==s["icon-style"]||void 0!==s["icon-color"]||void 0!==s["icon-background-color"]||void 0!==s["icon-padding"]||void 0!==s["icon-size"])&&!t){if(r||"original"!=n)c=to.classes[e].original["icon-style"]||to.defaultOptions.ct_fancy_icon["icon-style"],p=to.getGlobalColorValue(s["icon-color"]),d=to.getGlobalColorValue(s["icon-background-color"]),g=s["icon-padding"],_=s["icon-size"];else var c=s["icon-style"]||to.defaultOptions.ct_fancy_icon["icon-style"],p=to.getGlobalColorValue(s["icon-color"])||to.defaultOptions.ct_fancy_icon["icon-color"],d=to.getGlobalColorValue(s["icon-background-color"])||to.defaultOptions.ct_fancy_icon["icon-background-color"],g=s["icon-padding"]||to.defaultOptions.ct_fancy_icon["icon-padding"]+to.defaultOptions.ct_fancy_icon["icon-padding-unit"],_=s["icon-size"]||to.defaultOptions.ct_fancy_icon["icon-size"]+to.defaultOptions.ct_fancy_icon["icon-size-unit"];i+="."+e+a+"{",1==c&&(i+="border: 1px solid;"),2==c&&d&&(i+="background-color: "+to.getGlobalColorValue(d)+";",i+="border: 1px solid "+to.getGlobalColorValue(d)+";"),1!=c&&2!=c||(i+="padding:"+g+";"),p&&(i+="color:"+to.getGlobalColorValue(p)+";"),i+="}",_&&(i+="."+e+a+">svg {",i+="width: "+_+";",i+="height: "+_+";",i+="}")}if((void 0!==s["button-style"]||void 0!==s["button-color"]||void 0!==s["button-size"]||void 0!==s["button-text-color"])&&!t){if(r||"original"!=n)m=to.classes[e].original["button-style"]||to.defaultOptions.ct_link_button["button-style"],y=to.getGlobalColorValue(s["button-color"]),u=s["button-size"],b=to.getGlobalColorValue(s["button-text-color"]);else var m=s["button-style"]||to.defaultOptions.ct_link_button["button-style"],y=to.getGlobalColorValue(s["button-color"])||to.defaultOptions.ct_link_button["button-color"],u=s["button-size"]||to.defaultOptions.ct_link_button["button-size"]+to.defaultOptions.ct_link_button["button-size-unit"],b=to.getGlobalColorValue(s["button-text-color"])||to.defaultOptions.ct_link_button["button-text-color"];if(i+="."+e+a+"{",1==m&&y&&(i+="background-color: "+to.getGlobalColorValue(y)+";",i+="border: 1px solid "+to.getGlobalColorValue(y)+";",b&&(i+="color: "+to.getGlobalColorValue(b)+";")),2==m&&(i+="background-color: transparent;",y&&(i+="border: 1px solid "+to.getGlobalColorValue(y)+";",i+="color: "+to.getGlobalColorValue(y)+";")),u){var h=2==m?1:0;i+="padding: "+(parseInt(u)-h)+"px "+(1.6*parseInt(u)-h)+"px;"}i+="}"}var x=!1;if(to.classes[e])for(paramName in to.classes[e].original)0===paramName.indexOf("testimonial_")&&(x=!0);if(!t&&x){x=!1;var S,f,v,C,k="",w=s.testimonial_image_spacing;if("vertical"==s.testimonial_layout?(k="margin:0;",w=s.testimonial_image_spacing||to.defaultOptions.oxy_testimonial.testimonial_image_spacing+to.defaultOptions.oxy_testimonial["testimonial_image_spacing-unit"],"bottom"==s.testimonial_image_position?k+="margin-top":k+="margin-bottom"):"bottom"==s.testimonial_image_position?(k="margin:0;",w=s.testimonial_image_spacing||to.defaultOptions.oxy_testimonial.testimonial_image_spacing+to.defaultOptions.oxy_testimonial["testimonial_image_spacing-unit"],k+="margin-left"):k+="margin-right",k+=": "+w+";","left"==s.testimonial_content_alignment?(S="flex-start",f="left"):"center"==s.testimonial_content_alignment?f=S="center":"right"==s.testimonial_content_alignment&&(S="flex-end",f="right"),"left"==to.classes[e].original.testimonial_mobile_content_alignment?(v="flex-start",C="left"):"center"==to.classes[e].original.testimonial_mobile_content_alignment?C=v="center":"right"==to.classes[e].original.testimonial_mobile_content_alignment&&(v="flex-end",C="right"),"vertical"==s.testimonial_layout?i+="."+e+a+" {flex-direction: column;}":"horizontal"==s.testimonial_layout&&(i+="."+e+a+" {flex-direction: row;align-items: center;}"),"top"==s.testimonial_image_position||""==s.testimonial_image_position?i+="."+e+a+" .oxy-testimonial-photo-wrap {order: 1;}":"bottom"==s.testimonial_image_position&&(i+="."+e+a+" .oxy-testimonial-photo-wrap {order: 3;}"),i+="."+e+a+" .oxy-testimonial-photo {width:"+s.testimonial_image_size+";height:"+s.testimonial_image_size+";"+k+"}",i+="."+e+a+" .oxy-testimonial-photo-wrap,."+e+a+" .oxy-testimonial-author-wrap,."+e+a+" .oxy-testimonial-content-wrap {align-items:"+S+";text-align:"+f+";}",i+="."+e+a+" .oxy-testimonial-text {margin-bottom:"+s.testimonial_text_space_below+";"+to.generateTypographyCSS(s,"testimonial_text_typography")+"}",i+="."+e+a+" .oxy-testimonial-author {margin-bottom:"+s.testimonial_author_space_below+";"+to.generateTypographyCSS(s,"testimonial_author_typography")+"}",i+="."+e+a+" .oxy-testimonial-author-info {margin-bottom:"+s.testimonial_author_info_space_below+";"+to.generateTypographyCSS(s,"testimonial_author_info_typography")+"}",A=to.getMediaMaxSize(to.classes[e].original.testimonial_vertical_layout_below)){var P=s.testimonial_image_spacing;P||(P=to.defaultOptions.oxy_testimonial.testimonial_image_spacing+to.defaultOptions.oxy_testimonial["testimonial_image_spacing-unit"]),i+="@media (max-width: "+A+"){."+e+a+" {flex-direction: column !important;}."+e+a+" .oxy-testimonial-photo {margin: 0;margin-"+("bottom"==s.testimonial_image_position?"top":"bottom")+":"+P+";}."+e+a+" .oxy-testimonial-photo-wrap, ."+e+a+" .oxy-testimonial-author-wrap, ."+e+a+" .oxy-testimonial-content-wrap {align-items:"+v+";text-align:"+C+";}}"}}var O=!1;if(to.classes[e])for(paramName in to.classes[e].original)0===paramName.indexOf("icon_box_")&&(O=!0);if(!t&&O){var z,T,G,V,M,A;if(O=!1,"top"==s.icon_box_icon_position?z="column":"left"==s.icon_box_icon_position?z="row":"right"==s.icon_box_icon_position?z="row-reverse":"bottom"==s.icon_box_icon_position&&(z="column-reverse"),"left"==s.icon_box_icon_position||"right"==s.icon_box_icon_position){var I=s.icon_box_icon_space_before||to.defaultOptions.oxy_icon_box.icon_box_icon_space_before+to.defaultOptions.oxy_icon_box["icon_box_icon_space_before-unit"];right=s.icon_box_icon_space_after||to.defaultOptions.oxy_icon_box.icon_box_icon_space_after+to.defaultOptions.oxy_icon_box["icon_box_icon_space_after-unit"],G="margin-left: "+I+";\n",G+="margin-right: "+right+";\n",G+="margin-bottom: 0; margin-top: 0;"}else G="margin-top: "+s.icon_box_icon_space_before+";\n",G+="margin-bottom: "+s.icon_box_icon_space_after+";\n";"left"==s.icon_box_icon_position||"right"==s.icon_box_icon_position?T=s.icon_box_icon_vertical_alignment:"left"==s.icon_box_content_alignment?T="flex-start":"center"==s.icon_box_content_alignment?T="center":"right"==s.icon_box_content_alignment&&(T="flex-end"),M="left"==s.icon_box_mobile_content_alignment?(V="flex-start","left"):"center"==s.icon_box_mobile_content_alignment?V="center":"right"==s.icon_box_mobile_content_alignment?(V="flex-end","right"):(V="flex-start","left"),i+="."+e+a+" {text-align: "+s.icon_box_content_alignment+";flex-direction: "+z+";}",i+="."+e+a+" .oxy-icon-box-icon {"+G+"align-self: "+T+";}",i+="."+e+a+" .oxy-icon-box-heading {"+to.generateTypographyCSS(s,"icon_box_heading_typography")+"margin-top: "+s.icon_box_heading_space_above+";margin-bottom: "+s.icon_box_heading_space_below+";}",i+="."+e+a+" .oxy-icon-box-text {"+to.generateTypographyCSS(s,"icon_box_text_typography")+"margin-top: "+s.icon_box_text_space_above+";margin-bottom: "+s.icon_box_text_space_below+";align-self: "+T+";}",i+="."+e+a+" .oxy-icon-box-link {margin-top: "+s.icon_box_link_space_above+";margin-bottom: "+s.icon_box_link_space_below+";}",(A=to.getMediaMaxSize(to.classes[e].original.icon_box_vertical_layout_below))&&!r&&(i+="@media (max-width: "+A+"){."+e+a+".oxy-icon-box {flex-direction: column !important;text-align: "+M+";}."+e+a+" .oxy-icon-box-icon {margin-left: 0;margin-right: 0;margin-top: "+s.icon_box_icon_space_before+";margin-bottom: "+s.icon_box_icon_space_after+";}."+e+a+" .oxy-icon-box-icon, .oxy-icon-box-text {align-self: "+V+";}}")}var F=!1;if(to.classes[e])for(paramName in to.classes[e].original)0===paramName.indexOf("progress_bar_")&&(F=!0);if(!t&&F){F=!1;var N="",E=[];if("true"==s.progress_bar_stripes&&(N="background-image: linear-gradient(-45deg,rgba(255,255,255,.12) 25%,transparent 25%,transparent 50%,rgba(255,255,255,.12) 50%,rgba(255,255,255,.12) 75%,transparent 75%,transparent);"),"false"==s.progress_bar_stripes&&(N="background-image:none;"),"true"==s.progress_bar_animation_stripes){var j=s.progress_bar_animation_stripes_duration||to.defaultOptions.oxy_progress_bar.progress_bar_animation_stripes_duration;E.stripes="oxy_progress_bar_stripes "+j+" linear infinite"}if("false"==s.progress_bar_animation_stripes&&(E.stripes="none 0s paused"),"true"==s.progress_bar_animate_width){var B=s.progress_bar_animation_width_duration||to.defaultOptions.oxy_progress_bar.progress_bar_animation_width_duration;E.width="oxy_progress_bar_width "+B+" ease-out 1"}"false"==s.progress_bar_animate_width&&(E.width="none 0s paused");var D=[];for(var W in E)D.push(E[W]);i+="."+e+a+" .oxy-progress-bar-background {background-color:"+to.getGlobalColorValue(s.progress_bar_background_color)+";"+N+"animation:"+E.stripes+";}",i+="."+e+a+" .oxy-progress-bar-progress-wrap {width:"+s.progress_bar_progress+";}",i+="."+e+a+" .oxy-progress-bar-progress {background-color:"+to.getGlobalColorValue(s.progress_bar_bar_color)+";padding:"+s.progress_bar_bar_padding+";"+N+"animation:"+D.join()+";}",i+="."+e+a+" .oxy-progress-bar-overlay-text {"+to.generateTypographyCSS(s,"progress_bar_left_text_typography")+"}",i+="."+e+a+" .oxy-progress-bar-overlay-percent {"+to.generateTypographyCSS(s,"progress_bar_right_text_typography")+"}"}var X,Y,K,H,U,L,$=!1;if(to.classes[e])for(paramName in to.classes[e].original)0===paramName.indexOf("pricing_box_")&&($=!0);if(!t&&$)$=!1,"vertical"==s.pricing_box_price_layout?(Y="column","left"==s.pricing_box_price_alignment?X="flex-start":"center"==s.pricing_box_price_alignment?X="center":"right"==s.pricing_box_price_alignment&&(X="flex-end")):"horizontal"==s.pricing_box_price_layout&&(Y="row"),"horizontal"==s.pricing_box_price_layout&&("left"==s.pricing_box_price_alignment?K="flex-start":"center"==s.pricing_box_price_alignment?K="center":"right"==s.pricing_box_price_alignment&&(K="flex-end")),"left"==s.pricing_box_global_alignment?H="flex-start":"center"==s.pricing_box_global_alignment?H="center":"right"==s.pricing_box_global_alignment&&(H="flex-end"),"left"==s.pricing_box_graphic_alignment?U="flex-start":"center"==s.pricing_box_graphic_alignment?U="center":"right"==s.pricing_box_graphic_alignment?U="flex-end":H&&(U=H),"left"==s.pricing_box_cta_alignment?L="flex-start":"center"==s.pricing_box_cta_alignment?L="center":"right"==s.pricing_box_cta_alignment?L="flex-end":H&&(L=H),i+="."+e+a+" .oxy-pricing-box-section {"+to.generateArrayOptionsCSS(s,"pricing_box_global")+"text-align:"+s.pricing_box_global_alignment+";}",i+="."+e+a+" .oxy-pricing-box-section.oxy-pricing-box-price {justify-content:"+H+";}",i+="."+e+a+" .oxy-pricing-box-section.oxy-pricing-box-graphic {"+to.generateArrayOptionsCSS(s,"pricing_box_graphic")+"background-color:"+to.getGlobalColorValue(s.pricing_box_graphic_background)+";text-align:"+s.pricing_box_graphic_alignment+";justify-content:"+U+";}",i+="."+e+a+" .oxy-pricing-box-section.oxy-pricing-box-title {"+to.generateArrayOptionsCSS(s,"pricing_box_title")+"text-align:"+s.pricing_box_title_alignment+";background-color:"+to.getGlobalColorValue(s.pricing_box_title_background)+";}",i+="."+e+a+" .oxy-pricing-box-title-title {"+to.generateTypographyCSS(s,"pricing_box_title_typography")+"}",i+="."+e+a+" .oxy-pricing-box-title-subtitle {"+to.generateTypographyCSS(s,"pricing_box_subtitle_typography")+"}",i+="."+e+a+" .oxy-pricing-box-section.oxy-pricing-box-price {"+to.generateArrayOptionsCSS(s,"pricing_box_price")+"text-align:"+s.pricing_box_price_alignment+";background-color:"+to.getGlobalColorValue(s.pricing_box_price_background)+";flex-direction:"+Y+";justify-content:"+K+";align-items:"+X+";}",i+="."+e+a+" .oxy-pricing-box-currency {"+to.generateTypographyCSS(s,"pricing_box_price_amount_currency_typography")+"}",i+="."+e+a+" .oxy-pricing-box-amount-main {"+to.generateTypographyCSS(s,"pricing_box_price_amount_main_typography")+"}",i+="."+e+a+" .oxy-pricing-box-amount-decimal {"+to.generateTypographyCSS(s,"pricing_box_price_amount_decimal_typography")+"}",i+="."+e+a+" .oxy-pricing-box-term {"+to.generateTypographyCSS(s,"pricing_box_price_amount_term_typography")+"}",i+="."+e+a+" .oxy-pricing-box-sale-price {"+to.generateTypographyCSS(s,"pricing_box_price_sale_typography")+"margin-bottom:"+s.pricing_box_price_sale_space_below+";}",i+="."+e+a+" .oxy-pricing-box-section.oxy-pricing-box-content {"+to.generateArrayOptionsCSS(s,"pricing_box_content")+"background-color:"+to.getGlobalColorValue(s.pricing_box_content_background)+";text-align:"+s.pricing_box_content_alignment+";"+to.generateTypographyCSS(s,"pricing_box_content_typography")+"}",i+="."+e+a+" .oxy-pricing-box-section.oxy-pricing-box-cta {"+to.generateArrayOptionsCSS(s,"pricing_box_cta")+"background-color:"+to.getGlobalColorValue(s.pricing_box_cta_background)+";text-align:"+s.pricing_box_cta_alignment+";justify-content:"+L+";}";!t&&to.classHasOptions(e,"slider-")&&(r||"original"!=n||(s["slider-arrow-color"]&&"lighter"==s["slider-arrow-color"]&&(i+="."+e+" .unslider-arrow {",i+="background-color: rgba(255,255,255,0.2); ",i+="}"),s["slider-dot-color"]&&(i+="."+e+" .unslider-nav ol li {",i+="border-color: "+to.getGlobalColorValue(s["slider-dot-color"])+"; ",i+="}",i+="."+e+" .unslider-nav ol li.unslider-active {",i+="background-color: "+to.getGlobalColorValue(s["slider-dot-color"])+"; ",i+="}"),s["slider-remove-padding"]&&"yes"==s["slider-remove-padding"]&&(i+="."+e+" .unslider {",i+="padding: 0px; ",i+="}",i+="."+e+" .unslider-wrap.unslider-carousel > li {",i+="padding: 0px; ",i+="}",i+="."+e+" .unslider-arrow.next {",i+="right: 10px; ",i+="z-index: 100; ",i+="}",i+="."+e+" .unslider-arrow.prev {",i+="left: 10px; ",i+="z-index: 100; ",i+="}"),s["slider-dots-overlay"]&&"yes"==s["slider-dots-overlay"]&&(i+="."+e+" .unslider .unslider-nav {",i+="position: absolute; bottom: 0; left: 0; right: 0; z-index: 100",i+="}"),s["slider-stretch-slides"]&&"yes"==s["slider-stretch-slides"]&&(i+="."+e+" .unslider-wrap {",i+="display: flex;",i+="}",i+="."+e+" .ct-slide {",i+="height: 100%;",i+="}",i+="."+e+" .unslider,",i+="."+e+" .oxygen-unslider-container,",i+="."+e+" .unslider-wrap,",i+="."+e+" .unslider-wrap li {",i+="height: 100%;",i+="}"),s["slider-stretch-slides"]&&"yes"==s["slider-stretch-slides"]&&s["slider-animation"]&&"fade"==s["slider-animation"]&&(i+="."+e+" .unslider-fade ul li.unslider-active {",i+="width: 100%;",i+="}"),s["slider-slide-padding"]&&(i+="."+e+" .ct-slide {",i+="padding: "+s["slider-slide-padding"],i+="}")));var Z=!1;if(to.classes[e])for(paramName in to.classes[e].original)0===paramName.indexOf("toggle_")&&(Z=!0);!t&&Z&&(i+="."+e+a+" .oxy-expand-collapse-icon {font-size:"+s.toggle_icon_size+";}",i+="."+e+a+" .oxy-expand-collapse-icon::before,."+e+a+" .oxy-expand-collapse-icon::after {background-color:"+to.getGlobalColorValue(s.toggle_icon_color)+";}");var Q=!1;if(to.classes[e])for(paramName in to.classes[e].original)0===paramName.indexOf("superbox_")&&(Q=!0);if(!t&&Q){var q,R,J,ee,oe,te=s.superbox_secondary_scale_start,re=s.superbox_secondary_scale_finish,ae=s.superbox_primary_scale_start,ie=s.superbox_primary_scale_finish,ne="",le="",se="",ce="";void 0!==te&&(R="transform: scale("+te+");"),void 0!==re&&(J="transform: scale("+re+");"),void 0!==ae&&(ee="transform: scale("+ae+");"),void 0!==ie&&(oe="transform: scale("+ie+");"),s.superbox_secondary_slide_direction&&(q=to.slide_position(s.superbox_secondary_slide_direction,(s.superbox_secondary_slide_distance||"")+"px"),"in"==s.superbox_secondary_slide_inorout?(ne=q.out_css,le=q.in_css):"out"==s.superbox_secondary_slide_inorout&&(ne=q.in_css,le=q.out_css)),s.superbox_primary_slide_direction&&(q=to.slide_position(s.superbox_primary_slide_direction,(s.superbox_primary_slide_distance||"")+"px"),"in"==s.superbox_primary_slide_inorout?(se=q.out_css,ce=q.in_css):"out"==s.superbox_primary_slide_inorout&&(se=q.in_css,ce=q.out_css)),i+="."+e+" .oxy-superbox-secondary, ."+e+" .oxy-superbox-primary {transition-duration:"+s.superbox_transition_duration+";}",i+="."+e+" .oxy-superbox-secondary {opacity:"+s.superbox_secondary_opacity_start+";"+ne+R+"}",i+="."+e+":hover .oxy-superbox-secondary {opacity:"+s.superbox_secondary_opacity_finish+";z-index: 2147483642;"+le+J+"}",i+="."+e+" .oxy-superbox-primary {opacity:"+s.superbox_primary_opacity_start+";"+se+ee+"}",i+="."+e+":hover .oxy-superbox-primary {opacity:"+s.superbox_primary_opacity_finish+";"+ce+oe+"}"}if(void 0!==to.componentsTemplates)for(var pe in to.componentsTemplates)if(to.componentsTemplates.hasOwnProperty(pe)){var de=!1;if(to.classes[e])for(paramName in to.classes[e][n])0===paramName.indexOf(pe)&&(de=!0);if(!t&&de&&to.componentsTemplates[pe].registeredSelectors){var ge=to.componentsTemplates[pe].registeredSelectors;for(var W in selectorsCSS="",ge)if(ge.hasOwnProperty(W)){var _e=ge[W],me="";if(_e)for(var ye in _e)_e.hasOwnProperty(ye)&&s[_e[ye]]&&(me+=ye+":"+to.getGlobalColorValue(s[_e[ye]])+";");me&&(selectorsCSS+="."+e+" "+W+a+"{"+me+"}")}i+=selectorsCSS}}if(s["box-shadow-color"]){var ue="inset"==s["box-shadow-inset"]?s["box-shadow-inset"]+" ":"",be=s["box-shadow-horizontal-offset"]?s["box-shadow-horizontal-offset"]+"px ":"",he=s["box-shadow-vertical-offset"]?s["box-shadow-vertical-offset"]+"px ":"",xe=s["box-shadow-blur"]?s["box-shadow-blur"]+"px ":"0px ",Se=s["box-shadow-spread"]?s["box-shadow-spread"]+"px ":"";s["box-shadow"]=ue+be+he+xe+Se+to.getGlobalColorValue(s["box-shadow-color"])}if(s["text-shadow-color"]){be=s["text-shadow-horizontal-offset"]?s["text-shadow-horizontal-offset"]+"px ":"",he=s["text-shadow-vertical-offset"]?s["text-shadow-vertical-offset"]+"px ":"",xe=s["text-shadow-blur"]?s["text-shadow-blur"]+"px ":"0px ";s["text-shadow"]=be+he+xe+to.getGlobalColorValue(s["text-shadow-color"])}for(var fe in t?e.indexOf(".")<0&&e.indexOf("#")<0&&e.indexOf("body")<0?i+=".oxygen-body "+e+a:i+=e+a:i+="."+e+a,i+="{",i+=to.getBackgroundLayersCSS(s,null,t,e,r,n)||"",i+=to.getTransformCSS(s)||"",s)if(s.hasOwnProperty(fe)){if("custom-css"==fe)continue;if(0<=["display","flex-direction","flex-wrap","align-items","align-content","justify-content"].indexOf(fe)&&!t)continue;var ve=s[fe];if("flex-direction"==fe){i+=fe+":"+ve+(Ce="reverse"==s["flex-reverse"]?"-reverse":"")+";";continue}if("filter"==fe&&s["filter-amount-"+ve])ve+="("+s["filter-amount-"+ve]+")";else if("filter"==fe)continue;if("content"==fe.trim().toLowerCase()&&(ve='"'+ve.replace('"','\\"')+'"',to.contentAdded[e+a]=!0),("font-family"==fe||-1<fe.indexOf("font-family"))&&void 0!==ve&&(to.loadWebFont(ve),-1===ve.indexOf(",")&&"inherit"!==ve.toLowerCase()&&(ve="'"+ve+"'")),"background-image"==fe||"background-size"==fe)continue;ve&&to.excludeProperties.indexOf(fe)<0&&"background-layers"!==fe&&(i+=fe+":"+to.getGlobalColorValue(ve)+";"),"-webkit-font-smoothing"==fe&&(i+="-moz-osx-font-smoothing:"+("antialiased"===ve?"grayscale":"unset")+";")}if("before"!=n&&"after"!=n||to.contentAdded[e+a]||(i+='content:"";',to.contentAdded[e+a]=!0),s["custom-css"]&&(i+=to.replaceGlobalColors(s["custom-css"])),i+="}",(s["container-padding-top"]||s["container-padding-right"]||s["container-padding-bottom"]||s["container-padding-left"])&&(i+="."+e+a+" .ct-section-inner-wrap {",s["container-padding-top"]&&(i+="padding-top:"+s["container-padding-top"]+";"),s["container-padding-right"]&&(i+="padding-right:"+s["container-padding-right"]+";"),s["container-padding-bottom"]&&(i+="padding-bottom:"+s["container-padding-bottom"]+";"),s["container-padding-left"]&&(i+="padding-left:"+s["container-padding-left"]+";"),i+="}"),(s.display||s["flex-direction"]||s["flex-wrap"]||s["align-items"]||s["align-content"]||s["justify-content"])&&!t){i+="."+e+":not(.ct-section)"+a,to.isPseudoElement(a)?i+=",."+e+".ct-section .ct-section-inner-wrap"+a:i+=",."+e+".ct-section"+a+" .ct-section-inner-wrap",i+="{",s.display&&(i+="display:"+s.display+";");var Ce="reverse"==s["flex-reverse"]?"-reverse":"";s["flex-direction"]&&(i+="flex-direction:"+s["flex-direction"]+Ce+";"),s["justify-content"]&&(i+="justify-content:"+s["justify-content"]+";"),s["align-content"]&&(i+="align-content:"+s["align-content"]+";"),s["align-items"]&&(i+="align-items:"+s["align-items"]+";"),s["flex-wrap"]&&(i+="flex-wrap:"+s["flex-wrap"]+";"),i+="}"}}return i},to.generateTreeCSS=function(o,t,r,a){if(a=0,a++,"[object Array]"!==Object.prototype.toString.call(o))return!1;to.log&&console.log("generateTreeCSS()",o,t),angular.forEach(o,function(e){e.options.name=e.name,e.options.original,e.options.id=e.options.original,to.generateDynamicBackgrounds(e.id,!1,"id",function(){t.styles+=to.getSingleComponentCSS(e.options,e.id),e.children?to.generateTreeCSS(e.children,t,r,a):a<=1&&r&&r()},{children:o})}),a--},to.classHasOptions=function(e,o){if(to.classes[e])for(paramName in to.classes[e].original)if(0===paramName.indexOf(o))return!0},to.applyComponentCSS=function(e,o){null==e&&(e=to.component.active.id),null==o&&(o=to.component.active.name),to.setOption(e,o,"custom-css",!1,!1)},to.applyStyleSheet=function(e){var o="\n"+to.replaceGlobalColors(e.css)+"\n",t=document.getElementById("ct-style-sheet-"+e.name);if(null===t){var r=document.getElementsByClassName("ct-css-location"),a=angular.element(r[r.length-1]);(t=angular.element("<style>").attr("id","ct-style-sheet-"+e.name).addClass("ct-css-location")).insertAfter(a)}else t=angular.element(t);if(t.empty(),t.append(o),bracket=to.bracketsFailed(o)){if("("==bracket||"{"==bracket)var i="closing";else i="opening";var n="Warning: there is no "+i+' bracket for "'+bracket+'" somewhere in your CSS. This may break page styling.';jQuery(".oxygen-code-error-container",l.oxygenUIElement).show().html(n)}else jQuery(".oxygen-code-error-container",l.oxygenUIElement).hide().html("");to.unsavedChanges()},to.addDesignSetStyleSheets=function(e){for(var o in e)if(e.hasOwnProperty(o)){var t=e[o];"object"==typeof t&&void 0===to.styleSheets[t.name]&&(to.styleSheets[t.name]=to.stripSlashes(t.content),to.applyStyleSheet(t.name))}},to.getWidth=function(e){if(!e)return{value:"",unit:""};var o=parseInt(e,10),t="";return o!==e&&(t=-1<e.indexOf("%")?"%":-1<e.indexOf("em")?"em":-1<e.indexOf("rem")?"rem":"px"),{value:o,unit:t}},to.outputPageSettingsCSS=function(){var e=".ct-section-inner-wrap, .oxy-header-container{";e+="max-width:"+to.getPageWidth()+"px;",e+="}",to.getPageSetting("overlay-header-above")&&"never"!=to.getPageSetting("overlay-header-above")&&("always"!=to.getPageSetting("overlay-header-above")&&(e+="@media (min-width: "+to.getMediaMinSize(to.getPageSetting("overlay-header-above"))+") {"),e+="body.oxy-overlay-header .oxy-header {position: absolute;left: 0;right: 0;z-index: 2147483640;}body.oxy-overlay-header .oxy-header:not(.oxy-sticky-header-active),body.oxy-overlay-header .oxy-header:not(.oxy-sticky-header-active) .oxy-header-row {background-color: initial !important;}body.oxy-overlay-header .oxy-header .oxygen-hide-in-overlay{display: none;}body.oxy-overlay-header .oxy-header .oxygen-only-show-in-overlay{display: block;}","always"!=to.getPageSetting("overlay-header-above")&&(e+="}")),to.outputCSSStyles("ct-page-settings-styles",e)},to.updateGlobalSettingsCSS=function(){var e="",o=to.getGlobalFont("Text"),t=to.getGlobalFont("Display");-1===o.indexOf(",")&&(o="'"+o+"'"),-1===t.indexOf(",")&&(t="'"+t+"'"),e+="body {",e+="font-family: "+o+";",e+="line-height: "+to.globalSettings.body_text["line-height"]+";",e+="font-size: "+to.globalSettings.body_text["font-size"]+to.globalSettings.body_text["font-size-unit"]+";",e+="font-weight: "+to.globalSettings.body_text["font-weight"]+";",e+="color: "+to.getGlobalColorValue(to.globalSettings.body_text.color)+";",e+="}",e+=".oxy-nav-menu-hamburger-line {",e+="background-color: "+to.getGlobalColorValue(to.globalSettings.body_text.color)+";",e+="}",e+="h1, h2, h3, h4, h5, h6 {",e+="font-family: "+t+";",""!==to.globalSettings.headings.H1["font-size"]&&(e+="font-size: "+to.globalSettings.headings.H1["font-size"]+to.globalSettings.headings.H1["font-size-unit"]+";"),""!==to.globalSettings.headings.H1["font-weight"]&&(e+="font-weight: "+to.globalSettings.headings.H1["font-weight"]+";"),""!==to.globalSettings.headings.H1.color&&(e+="color: "+to.getGlobalColorValue(to.globalSettings.headings.H1.color)+";"),e+="}";var r="h2, h3, h4, h5, h6";for(var a in to.globalSettings.headings)if(to.globalSettings.headings.hasOwnProperty(a)){var i="";if("H1"==a)continue;""!==to.globalSettings.headings[a]["font-size"]&&(i+="font-size: "+to.globalSettings.headings[a]["font-size"]+to.globalSettings.headings[a]["font-size-unit"]+";"),""!==to.globalSettings.headings[a]["font-weight"]&&(i+="font-weight: "+to.globalSettings.headings[a]["font-weight"]+";"),""!==to.globalSettings.headings[a].color&&(i+="color: "+to.getGlobalColorValue(to.globalSettings.headings[a].color)+";"),""!==i&&(e+=r+"{",e+=i,e+="}"),r=r.replace(a.toLowerCase()+", ","")}var n={all:"a",text_link:".ct-link-text",link_wrapper:".ct-link",button:".ct-link-button"};for(var l in n)if(n.hasOwnProperty(l)){var s="";r=n[l];to.globalSettings.links[l]=to.globalSettings.links[l]||{},""!==to.globalSettings.links[l].color&&(s+="color: "+to.getGlobalColorValue(to.globalSettings.links[l].color)+";"),""!==to.globalSettings.links[l]["font-weight"]&&(s+="font-weight: "+to.globalSettings.links[l]["font-weight"]+";"),to.globalSettings.links[l]["text-decoration"]&&(s+="text-decoration: "+to.globalSettings.links[l]["text-decoration"]+";"),to.globalSettings.links[l]["border-radius"]&&(s+="border-radius: "+to.globalSettings.links[l]["border-radius"]+to.globalSettings.links[l]["border-radius-unit"]+";"),""!==s&&(e+=r+" {",e+=s,e+="}"),(s="")!==to.globalSettings.links[l].hover_color&&(s+="color: "+to.getGlobalColorValue(to.globalSettings.links[l].hover_color)+";"),to.globalSettings.links[l]["hover_text-decoration"]&&(s+="text-decoration: "+to.globalSettings.links[l]["hover_text-decoration"]+";"),""!==s&&(e+=r+":hover {",e+=s,e+="}")}for(var c in e+=".ct-section-inner-wrap {",e+="padding-top: "+to.globalSettings.sections["container-padding-top"]+to.globalSettings.sections["container-padding-top-unit"]+";",e+="padding-left: "+to.globalSettings.sections["container-padding-left"]+to.globalSettings.sections["container-padding-left-unit"]+";",e+="padding-right: "+to.globalSettings.sections["container-padding-right"]+to.globalSettings.sections["container-padding-right-unit"]+";",e+="padding-bottom: "+to.globalSettings.sections["container-padding-bottom"]+to.globalSettings.sections["container-padding-bottom-unit"]+";",e+="}",e+=".oxy-header-container {",e+="padding-left: "+to.globalSettings.sections["container-padding-left"]+to.globalSettings.sections["container-padding-left-unit"]+";",e+="padding-right: "+to.globalSettings.sections["container-padding-right"]+to.globalSettings.sections["container-padding-right-unit"]+";",e+="}",to.globalSettings)if(to.globalSettings.hasOwnProperty(c)){var p=to.globalSettings[c];for(var d in p)p.hasOwnProperty(d)&&("font-family"==d||-1<d.indexOf("font-family"))&&to.loadWebFont(p[d])}e+=to.replaceGlobalWooSettings(CtBuilderAjax.wooGlobalStyles),to.outputCSSStyles("oxygen-global-settings-styles",e)},to.$watch("globalSettings",function(e,o){to.updateGlobalSettingsCSS()},!0),to.$watch("globalSettings.sections",function(e,o){to.pageSettingsUpdate(),to.applyModelOptions()},!0),to.$watch("globalSettings.woo",function(e,o){to.updateAllComponentsCacheStyles(),to.outputCSSOptions()},!0),to.$watch("pageSettingsMeta",function(e,o){to.pageSettingsUpdate()},!0),to.$watch("pageSettingsMeta.aos",function(e,o){to.updateAOS()},!0),to.updateAOS=function(){var e=angular.copy(to.pageSettingsMeta.aos);for(var o in e)""!==e[o]&&void 0!==e[o]||delete e[o];var t=angular.extend({},to.globalSettings.aos,e);for(var o in"false"===t.once&&(t.once=!1),e=t)""!==e[o]&&void 0!==e[o]||delete e[o];aosDefaults={offset:120,delay:0,easing:"ease",duration:400,disable:!1,once:!1},t=angular.extend({},aosDefaults,e),jQuery('[data-aos-enabled="true"]').each(function(){var e=jQuery(this).attr("ng-attr-component-id");to.setOption(e,to.component.options[e].name,"aos-type")}),AOS.init(t)},to.bracketsFailed=function(e){return e=(""+e).replace(/(\/[*][^*]*[*]\/)|(\/\/[^\n]*)/gm,""),function(e){for(var o={"}":"{",")":"("},t=[],r=0,a=(e=""+e).length;r<a;r++)o[e[r]]&&t.pop()===o[e[r]]||t.push(e[r]);return!!t.length&&t[0]}(e=(""+e).replace(/[^(){}]/g,""))},to.mapCSSProperty=function(e,o,t){to.mappedSelectors[t]||(to.mappedSelectors[t]={}),to.mappedSelectors[t][o]||(to.mappedSelectors[t][o]={}),to.mappedSelectors[t][o]=e},to.unmapCSSProperty=function(e,o){to.mappedSelectors[o][e]=null,delete to.mappedSelectors[o][e]},to.getMappedCSS=function(o,e){var t="";for(var r in to.mappedSelectors){var a=to.mappedSelectors[r];for(var i in t+=(r=r.split(",").map(function(e){return"#"+o+" "+e}).join(","))+"{",a)if(void 0!==a[i]&&void 0!==e[a[i]]&&""!==e[a[i]].toString().trim()){var n="";void 0!==e[a[i]+"-unit"]&&(n=e[a[i]+"-unit"]),t+="background-image"===i?i+": url("+e[a[i]]+");":i+":"+to.getGlobalColorValue(e[a[i]])+n+";"}t+="}"}return t},to.position_css=function(e,o){var t;for(var r in e){var a=e[r];!0===o&&null!==a&&(a="0"),null!==a&&(t=r+":"+a+";")}return t},to.slide_position=function(e,o){var t="100%",r=[],a=[];switch(void 0!==o&&"px"!==o&&(t=o),e){case"left":r.left="-"+t;break;case"right":r.left=""+t;break;case"top":r.top="-"+t;break;case"bottom":r.top=""+t}return a.out_css=to.position_css(r),a.in_css=to.position_css(r,!0),a},to.SPECIFICITY=(t=function(e){var o,t,r,a,i=[];for(r=0,a=(o=e.split(",")).length;r<a;r+=1)0<(t=o[r]).length&&i.push(n(t));return i},n=function(s){var e,o,t,c=s,p={a:0,b:0,c:0},d=[];return e=function(e,o){var t,r,a,i,n,l;if(e.test(c))for(r=0,a=(t=c.match(e)).length;r<a;r+=1)p[o]+=1,i=t[r],n=c.indexOf(i),l=i.length,d.push({selector:s.substr(n,l),type:o,index:n,length:l}),c=c.replace(i,Array(l+1).join(" "))},(o=function(e){var o,t,r,a;if(e.test(c))for(t=0,r=(o=c.match(e)).length;t<r;t+=1)a=o[t],c=c.replace(a,Array(a.length+1).join("A"))})(/\\[0-9A-Fa-f]{6}\s?/g),o(/\\[0-9A-Fa-f]{1,5}\s/g),o(/\\./g),(t=/:not\(([^\)]*)\)/g).test(c)&&(c=c.replace(t,"     $1 ")),function(){var e,o,t,r,a=/{[^]*/gm;if(a.test(c))for(o=0,t=(e=c.match(a)).length;o<t;o+=1)r=e[o],c=c.replace(r,Array(r.length+1).join(" "))}(),e(/(\[[^\]]+\])/g,"b"),e(/(#[^\s\+>~\.\[:]+)/g,"a"),e(/(\.[^\s\+>~\.\[:]+)/g,"b"),e(/(::[^\s\+>~\.\[:]+|:first-line|:first-letter|:before|:after)/gi,"c"),e(/(:[\w-]+\([^\)]*\))/gi,"b"),e(/(:[^\s\+>~\.\[:]+)/g,"b"),c=(c=c.replace(/[\*\s\+>~]/g," ")).replace(/[#\.]/g," "),e(/([^\s\+>~\.\[:]+)/g,"c"),d.sort(function(e,o){return e.index-o.index}),{selector:s,specificity:"0,"+p.a.toString()+","+p.b.toString()+","+p.c.toString(),specificityArray:[0,p.a,p.b,p.c],parts:d}},{calculate:t,compare:function(e,o){var t,r,a;if("string"==typeof e){if(-1!==e.indexOf(","))throw"Invalid CSS selector";t=n(e).specificityArray}else{if(!Array.isArray(e))throw"Invalid CSS selector or specificity array";if(4!==e.filter(function(e){return"number"==typeof e}).length)throw"Invalid specificity array";t=e}if("string"==typeof o){if(-1!==o.indexOf(","))throw"Invalid CSS selector";r=n(o).specificityArray}else{if(!Array.isArray(o))throw"Invalid CSS selector or specificity array";if(4!==o.filter(function(e){return"number"==typeof e}).length)throw"Invalid specificity array";r=o}for(a=0;a<4;a+=1){if(t[a]<r[a])return-1;if(t[a]>r[a])return 1}return 0}})}]);
