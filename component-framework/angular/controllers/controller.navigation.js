        ...
        angular.forEach(node.children, function(item, index) {
            ...
            if ( !isBrake ) {
                ...
                if (undefined === searchId || item.id == searchId) {
                    ...
                    if ( item.name == "ct_if_else_wrap" ) {
                        classes += " ct-sortable-if-else-wrap";
                    }
                                ...
                                '<div ng-attr-tree-actual-id="' + item.actualID + '" ng-attr-tree-id="' + item.id + '"' + ngClassNode + ' id="ct-dom-tree-node-' + item.id + '" class="ct-dom-tree-node ' + classes + '" '+apiData+' ng-Style="parentScope.isActiveId('+id+')?{zIndex: 9999}:{}">' +
                                    ...
                                    '<div ng-attr-node-id="' + id + 
                                        ...
                                        '<div class="ct-dom-tree-node-header" '+
                                            ...
                                            '<i class="ct-icon-if-conditions" ng-if="(component.options['+id+'][\'model\'][\'globalconditions\'] && component.options['+id+'][\'model\'][\'globalconditions\'].length > 0) || component.options['+id+'][\'model\'][\'conditionspreview\'] === \'0\'"></i>'+                                            '<span class="ct-nicename" ng-if="editableFriendlyName!='+id+'" ng-bind="component.options[\''+item.id+'\'][\'nicename\']" />' + 
