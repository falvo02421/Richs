...
/**
 * Return attachment sizes valid for a particular image
 *
 * @since 2.2
 */

function ct_get_attachment_sizes() {
...
add_action('wp_ajax_ct_get_attachment_sizes', 'ct_get_attachment_sizes');
