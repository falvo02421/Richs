		...
		?>
			<div class="oxygen-metabox-screenshot-inputs">
				...
				<div class="oxygen-metabox-control-group">
					...
					<input type="text" name="ct_connection_template_screenshot_url" class="oxygen-vsb-metabox-input" id="oxygen_vsb_screenshot_generate_url" value="<?php echo esc_attr($ct_connection_template_screenshot_url);?>" /></label>
				</div>
			</div>
		<?php
		}
