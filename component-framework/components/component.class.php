...
Class CT_Component {
	...
	static function component_tabs($tabs, $tag, $name) { 
            ...
            <div class="oxygen-sidebar-flex-panel oxygen-basic-styles-tab-content"
                ...
                <?php 
	                ...
	                if ( isset($tab['params']) && is_array($tab['params']) ) {
					 	self::component_params($tab['params'], $tag);
					} 
			...
			<?php if (isset($tab['tabs'])&&is_array($tab['tabs'])) {
				foreach ($tab['tabs'] as $child_id => $child_tab) { ?>
				    ...
				    <div class="oxygen-sidebar-flex-panel oxygen-basic-styles-tab-content"
				        ...
				        <?php if (isset($child_tab['params'])) self::component_params($child_tab['params'], $tag); ?>
		            ...
		            <?php if (isset($child_tab['tabs'])&&is_array($child_tab['tabs'])) {
				        ...
				        <div class="oxygen-sidebar-flex-panel oxygen-basic-styles-tab-content"
					        ...
					        <?php if (isset($grand_child_tab['params'])) { self::component_params($grand_child_tab['params'], $tag); } ?>
