...
class Oxygen_VSB_Pricing_Box extends CT_Component{
    ...
    function shortcode($atts, $content, $name) {
	    ...
	    $editable_package_title = base64_decode($this->param_array[$options['id']]['pricing_box_package_title']);
	    $editable_package_subtitle = base64_decode($this->param_array[$options['id']]['pricing_box_package_subtitle']);
	    $editable_content = base64_decode($this->param_array[$options['id']]['pricing_box_content']);
	    $editable_package_regular = base64_decode($this->param_array[$options['id']]['pricing_box_package_regular']);
