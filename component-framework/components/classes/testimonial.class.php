...
class Oxygen_VSB_Testimonial extends CT_Component {
    ...
    function shortcode($atts, $content = null, $name = null ) {
	    ...
	    $editable_testimonial_text = base64_decode($this->param_array[$options['id']]['testimonial_text']);
	    $editable_testimonial_author = base64_decode($this->param_array[$options['id']]['testimonial_author']);
	    $editable_testimonial_author_info = base64_decode($this->param_array[$options['id']]['testimonial_author_info']);
