...
Class CT_Link_Text extends CT_Component {
	...
	function add_shortcode( $atts, $content, $name ) {
		...
		$editable_link = esc_url($options['url']);
		...
		?><a id="<?php echo esc_attr($options['selector']); ?>" class="<?php echo esc_attr($options['classes']); ?>" href="<?php echo $editable_link; ?>" <?php echo ($options['target']) ? "target=\"".esc_attr($options['target'])."\"" : ""; ?> <?php do_action("oxygen_vsb_component_attr", $options, $this->options['tag']); ?>><?php echo $editable_attribute; ?></a><?php
